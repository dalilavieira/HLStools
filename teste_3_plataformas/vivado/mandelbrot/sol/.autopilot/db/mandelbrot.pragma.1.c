...
void mandelbrot(char color[6], int xmax, int xmin, int ymax, int ymin, int maxiter, int xres, int yres, int dx, int dy){_ssdm_SpecArrayDimSize(color, 6);
  double x, y;
  double u, v;
  int i,j;
  int k;
...
int main(int argc, char* argv[])
{
  ...
  mandelbrot(color, xmax, xmin, ymax, ymin, maxiter, xres, yres, dx, dy);
