...
set id 1
set name mandelbrot_dadddsub_64ns_64ns_64_5_full_dsp_1
...
set id 2
set name mandelbrot_dadd_64ns_64ns_64_5_full_dsp_1
...
set id 3
set name mandelbrot_dmul_64ns_64ns_64_5_max_dsp_1
...
set id 6
set name mandelbrot_dcmp_64ns_64ns_1_2_1
...
set id 7
set name mandelbrot_sitodp_32ns_64_4_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename color \
    op interface \
    ports { color_address0 { O 3 vector } color_ce0 { O 1 bit } color_we0 { O 1 bit } color_d0 { O 8 vector } color_address1 { O 3 vector } color_ce1 { O 1 bit } color_we1 { O 1 bit } color_d1 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'color'"
}
}
