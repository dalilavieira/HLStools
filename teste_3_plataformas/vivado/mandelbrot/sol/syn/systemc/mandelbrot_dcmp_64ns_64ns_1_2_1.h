...
// ==============================================================
#ifndef __mandelbrot_dcmp_64ns_64ns_1_2_1__HH__
#define __mandelbrot_dcmp_64ns_64ns_1_2_1__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandelbrot_dcmp_64ns_64ns_1_2_1) {
    ...
    SC_CTOR(mandelbrot_dcmp_64ns_64ns_1_2_1):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
