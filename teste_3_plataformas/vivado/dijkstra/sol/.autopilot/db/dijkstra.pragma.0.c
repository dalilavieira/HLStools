...
# 1 "<built-in>" 2
# 1 "dijkstra.c" 2
# 1 "/opt/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/limits.h" 1 3
# 38 "/opt/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/limits.h" 3
...
# 39 "/opt/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/limits.h" 2 3
# 2 "dijkstra.c" 2
...
int minDistance(__int32_t dist[9], __int32_t sptSet[9])
{_ssdm_SpecArrayDimSize(dist, 9);_ssdm_SpecArrayDimSize(sptSet, 9);
...
int printSolution(__int32_t dist[9], int n)
{_ssdm_SpecArrayDimSize(dist, 9);
...
void dijkstra(__int32_t graph[9][9], int src)
{_ssdm_SpecArrayDimSize(graph, 9);
    int dist[9];
