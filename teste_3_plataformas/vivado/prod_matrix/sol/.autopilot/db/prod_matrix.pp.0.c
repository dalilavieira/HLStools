...
void prod_matrix(__int32_t v[100][100], __int32_t r[100][100], int row, int col) {_ssdm_SpecArrayDimSize(v, 100);_ssdm_SpecArrayDimSize(r, 100);
    int i, j, k;
    for (i = 0; i < row; ++i) {
        for (j = 0; j < col; ++j) {
            for (k = 0; k < row; ++k)
