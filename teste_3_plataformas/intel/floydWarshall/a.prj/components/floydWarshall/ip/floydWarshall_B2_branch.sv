...
// SystemVerilog created from floydWarshall_B2_branch
...
module floydWarshall_B2_branch (
    input wire [0:0] in_c0_exe1234,
    ...
    // out_c0_exe1234(GPOUT,8)
    assign out_c0_exe1234 = in_c0_exe1234;
