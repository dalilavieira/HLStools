...
// SystemVerilog created from floydWarshall_i_iowr_bl_return_floydwarsA000000Zall56_floydwarshall0
...
module floydWarshall_i_iowr_bl_return_floydwarsA000000Zall56_floydwarshall0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_floydWarshall_i_fifoready;
    ...
    assign out_iowr_bl_return_floydWarshall_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_floydWarshall_o_fifovalid = iowr_o_fifovalid;
