...
// SystemVerilog created from floydWarshall_i_iord_bl_call_floydwarshaA000000Zhall2_floydwarshall0
...
module floydWarshall_i_iord_bl_call_floydwarshaA000000Zhall2_floydwarshall0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_floydWarshall_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_floydWarshall_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_floydWarshall_i_fifodata),
    ...
    assign out_iord_bl_call_floydWarshall_o_fifoready = iord_o_fifoready;
