...
// SystemVerilog created from floydWarshall_B6_merge
...
module floydWarshall_B6_merge (
    ...
    wire [0:0] k_028_mux_s;
    reg [31:0] k_028_mux_q;
    ...
    // k_028_mux(MUX,10)
    assign k_028_mux_s = in_valid_in_0;
    always @(k_028_mux_s or in_k_028_1 or in_k_028_0)
    begin
        unique case (k_028_mux_s)
            1'b0 : k_028_mux_q = in_k_028_1;
            1'b1 : k_028_mux_q = in_k_028_0;
            default : k_028_mux_q = 32'b0;
        endcase
    end

    // out_k_028(GPOUT,12)
    assign out_k_028 = k_028_mux_q;
