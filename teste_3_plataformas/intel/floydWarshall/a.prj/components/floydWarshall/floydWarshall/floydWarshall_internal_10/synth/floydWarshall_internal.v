...
/////////////////////////////////////////////////////////////////
// MODULE floydWarshall_internal
/////////////////////////////////////////////////////////////////
module floydWarshall_internal
(
   input logic clock,
   input logic resetn,
   input logic [63:0] graph,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   ...
   // INST floydWarshall_internal of floydWarshall_function_wrapper
   floydWarshall_function_wrapper floydWarshall_internal
   (
      .clock(clock),
      .resetn(resetn),
      .graph(graph),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_unnamed_floydWarshall4_floydWarshall
      .avm_unnamed_floydWarshall4_floydWarshall_enable(avmm_0_global_avm_enable[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_read(avmm_0_global_avm_read[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_write(avmm_0_global_avm_write[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_address(avmm_0_global_avm_address[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_writedata(avmm_0_global_avm_writedata[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_readdata(avmm_0_global_avm_readdata[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_unnamed_floydWarshall4_floydWarshall_writeack(avmm_0_global_avm_writeack[0])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of floydWarshall_internal_ic_11797103729985604047
      floydWarshall_internal_ic_11797103729985604047 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE floydWarshall_internal_ic_11797103729985604047
/////////////////////////////////////////////////////////////////
module floydWarshall_internal_ic_11797103729985604047
(
   input logic clock,
