...
// SystemVerilog created from mmc_B2_branch
...
module mmc_B2_branch (
    ...
    wire [0:0] mmc_B2_branch_enable_q;
    wire [0:0] mmc_B2_branch_enable_not_q;
    ...
    begin
        ...
        else if (mmc_B2_branch_enable_q == 1'b1)
        begin
    ...
    // mmc_B2_branch_enable(LOGICAL,7)
    assign mmc_B2_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // mmc_B2_branch_enable_not(LOGICAL,8)
    assign mmc_B2_branch_enable_not_q = ~ (mmc_B2_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = mmc_B2_branch_enable_not_q;
