...
// SystemVerilog created from mmc_i_iowr_bl_return_unnamed_mmc8_mmc0
...
module mmc_i_iowr_bl_return_unnamed_mmc8_mmc0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_mmc_i_fifoready;
    ...
    assign out_iowr_bl_return_mmc_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_mmc_o_fifovalid = iowr_o_fifovalid;
