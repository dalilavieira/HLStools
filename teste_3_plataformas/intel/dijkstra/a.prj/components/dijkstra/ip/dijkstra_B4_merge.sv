...
// SystemVerilog created from dijkstra_B4_merge
...
module dijkstra_B4_merge (
    ...
    output wire [31:0] out_count_034,
    ...
    wire [0:0] VCC_q;
    wire [0:0] count_034_mux_s;
    reg [31:0] count_034_mux_q;
    ...
    // count_034_mux(MUX,2)
    assign count_034_mux_s = in_valid_in_0;
    always @(count_034_mux_s or in_count_034_1 or in_count_034_0)
    begin
        unique case (count_034_mux_s)
            1'b0 : count_034_mux_q = in_count_034_1;
            1'b1 : count_034_mux_q = in_count_034_0;
            default : count_034_mux_q = 32'b0;
        endcase
    end

    // out_count_034(GPOUT,11)
    assign out_count_034 = count_034_mux_q;
