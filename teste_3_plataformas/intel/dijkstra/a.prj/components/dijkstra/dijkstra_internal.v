...
(
   ...
   // INST dijkstra_internal of dijkstra_function_wrapper
   dijkstra_function_wrapper dijkstra_internal
   (
      .clock(clock),
      .resetn(resetn),
      .graph(graph),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_lm1_dijkstra
      .avm_lm1_dijkstra_enable(avmm_0_global_avm_enable[0]),
      .avm_lm1_dijkstra_read(avmm_0_global_avm_read[0]),
      .avm_lm1_dijkstra_write(avmm_0_global_avm_write[0]),
      .avm_lm1_dijkstra_address(avmm_0_global_avm_address[0]),
      .avm_lm1_dijkstra_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm1_dijkstra_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm1_dijkstra_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm1_dijkstra_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm1_dijkstra_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm1_dijkstra_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm1_dijkstra_writeack(avmm_0_global_avm_writeack[0])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of dijkstra_internal_ic_11797103729985604047
      dijkstra_internal_ic_11797103729985604047 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE dijkstra_internal_ic_11797103729985604047
/////////////////////////////////////////////////////////////////
module dijkstra_internal_ic_11797103729985604047
(
   input logic clock,
