...
// SystemVerilog created from dijkstra_i_iord_bl_call_unnamed_dijkstra2_dijkstra0
...
module dijkstra_i_iord_bl_call_unnamed_dijkstra2_dijkstra0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_dijkstra_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_dijkstra_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_dijkstra_i_fifodata),
    ...
    assign out_iord_bl_call_dijkstra_o_fifoready = iord_o_fifoready;
