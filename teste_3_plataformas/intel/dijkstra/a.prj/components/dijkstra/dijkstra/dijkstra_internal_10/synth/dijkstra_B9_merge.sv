...
// SystemVerilog created from dijkstra_B9_merge
...
module dijkstra_B9_merge (
    ...
    output wire [31:0] out_inc50175_pop37178,
    ...
    wire [0:0] inc50175_pop37178_mux_s;
    reg [31:0] inc50175_pop37178_mux_q;
    ...
    // out_forked52(GPOUT,11)
    assign out_forked52 = forked52_mux_q;

    // inc50175_pop37178_mux(MUX,3)
    assign inc50175_pop37178_mux_s = in_valid_in_0;
    always @(inc50175_pop37178_mux_s or in_inc50175_pop37178_1 or in_inc50175_pop37178_0)
    begin
        unique case (inc50175_pop37178_mux_s)
            1'b0 : inc50175_pop37178_mux_q = in_inc50175_pop37178_1;
            1'b1 : inc50175_pop37178_mux_q = in_inc50175_pop37178_0;
            default : inc50175_pop37178_mux_q = 32'b0;
        endcase
    end

    // out_inc50175_pop37178(GPOUT,12)
    assign out_inc50175_pop37178 = inc50175_pop37178_mux_q;
