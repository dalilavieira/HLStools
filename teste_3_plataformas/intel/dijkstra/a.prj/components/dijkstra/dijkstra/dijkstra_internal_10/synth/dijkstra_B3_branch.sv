...
// SystemVerilog created from dijkstra_B3_branch
...
module dijkstra_B3_branch (
    ...
    wire [0:0] dijkstra_B3_branch_enable_q;
    wire [0:0] dijkstra_B3_branch_enable_not_q;
    ...
    begin
        ...
        else if (dijkstra_B3_branch_enable_q == 1'b1)
        begin
    ...
    // dijkstra_B3_branch_enable(LOGICAL,3)
    assign dijkstra_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // dijkstra_B3_branch_enable_not(LOGICAL,4)
    assign dijkstra_B3_branch_enable_not_q = ~ (dijkstra_B3_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = dijkstra_B3_branch_enable_not_q;
