...
(
   ...
   // INST sum_vector_internal of sum_vector_function_wrapper
   sum_vector_function_wrapper sum_vector_internal
   (
      .clock(clock),
      .resetn(resetn),
      .a(a),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_lm1_sum_vector
      .avm_lm1_sum_vector_enable(avmm_0_global_avm_enable[0]),
      .avm_lm1_sum_vector_read(avmm_0_global_avm_read[0]),
      .avm_lm1_sum_vector_write(avmm_0_global_avm_write[0]),
      .avm_lm1_sum_vector_address(avmm_0_global_avm_address[0]),
      .avm_lm1_sum_vector_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm1_sum_vector_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm1_sum_vector_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm1_sum_vector_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm1_sum_vector_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm1_sum_vector_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm1_sum_vector_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_lm32_sum_vector
      .avm_lm32_sum_vector_enable(avmm_0_global_avm_enable[1]),
      .avm_lm32_sum_vector_read(avmm_0_global_avm_read[1]),
      .avm_lm32_sum_vector_write(avmm_0_global_avm_write[1]),
      .avm_lm32_sum_vector_address(avmm_0_global_avm_address[1]),
      .avm_lm32_sum_vector_writedata(avmm_0_global_avm_writedata[1]),
      .avm_lm32_sum_vector_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_lm32_sum_vector_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_lm32_sum_vector_readdata(avmm_0_global_avm_readdata[1]),
      .avm_lm32_sum_vector_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_lm32_sum_vector_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_lm32_sum_vector_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_memdep_sum_vector
      .avm_memdep_sum_vector_enable(avmm_0_global_avm_enable[2]),
      .avm_memdep_sum_vector_read(avmm_0_global_avm_read[2]),
      .avm_memdep_sum_vector_write(avmm_0_global_avm_write[2]),
      .avm_memdep_sum_vector_address(avmm_0_global_avm_address[2]),
      .avm_memdep_sum_vector_writedata(avmm_0_global_avm_writedata[2]),
      .avm_memdep_sum_vector_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_memdep_sum_vector_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_memdep_sum_vector_readdata(avmm_0_global_avm_readdata[2]),
      .avm_memdep_sum_vector_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_memdep_sum_vector_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_memdep_sum_vector_writeack(avmm_0_global_avm_writeack[2])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of sum_vector_internal_ic_8981068905411363227
      sum_vector_internal_ic_8981068905411363227 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE sum_vector_internal_ic_8981068905411363227
/////////////////////////////////////////////////////////////////
module sum_vector_internal_ic_8981068905411363227
(
   input logic clock,
