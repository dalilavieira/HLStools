...
// SystemVerilog created from sum_vector_i_iord_bl_call_unnamed_sum_vector2_sum_vector0
...
module sum_vector_i_iord_bl_call_unnamed_sum_vector2_sum_vector0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_sum_vector_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_sum_vector_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_sum_vector_i_fifodata),
    ...
    assign out_iord_bl_call_sum_vector_o_fifoready = iord_o_fifoready;

    // sync_out(GPOUT,19)@20000000
    assign out_o_stall = iord_o_stall;

    // ip_dsdk_adapt_bitselect8(BITSELECT,10)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[223:192];
