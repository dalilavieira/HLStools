...
// SystemVerilog created from euler_i_iord_bl_call_unnamed_euler2_euler0
...
module euler_i_iord_bl_call_unnamed_euler2_euler0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_euler_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_euler_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_euler_i_fifodata),
    ...
    assign out_iord_bl_call_euler_o_fifoready = iord_o_fifoready;
