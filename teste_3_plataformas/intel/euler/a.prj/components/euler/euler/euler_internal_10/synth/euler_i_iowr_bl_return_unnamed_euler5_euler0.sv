...
// SystemVerilog created from euler_i_iowr_bl_return_unnamed_euler5_euler0
...
module euler_i_iowr_bl_return_unnamed_euler5_euler0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_euler_i_fifoready;
    ...
    assign out_iowr_bl_return_euler_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,10)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iowr_bl_return_euler_o_fifovalid = iowr_o_fifovalid;
