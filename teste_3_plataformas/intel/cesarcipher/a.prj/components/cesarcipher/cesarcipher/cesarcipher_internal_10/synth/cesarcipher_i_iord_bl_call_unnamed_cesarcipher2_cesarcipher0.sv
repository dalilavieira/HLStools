...
// SystemVerilog created from cesarcipher_i_iord_bl_call_unnamed_cesarcipher2_cesarcipher0
...
module cesarcipher_i_iord_bl_call_unnamed_cesarcipher2_cesarcipher0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_cesarcipher_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_cesarcipher_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_cesarcipher_i_fifodata),
    ...
    assign out_iord_bl_call_cesarcipher_o_fifoready = iord_o_fifoready;
