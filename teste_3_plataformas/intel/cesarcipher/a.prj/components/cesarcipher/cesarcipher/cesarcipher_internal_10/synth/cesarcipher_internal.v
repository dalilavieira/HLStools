...
/////////////////////////////////////////////////////////////////
// MODULE cesarcipher_internal
/////////////////////////////////////////////////////////////////
module cesarcipher_internal
(
   input logic clock,
   input logic resetn,
   input logic [63:0] palavra,
   input logic [31:0] n,
   input logic start,
   output logic busy,
   output logic done,
   ...
   // INST cesarcipher_internal of cesarcipher_function_wrapper
   cesarcipher_function_wrapper cesarcipher_internal
   (
      .clock(clock),
      .resetn(resetn),
      .palavra(palavra),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_lm1_cesarcipher
      .avm_lm1_cesarcipher_enable(avmm_0_global_avm_enable[0]),
      .avm_lm1_cesarcipher_read(avmm_0_global_avm_read[0]),
      .avm_lm1_cesarcipher_write(avmm_0_global_avm_write[0]),
      .avm_lm1_cesarcipher_address(avmm_0_global_avm_address[0]),
      .avm_lm1_cesarcipher_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm1_cesarcipher_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm1_cesarcipher_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm1_cesarcipher_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm1_cesarcipher_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm1_cesarcipher_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm1_cesarcipher_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_cesarcipher3_cesarcipher
      .avm_unnamed_cesarcipher3_cesarcipher_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_cesarcipher3_cesarcipher_writeack(avmm_0_global_avm_writeack[1])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of cesarcipher_internal_ic_4428217573090046649
      cesarcipher_internal_ic_4428217573090046649 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE cesarcipher_internal_ic_4428217573090046649
/////////////////////////////////////////////////////////////////
module cesarcipher_internal_ic_4428217573090046649
(
   input logic clock,
