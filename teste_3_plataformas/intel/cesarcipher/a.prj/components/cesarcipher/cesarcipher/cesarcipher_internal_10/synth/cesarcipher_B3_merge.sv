...
// SystemVerilog created from cesarcipher_B3_merge
...
module cesarcipher_B3_merge (
    ...
    wire [0:0] notcmp15_mux_s;
    reg [0:0] notcmp15_mux_q;
    ...
    // notcmp15_mux(MUX,10)
    assign notcmp15_mux_s = in_valid_in_0;
    always @(notcmp15_mux_s or in_notcmp15_1 or in_notcmp15_0)
    begin
        unique case (notcmp15_mux_s)
            1'b0 : notcmp15_mux_q = in_notcmp15_1;
            1'b1 : notcmp15_mux_q = in_notcmp15_0;
            default : notcmp15_mux_q = 1'b0;
        endcase
    end

    // out_notcmp15(GPOUT,12)
    assign out_notcmp15 = notcmp15_mux_q;
