...
// SystemVerilog created from sum_vector_B3_branch
...
module sum_vector_B3_branch (
    ...
    wire [0:0] sum_vector_B3_branch_enable_q;
    wire [0:0] sum_vector_B3_branch_enable_not_q;
    ...
    begin
        ...
        else if (sum_vector_B3_branch_enable_q == 1'b1)
        begin
    ...
    // sum_vector_B3_branch_enable(LOGICAL,16)
    assign sum_vector_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // sum_vector_B3_branch_enable_not(LOGICAL,17)
    assign sum_vector_B3_branch_enable_not_q = ~ (sum_vector_B3_branch_enable_q);

    // out_stall_out(GPOUT,13)
    assign out_stall_out = sum_vector_B3_branch_enable_not_q;
