...
// SystemVerilog created from sobel_i_iowr_bl_return_unnamed_sobel15_sobel0
...
module sobel_i_iowr_bl_return_unnamed_sobel15_sobel0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_sobel_i_fifoready;
    ...
    assign out_iowr_bl_return_sobel_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_sobel_o_fifovalid = iowr_o_fifovalid;
