...
// SystemVerilog created from sobel_i_iord_bl_call_unnamed_sobel2_sobel0
...
module sobel_i_iord_bl_call_unnamed_sobel2_sobel0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_sobel_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_sobel_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_sobel_i_fifodata),
    ...
    assign out_iord_bl_call_sobel_o_fifoready = iord_o_fifoready;
