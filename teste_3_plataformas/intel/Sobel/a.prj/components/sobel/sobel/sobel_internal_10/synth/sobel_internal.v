...
/////////////////////////////////////////////////////////////////
// MODULE sobel_internal
/////////////////////////////////////////////////////////////////
module sobel_internal
(
   input logic clock,
   input logic resetn,
   input logic [63:0] image1,
   input logic [63:0] image2,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   ...
   genvar __i;
   logic avmm_0_global_avm_enable [9];
   logic avmm_0_global_avm_read [9];
   logic avmm_0_global_avm_write [9];
   logic [63:0] avmm_0_global_avm_address [9];
   logic [63:0] avmm_0_global_avm_writedata [9];
   logic [7:0] avmm_0_global_avm_byteenable [9];
   logic avmm_0_global_avm_waitrequest [9];
   logic [63:0] avmm_0_global_avm_readdata [9];
   logic avmm_0_global_avm_readdatavalid [9];
   logic avmm_0_global_avm_burstcount [9];
   logic avmm_0_global_avm_writeack [9];

   // INST sobel_internal of sobel_function_wrapper
   sobel_function_wrapper sobel_internal
   (
      .clock(clock),
      .resetn(resetn),
      .image1(image1),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_memdep_sobel
      .avm_memdep_sobel_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_sobel_read(avmm_0_global_avm_read[0]),
      .avm_memdep_sobel_write(avmm_0_global_avm_write[0]),
      .avm_memdep_sobel_address(avmm_0_global_avm_address[0]),
      .avm_memdep_sobel_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_sobel_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_sobel_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_sobel_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_sobel_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_sobel_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_sobel10_sobel
      .avm_unnamed_sobel10_sobel_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_sobel10_sobel_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_sobel10_sobel_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_sobel10_sobel_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_sobel10_sobel_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_sobel10_sobel_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_sobel10_sobel_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_sobel10_sobel_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_sobel10_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_sobel10_sobel_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_sobel10_sobel_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_unnamed_sobel11_sobel
      .avm_unnamed_sobel11_sobel_enable(avmm_0_global_avm_enable[2]),
      .avm_unnamed_sobel11_sobel_read(avmm_0_global_avm_read[2]),
      .avm_unnamed_sobel11_sobel_write(avmm_0_global_avm_write[2]),
      .avm_unnamed_sobel11_sobel_address(avmm_0_global_avm_address[2]),
      .avm_unnamed_sobel11_sobel_writedata(avmm_0_global_avm_writedata[2]),
      .avm_unnamed_sobel11_sobel_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_unnamed_sobel11_sobel_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_unnamed_sobel11_sobel_readdata(avmm_0_global_avm_readdata[2]),
      .avm_unnamed_sobel11_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_unnamed_sobel11_sobel_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_unnamed_sobel11_sobel_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_unnamed_sobel12_sobel
      .avm_unnamed_sobel12_sobel_enable(avmm_0_global_avm_enable[3]),
      .avm_unnamed_sobel12_sobel_read(avmm_0_global_avm_read[3]),
      .avm_unnamed_sobel12_sobel_write(avmm_0_global_avm_write[3]),
      .avm_unnamed_sobel12_sobel_address(avmm_0_global_avm_address[3]),
      .avm_unnamed_sobel12_sobel_writedata(avmm_0_global_avm_writedata[3]),
      .avm_unnamed_sobel12_sobel_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_unnamed_sobel12_sobel_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_unnamed_sobel12_sobel_readdata(avmm_0_global_avm_readdata[3]),
      .avm_unnamed_sobel12_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_unnamed_sobel12_sobel_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_unnamed_sobel12_sobel_writeack(avmm_0_global_avm_writeack[3]),
      // AVM avm_unnamed_sobel13_sobel
      .avm_unnamed_sobel13_sobel_enable(avmm_0_global_avm_enable[4]),
      .avm_unnamed_sobel13_sobel_read(avmm_0_global_avm_read[4]),
      .avm_unnamed_sobel13_sobel_write(avmm_0_global_avm_write[4]),
      .avm_unnamed_sobel13_sobel_address(avmm_0_global_avm_address[4]),
      .avm_unnamed_sobel13_sobel_writedata(avmm_0_global_avm_writedata[4]),
      .avm_unnamed_sobel13_sobel_byteenable(avmm_0_global_avm_byteenable[4]),
      .avm_unnamed_sobel13_sobel_waitrequest(avmm_0_global_avm_waitrequest[4]),
      .avm_unnamed_sobel13_sobel_readdata(avmm_0_global_avm_readdata[4]),
      .avm_unnamed_sobel13_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[4]),
      .avm_unnamed_sobel13_sobel_burstcount(avmm_0_global_avm_burstcount[4]),
      .avm_unnamed_sobel13_sobel_writeack(avmm_0_global_avm_writeack[4]),
      // AVM avm_unnamed_sobel6_sobel
      .avm_unnamed_sobel6_sobel_enable(avmm_0_global_avm_enable[5]),
      .avm_unnamed_sobel6_sobel_read(avmm_0_global_avm_read[5]),
      .avm_unnamed_sobel6_sobel_write(avmm_0_global_avm_write[5]),
      .avm_unnamed_sobel6_sobel_address(avmm_0_global_avm_address[5]),
      .avm_unnamed_sobel6_sobel_writedata(avmm_0_global_avm_writedata[5]),
      .avm_unnamed_sobel6_sobel_byteenable(avmm_0_global_avm_byteenable[5]),
      .avm_unnamed_sobel6_sobel_waitrequest(avmm_0_global_avm_waitrequest[5]),
      .avm_unnamed_sobel6_sobel_readdata(avmm_0_global_avm_readdata[5]),
      .avm_unnamed_sobel6_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[5]),
      .avm_unnamed_sobel6_sobel_burstcount(avmm_0_global_avm_burstcount[5]),
      .avm_unnamed_sobel6_sobel_writeack(avmm_0_global_avm_writeack[5]),
      // AVM avm_unnamed_sobel7_sobel
      .avm_unnamed_sobel7_sobel_enable(avmm_0_global_avm_enable[6]),
      .avm_unnamed_sobel7_sobel_read(avmm_0_global_avm_read[6]),
      .avm_unnamed_sobel7_sobel_write(avmm_0_global_avm_write[6]),
      .avm_unnamed_sobel7_sobel_address(avmm_0_global_avm_address[6]),
      .avm_unnamed_sobel7_sobel_writedata(avmm_0_global_avm_writedata[6]),
      .avm_unnamed_sobel7_sobel_byteenable(avmm_0_global_avm_byteenable[6]),
      .avm_unnamed_sobel7_sobel_waitrequest(avmm_0_global_avm_waitrequest[6]),
      .avm_unnamed_sobel7_sobel_readdata(avmm_0_global_avm_readdata[6]),
      .avm_unnamed_sobel7_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[6]),
      .avm_unnamed_sobel7_sobel_burstcount(avmm_0_global_avm_burstcount[6]),
      .avm_unnamed_sobel7_sobel_writeack(avmm_0_global_avm_writeack[6]),
      // AVM avm_unnamed_sobel8_sobel
      .avm_unnamed_sobel8_sobel_enable(avmm_0_global_avm_enable[7]),
      .avm_unnamed_sobel8_sobel_read(avmm_0_global_avm_read[7]),
      .avm_unnamed_sobel8_sobel_write(avmm_0_global_avm_write[7]),
      .avm_unnamed_sobel8_sobel_address(avmm_0_global_avm_address[7]),
      .avm_unnamed_sobel8_sobel_writedata(avmm_0_global_avm_writedata[7]),
      .avm_unnamed_sobel8_sobel_byteenable(avmm_0_global_avm_byteenable[7]),
      .avm_unnamed_sobel8_sobel_waitrequest(avmm_0_global_avm_waitrequest[7]),
      .avm_unnamed_sobel8_sobel_readdata(avmm_0_global_avm_readdata[7]),
      .avm_unnamed_sobel8_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[7]),
      .avm_unnamed_sobel8_sobel_burstcount(avmm_0_global_avm_burstcount[7]),
      .avm_unnamed_sobel8_sobel_writeack(avmm_0_global_avm_writeack[7]),
      // AVM avm_unnamed_sobel9_sobel
      .avm_unnamed_sobel9_sobel_enable(avmm_0_global_avm_enable[8]),
      .avm_unnamed_sobel9_sobel_read(avmm_0_global_avm_read[8]),
      .avm_unnamed_sobel9_sobel_write(avmm_0_global_avm_write[8]),
      .avm_unnamed_sobel9_sobel_address(avmm_0_global_avm_address[8]),
      .avm_unnamed_sobel9_sobel_writedata(avmm_0_global_avm_writedata[8]),
      .avm_unnamed_sobel9_sobel_byteenable(avmm_0_global_avm_byteenable[8]),
      .avm_unnamed_sobel9_sobel_waitrequest(avmm_0_global_avm_waitrequest[8]),
      .avm_unnamed_sobel9_sobel_readdata(avmm_0_global_avm_readdata[8]),
      .avm_unnamed_sobel9_sobel_readdatavalid(avmm_0_global_avm_readdatavalid[8]),
      .avm_unnamed_sobel9_sobel_burstcount(avmm_0_global_avm_burstcount[8]),
      .avm_unnamed_sobel9_sobel_writeack(avmm_0_global_avm_writeack[8])
   );

   generate
   begin:avmm_0_
      logic avmm_0_icm_in_arb_request [9];
      logic avmm_0_icm_in_arb_enable [9];
      logic avmm_0_icm_in_arb_read [9];
      logic avmm_0_icm_in_arb_write [9];
      logic avmm_0_icm_in_arb_burstcount [9];
      logic [60:0] avmm_0_icm_in_arb_address [9];
      logic [63:0] avmm_0_icm_in_arb_writedata [9];
      logic [7:0] avmm_0_icm_in_arb_byteenable [9];
      logic avmm_0_icm_in_arb_stall [9];
      logic avmm_0_icm_in_wrp_ack [9];
      logic avmm_0_icm_in_rrp_datavalid [9];
      logic [63:0] avmm_0_icm_in_rrp_data [9];
      ...
      logic icm_routedavmm_0_rw_arb_request [9];
      logic icm_routedavmm_0_rw_arb_enable [9];
      logic icm_routedavmm_0_rw_arb_read [9];
      logic icm_routedavmm_0_rw_arb_write [9];
      logic icm_routedavmm_0_rw_arb_burstcount [9];
      logic [60:0] icm_routedavmm_0_rw_arb_address [9];
      logic [63:0] icm_routedavmm_0_rw_arb_writedata [9];
      logic [7:0] icm_routedavmm_0_rw_arb_byteenable [9];
      logic icm_routedavmm_0_rw_arb_stall [9];
      logic icm_routedavmm_0_rw_wrp_ack [9];
      logic icm_routedavmm_0_rw_rrp_datavalid [9];
      logic [63:0] icm_routedavmm_0_rw_rrp_data [9];
      ...
      // INST global_icavmm_0_rw of sobel_internal_ic_17182814575274308850
      sobel_internal_ic_17182814575274308850 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE sobel_internal_ic_17182814575274308850
/////////////////////////////////////////////////////////////////
module sobel_internal_ic_17182814575274308850
(
   input logic clock,
   ...
   input logic [60:0] m_arb_address [9],
   input logic [63:0] m_arb_writedata [9],
   input logic [7:0] m_arb_byteenable [9],
   output logic m_arb_stall [9],
   output logic m_wrp_ack [9],
   output logic m_rrp_datavalid [9],
   output logic [63:0] m_rrp_data [9],
   // ICM mout
   ...
   assign dp[1].in_intf.req = a[7].mout_intf.req;
   assign a[7].mout_intf.stall = dp[1].in_intf.stall;
   assign a[7].m0_intf.req = a[6].mout_intf.req;
   assign a[6].mout_intf.stall = a[7].m0_intf.stall;
   assign a[7].m1_intf.req = dp[2].out_intf.req;
   assign dp[2].out_intf.stall = a[7].m1_intf.stall;
