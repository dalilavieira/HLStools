...
// SystemVerilog created from sobel_B2_branch
...
module sobel_B2_branch (
    input wire [31:0] in_c0_exe146,
    input wire [31:0] in_c0_exe2,
    input wire [0:0] in_c0_exe3,
    input wire [0:0] in_c0_exe4,
    input wire [0:0] in_memdep_phi1_pop10,
    ...
    // out_c0_exe146(GPOUT,9)
    assign out_c0_exe146 = in_c0_exe146;
    ...
    // out_memdep_phi1_pop10(GPOUT,13)
    assign out_memdep_phi1_pop10 = in_memdep_phi1_pop10;
