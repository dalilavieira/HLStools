...
(
   ...
   // INST prod_matrix_internal of prod_matrix_function_wrapper
   prod_matrix_function_wrapper prod_matrix_internal
   (
      .clock(clock),
      .resetn(resetn),
      .v(v),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_lm1_prod_matrix
      .avm_lm1_prod_matrix_enable(avmm_0_global_avm_enable[0]),
      .avm_lm1_prod_matrix_read(avmm_0_global_avm_read[0]),
      .avm_lm1_prod_matrix_write(avmm_0_global_avm_write[0]),
      .avm_lm1_prod_matrix_address(avmm_0_global_avm_address[0]),
      .avm_lm1_prod_matrix_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm1_prod_matrix_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm1_prod_matrix_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm1_prod_matrix_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm1_prod_matrix_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm1_prod_matrix_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm1_prod_matrix_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_lm82_prod_matrix
      .avm_lm82_prod_matrix_enable(avmm_0_global_avm_enable[1]),
      .avm_lm82_prod_matrix_read(avmm_0_global_avm_read[1]),
      .avm_lm82_prod_matrix_write(avmm_0_global_avm_write[1]),
      .avm_lm82_prod_matrix_address(avmm_0_global_avm_address[1]),
      .avm_lm82_prod_matrix_writedata(avmm_0_global_avm_writedata[1]),
      .avm_lm82_prod_matrix_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_lm82_prod_matrix_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_lm82_prod_matrix_readdata(avmm_0_global_avm_readdata[1]),
      .avm_lm82_prod_matrix_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_lm82_prod_matrix_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_lm82_prod_matrix_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_memdep_prod_matrix
      .avm_memdep_prod_matrix_enable(avmm_0_global_avm_enable[2]),
      .avm_memdep_prod_matrix_read(avmm_0_global_avm_read[2]),
      .avm_memdep_prod_matrix_write(avmm_0_global_avm_write[2]),
      .avm_memdep_prod_matrix_address(avmm_0_global_avm_address[2]),
      .avm_memdep_prod_matrix_writedata(avmm_0_global_avm_writedata[2]),
      .avm_memdep_prod_matrix_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_memdep_prod_matrix_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_memdep_prod_matrix_readdata(avmm_0_global_avm_readdata[2]),
      .avm_memdep_prod_matrix_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_memdep_prod_matrix_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_memdep_prod_matrix_writeack(avmm_0_global_avm_writeack[2])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of prod_matrix_internal_ic_8981068905411363227
      prod_matrix_internal_ic_8981068905411363227 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE prod_matrix_internal_ic_8981068905411363227
/////////////////////////////////////////////////////////////////
module prod_matrix_internal_ic_8981068905411363227
(
   input logic clock,
