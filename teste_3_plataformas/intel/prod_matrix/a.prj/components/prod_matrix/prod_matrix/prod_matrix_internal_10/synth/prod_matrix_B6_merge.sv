...
// SystemVerilog created from prod_matrix_B6_merge
...
module prod_matrix_B6_merge (
    ...
    // out_memdep_1(GPOUT,7)
    assign out_memdep_1 = in_memdep_1_0;

    // out_notcmp2635_pop255(GPOUT,8)
    assign out_notcmp2635_pop255 = in_notcmp2635_pop255_0;

    // out_pop243(GPOUT,9)
    assign out_pop243 = in_pop243_0;
