...
// SystemVerilog created from prod_matrix_i_iord_bl_call_unnamed_prod_matrix2_prod_matrix0
...
module prod_matrix_i_iord_bl_call_unnamed_prod_matrix2_prod_matrix0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_prod_matrix_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_prod_matrix_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_prod_matrix_i_fifodata),
    ...
    assign out_iord_bl_call_prod_matrix_o_fifoready = iord_o_fifoready;
