...
(
   ...
   // INST bubbleSort_internal of bubbleSort_function_wrapper
   bubbleSort_function_wrapper bubbleSort_internal
   (
      .clock(clock),
      .resetn(resetn),
      .v(v),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_lm1_bubbleSort
      .avm_lm1_bubbleSort_enable(avmm_0_global_avm_enable[0]),
      .avm_lm1_bubbleSort_read(avmm_0_global_avm_read[0]),
      .avm_lm1_bubbleSort_write(avmm_0_global_avm_write[0]),
      .avm_lm1_bubbleSort_address(avmm_0_global_avm_address[0]),
      .avm_lm1_bubbleSort_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm1_bubbleSort_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm1_bubbleSort_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm1_bubbleSort_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm1_bubbleSort_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm1_bubbleSort_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm1_bubbleSort_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_lm92_bubbleSort
      .avm_lm92_bubbleSort_enable(avmm_0_global_avm_enable[1]),
      .avm_lm92_bubbleSort_read(avmm_0_global_avm_read[1]),
      .avm_lm92_bubbleSort_write(avmm_0_global_avm_write[1]),
      .avm_lm92_bubbleSort_address(avmm_0_global_avm_address[1]),
      .avm_lm92_bubbleSort_writedata(avmm_0_global_avm_writedata[1]),
      .avm_lm92_bubbleSort_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_lm92_bubbleSort_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_lm92_bubbleSort_readdata(avmm_0_global_avm_readdata[1]),
      .avm_lm92_bubbleSort_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_lm92_bubbleSort_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_lm92_bubbleSort_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_memdep_5_bubbleSort
      .avm_memdep_5_bubbleSort_enable(avmm_0_global_avm_enable[2]),
      .avm_memdep_5_bubbleSort_read(avmm_0_global_avm_read[2]),
      .avm_memdep_5_bubbleSort_write(avmm_0_global_avm_write[2]),
      .avm_memdep_5_bubbleSort_address(avmm_0_global_avm_address[2]),
      .avm_memdep_5_bubbleSort_writedata(avmm_0_global_avm_writedata[2]),
      .avm_memdep_5_bubbleSort_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_memdep_5_bubbleSort_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_memdep_5_bubbleSort_readdata(avmm_0_global_avm_readdata[2]),
      .avm_memdep_5_bubbleSort_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_memdep_5_bubbleSort_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_memdep_5_bubbleSort_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_memdep_bubbleSort
      .avm_memdep_bubbleSort_enable(avmm_0_global_avm_enable[3]),
      .avm_memdep_bubbleSort_read(avmm_0_global_avm_read[3]),
      .avm_memdep_bubbleSort_write(avmm_0_global_avm_write[3]),
      .avm_memdep_bubbleSort_address(avmm_0_global_avm_address[3]),
      .avm_memdep_bubbleSort_writedata(avmm_0_global_avm_writedata[3]),
      .avm_memdep_bubbleSort_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_memdep_bubbleSort_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_memdep_bubbleSort_readdata(avmm_0_global_avm_readdata[3]),
      .avm_memdep_bubbleSort_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_memdep_bubbleSort_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_memdep_bubbleSort_writeack(avmm_0_global_avm_writeack[3])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of bubbleSort_internal_ic_11074848305052637784
      bubbleSort_internal_ic_11074848305052637784 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE bubbleSort_internal_ic_11074848305052637784
/////////////////////////////////////////////////////////////////
module bubbleSort_internal_ic_11074848305052637784
(
   input logic clock,
