...
// SystemVerilog created from bubbleSort_i_iord_bl_call_bubblesort_unnamed_bubblesort2_bubblesort0
...
module bubbleSort_i_iord_bl_call_bubblesort_unnamed_bubblesort2_bubblesort0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_bubbleSort_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_bubbleSort_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_bubbleSort_i_fifodata),
    ...
    assign out_iord_bl_call_bubbleSort_o_fifoready = iord_o_fifoready;
