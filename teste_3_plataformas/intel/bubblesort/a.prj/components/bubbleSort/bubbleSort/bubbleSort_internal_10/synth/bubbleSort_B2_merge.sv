...
// SystemVerilog created from bubbleSort_B2_merge
...
module bubbleSort_B2_merge (
    ...
    // out_memdep_2(GPOUT,7)
    assign out_memdep_2 = in_memdep_2_0;

    // out_notcmp3039_pop213(GPOUT,8)
    assign out_notcmp3039_pop213 = in_notcmp3039_pop213_0;

    // out_pop201(GPOUT,9)
    assign out_pop201 = in_pop201_0;
