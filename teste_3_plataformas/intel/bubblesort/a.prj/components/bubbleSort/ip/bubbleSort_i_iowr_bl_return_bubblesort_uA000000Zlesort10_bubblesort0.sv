...
// SystemVerilog created from bubbleSort_i_iowr_bl_return_bubblesort_uA000000Zlesort10_bubblesort0
...
module bubbleSort_i_iowr_bl_return_bubblesort_uA000000Zlesort10_bubblesort0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_bubbleSort_i_fifoready;
    ...
    assign out_iowr_bl_return_bubbleSort_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_bubbleSort_o_fifovalid = iowr_o_fifovalid;
