...
// SystemVerilog created from bubbleSort_bb_B4_sr_1
...
module bubbleSort_bb_B4_sr_1 (
    ...
    begin
        if (!resetn)
        begin
            sr_1_x_q <= $unsigned(33'b000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
