...
// SystemVerilog created from mandelbrot_i_iord_bl_call_unnamed_mandelbrot2_mandelbrot0
...
module mandelbrot_i_iord_bl_call_unnamed_mandelbrot2_mandelbrot0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_mandelbrot_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_mandelbrot_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_mandelbrot_i_fifodata),
    ...
    assign out_iord_bl_call_mandelbrot_o_fifoready = iord_o_fifoready;
