; ModuleID = 'mandelbrot.prelto.2.bc'
...
@img = common unnamed_addr global [64 x [64 x i8]] zeroinitializer, align 32

define noalias i8* @mandelbrot(i8* nocapture %threadarg) nounwind {
entry:
