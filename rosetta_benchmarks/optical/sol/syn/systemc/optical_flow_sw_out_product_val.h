...
// ==============================================================
#ifndef __optical_flow_sw_out_product_val_H__
#define __optical_flow_sw_out_product_val_H__
...
struct optical_flow_sw_out_product_val_ram : public sc_core::sc_module {

  static const unsigned DataWidth = 32;
  static const unsigned AddressRange = 2678784;
...
sc_core::sc_signal<sc_logic> we1_t1; 
   SC_CTOR(optical_flow_sw_out_product_val_ram) {
        for (unsigned i = 0; i < 2678784; i = i + 1) {
            ram[i] = 0;
        }
...
SC_MODULE(optical_flow_sw_out_product_val) {
...
optical_flow_sw_out_product_val_ram* meminst;


SC_CTOR(optical_flow_sw_out_product_val) {
meminst = new optical_flow_sw_out_product_val_ram("optical_flow_sw_out_product_val_ram");
