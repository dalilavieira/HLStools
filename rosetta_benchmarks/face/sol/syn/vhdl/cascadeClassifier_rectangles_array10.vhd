...
entity cascadeClassifier_rectangles_array10_rom is 
    generic(
             DWIDTH     : integer := 4; 
             AWIDTH     : integer := 12; 
...
architecture rtl of cascadeClassifier_rectangles_array10_rom is 
...
entity cascadeClassifier_rectangles_array10 is
    generic (
        DataWidth : INTEGER := 4;
...
architecture arch of cascadeClassifier_rectangles_array10 is
    component cascadeClassifier_rectangles_array10_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cascadeClassifier_rectangles_array10_rom_U :  component cascadeClassifier_rectangles_array10_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
