...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name face_detect_sw_ap_sitodp_2_no_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Custom \
                          ...
                          CONFIG.component_name face_detect_sw_ap_sitodp_2_no_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips face_detect_sw_ap_sitodp_2_no_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files face_detect_sw_ap_sitodp_2_no_dsp_32.xci]
generate_target {synthesis simulation} [get_files face_detect_sw_ap_sitodp_2_no_dsp_32.xci]
