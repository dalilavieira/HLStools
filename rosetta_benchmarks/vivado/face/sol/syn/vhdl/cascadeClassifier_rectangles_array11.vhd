...
entity cascadeClassifier_rectangles_array11_rom is 
    generic(
             DWIDTH     : integer := 4; 
             AWIDTH     : integer := 12; 
...
architecture rtl of cascadeClassifier_rectangles_array11_rom is 
...
entity cascadeClassifier_rectangles_array11 is
    generic (
        DataWidth : INTEGER := 4;
...
architecture arch of cascadeClassifier_rectangles_array11 is
    component cascadeClassifier_rectangles_array11_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cascadeClassifier_rectangles_array11_rom_U :  component cascadeClassifier_rectangles_array11_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
