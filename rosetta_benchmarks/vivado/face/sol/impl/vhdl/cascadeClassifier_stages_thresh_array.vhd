...
entity cascadeClassifier_stages_thresh_array_rom is 
    generic(
             DWIDTH     : integer := 12; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 25
...
architecture rtl of cascadeClassifier_stages_thresh_array_rom is 
...
entity cascadeClassifier_stages_thresh_array is
    generic (
...
architecture arch of cascadeClassifier_stages_thresh_array is
    component cascadeClassifier_stages_thresh_array_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cascadeClassifier_stages_thresh_array_rom_U :  component cascadeClassifier_stages_thresh_array_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
