...
set id 1
set name face_detect_sw_sdiv_27ns_32ns_32_31_seq_1
...
set id 2
set name face_detect_sw_sdiv_26ns_32ns_32_30_seq_1
set corename simcore_sdiv_seq
set op sdiv
set stage_num 30
set max_latency -1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dest_height \
    op interface \
    ports { dest_height { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dest_width \
    op interface \
    ports { dest_width { I 32 vector } } \
} "
}
