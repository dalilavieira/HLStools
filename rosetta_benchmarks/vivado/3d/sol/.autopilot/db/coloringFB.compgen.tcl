...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { pixels_color_address0 { O 9 vector } pixels_color_ce0 { O 1 bit } pixels_color_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename frame_buffer \
    op interface \
    ports { frame_buffer_address0 { O 16 vector } frame_buffer_ce0 { O 1 bit } frame_buffer_we0 { O 1 bit } frame_buffer_d0 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'frame_buffer'"
}
}
