...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("data_address0", 23, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("data_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("data_q0", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("label_r_address0", 13, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("label_r_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("label_r_q0", 8, hls_in, 1, "ap_memory", "mem_dout", 1),
