...
{_ssdm_SpecArrayDimSize(param, 1024);_ssdm_SpecArrayDimSize(feature, 1024);
...
void computeGradient(
    ...
    DataType feature[NUM_FEATURES],
    FeatureType scale)
{_ssdm_SpecArrayDimSize(grad, 1024);_ssdm_SpecArrayDimSize(feature, 1024);
...
void updateParameter(
    ...
    FeatureType grad[NUM_FEATURES],
    FeatureType scale)
{_ssdm_SpecArrayDimSize(param, 1024);_ssdm_SpecArrayDimSize(grad, 1024);
...
void SgdLR_sw( DataType data[NUM_FEATURES * NUM_TRAINING],
               LabelType label[NUM_TRAINING],
               FeatureType theta[NUM_FEATURES])
{_ssdm_SpecArrayDimSize(data, 4608000);_ssdm_SpecArrayDimSize(label, 4500);_ssdm_SpecArrayDimSize(theta, 1024);
