...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "hamming_window.c" 2
# 91 "hamming_window.c"
# 1 "./hamming_window.h" 1
# 94 "./hamming_window.h"
# 1 "/opt/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdint.h" 1 3
# 33 "/opt/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdint.h" 3
...
# 34 "/opt/xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdint.h" 2 3
# 95 "./hamming_window.h" 2
...
# 96 "./hamming_window.h" 2
# 116 "./hamming_window.h"
void hamming_window(int32_t outdata[], int16_t indata[]);
# 92 "hamming_window.c" 2


static void hamming_rom_init(int16_t rom_array[]);


void hamming_window(int32_t outdata[256], int16_t indata[256])
{_ssdm_SpecArrayDimSize(outdata, 256);_ssdm_SpecArrayDimSize(indata, 256);
   static int16_t window_coeff[256];
   unsigned i;
...
static void hamming_rom_init(int16_t rom_array[256])
{_ssdm_SpecArrayDimSize(rom_array, 256);
   int i;
   for (i = 0; i < 256; i++) {
      float real_val = 0.54f -
         0.46f * cos(2.0f * 3.14159265358979323846 * i / (float)(256 - 1));
      rom_array[i] = (int16_t)(((float)(1 << (14))) * real_val);
   }
}
