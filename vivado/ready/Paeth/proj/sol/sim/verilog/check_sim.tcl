...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.paeth.autotvin_a.dat"
         "c.paeth.autotvin_b.dat"
         "c.paeth.autotvin_c.dat"
         "c.paeth.autotvin_out_r.dat"
         "c.paeth.autotvout_out_r.dat"
         "c.paeth.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.paeth.autotvout_out_r.dat"
         "rtl.paeth.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
