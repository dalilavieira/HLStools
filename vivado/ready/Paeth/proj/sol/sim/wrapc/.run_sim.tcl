...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "paeth.autotvin.dat"
	set constFileTvOut       "paeth.autotvout.dat"
	set constFileHdlTvIn     "paeth.autohdltvin.dat"
	set constFileHdlTvOut    "paeth.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
