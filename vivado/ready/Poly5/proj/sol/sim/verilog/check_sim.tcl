...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.poly5.autotvin_a.dat"
         "c.poly5.autotvin_b.dat"
         "c.poly5.autotvin_c.dat"
         "c.poly5.autotvin_out_r.dat"
         "c.poly5.autotvout_out_r.dat"
         "c.poly5.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.poly5.autotvout_out_r.dat"
         "rtl.poly5.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
