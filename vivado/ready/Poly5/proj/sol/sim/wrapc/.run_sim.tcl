...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "poly5.autotvin.dat"
	set constFileTvOut       "poly5.autotvout.dat"
	set constFileHdlTvIn     "poly5.autohdltvin.dat"
	set constFileHdlTvOut    "poly5.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
