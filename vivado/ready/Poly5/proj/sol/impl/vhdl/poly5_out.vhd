...
entity poly5_out_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 24; 
            MEM_SIZE    : integer := 16777216
    ); 
    port (
...
architecture rtl of poly5_out_ram is 
...
architecture arch of poly5_out is
    component poly5_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    poly5_out_ram_U :  component poly5_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
