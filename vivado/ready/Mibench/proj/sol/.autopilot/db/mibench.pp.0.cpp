...
int mibench(int16_t A[(100)],int16_t B[(100)],int16_t C[(100)],int32_t OUT[(100)]) {_ssdm_SpecArrayDimSize(A, 100);_ssdm_SpecArrayDimSize(B, 100);_ssdm_SpecArrayDimSize(C, 100);_ssdm_SpecArrayDimSize(OUT, 100);
