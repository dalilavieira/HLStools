...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("OUT_r_address0", 7, hls_out, 3, "ap_memory", "mem_address", 1),
	...
	Port_Property("OUT_r_q0", 32, hls_in, 3, "ap_memory", "mem_dout", 1),
	Port_Property("ap_return", 32, hls_out, -1, "", "", 1),
};
const char* HLS_Design_Meta::dut_name = "mibench";
