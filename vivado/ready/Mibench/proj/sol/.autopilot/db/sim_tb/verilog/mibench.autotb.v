...
`define AUTOTB_DUT      mibench
`define AUTOTB_DUT_INST AESL_inst_mibench
`define AUTOTB_TOP      apatb_mibench_top
`define AUTOTB_LAT_RESULT_FILE "mibench.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mibench.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mibench_top
...
`define AUTOTB_TVIN_A  "./c.mibench.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.mibench.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.mibench.autotvin_C.dat"
`define AUTOTB_TVIN_OUT_r  "./c.mibench.autotvin_OUT_r.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.mibench.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.mibench.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.mibench.autotvin_C.dat"
`define AUTOTB_TVIN_OUT_r_out_wrapc  "./rtl.mibench.autotvin_OUT_r.dat"
`define AUTOTB_TVOUT_OUT_r  "./c.mibench.autotvout_OUT_r.dat"
`define AUTOTB_TVOUT_ap_return  "./c.mibench.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_OUT_r_out_wrapc  "./impl_rtl.mibench.autotvout_OUT_r.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.mibench.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mibench.autotvout_OUT_r.dat", "r");
    fp2 = $fopen("./impl_rtl.mibench.autotvout_OUT_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mibench.autotvout_OUT_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mibench.autotvout_OUT_r.dat\"!");
    else begin
        $display("Comparing rtl.mibench.autotvout_OUT_r.dat with impl_rtl.mibench.autotvout_OUT_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mibench.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.mibench.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mibench.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mibench.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.mibench.autotvout_ap_return.dat with impl_rtl.mibench.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
