...
set id 1
set name mibench_mul_mul_16s_16s_16_1_1
...
set id 2
set name mibench_ama_addmuladd_16ns_16ns_16s_16s_16_1_1
...
set out_width 16
set exp (i0+i1)*i2+i3
set arg_lists {i0 {16 0 +} i1 {16 0 +} s {16 1 +} i2 {16 1 +} m {16 1 +} i3 {16 1 +} p {16 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
