...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mibench.autotvin_A.dat"
         "c.mibench.autotvin_B.dat"
         "c.mibench.autotvin_C.dat"
         "c.mibench.autotvin_OUT_r.dat"
         "c.mibench.autotvout_OUT_r.dat"
         "c.mibench.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mibench.autotvout_OUT_r.dat"
         "rtl.mibench.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
