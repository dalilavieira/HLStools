...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mibench.autotvin.dat"
	set constFileTvOut       "mibench.autotvout.dat"
	set constFileHdlTvIn     "mibench.autohdltvin.dat"
	set constFileHdlTvOut    "mibench.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
