...
architecture rtl of loopback_out_r_rom is 
...
architecture arch of loopback_out_r is
    component loopback_out_r_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    loopback_out_r_rom_U :  component loopback_out_r_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
