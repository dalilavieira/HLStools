...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "loopback.autotvin.dat"
	set constFileTvOut       "loopback.autotvout.dat"
	set constFileHdlTvIn     "loopback.autohdltvin.dat"
	set constFileHdlTvOut    "loopback.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
