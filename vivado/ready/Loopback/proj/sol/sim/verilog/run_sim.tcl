...
if {[file isfile loopback.autotvin.dat]} {
	file delete -force loopback.autotvin.dat
}

if {[file isfile loopback.autotvout.dat]} {
	file delete -force loopback.autotvout.dat
}
