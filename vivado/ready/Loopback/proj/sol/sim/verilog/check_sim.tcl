...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.loopback.autotvin_a.dat"
         "c.loopback.autotvin_out_r.dat"
         "c.loopback.autotvout_out_r.dat"
         "c.loopback.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.loopback.autotvout_out_r.dat"
         "rtl.loopback.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
