...
// ==============================================================
#ifndef __qspline_out_H__
#define __qspline_out_H__
...
struct qspline_out_ram : public sc_core::sc_module {
...
qspline_out_ram* meminst;


SC_CTOR(qspline_out) {
meminst = new qspline_out_ram("qspline_out_ram");
