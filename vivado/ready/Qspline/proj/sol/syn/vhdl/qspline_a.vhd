...
architecture rtl of qspline_a_ram is 
...
architecture arch of qspline_a is
    component qspline_a_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    qspline_a_ram_U :  component qspline_a_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
