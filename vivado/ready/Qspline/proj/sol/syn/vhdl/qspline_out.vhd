...
architecture rtl of qspline_out_ram is 
...
architecture arch of qspline_out is
    component qspline_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    qspline_out_ram_U :  component qspline_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
