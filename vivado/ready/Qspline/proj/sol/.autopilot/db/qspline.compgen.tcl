...
set id 1
set name qspline_mul_mul_16s_16s_32_1_1
...
set id 3
set name qspline_mul_mul_16s_16s_30_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename e \
    op interface \
    ports { e_address0 { O 7 vector } e_ce0 { O 1 bit } e_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename f \
    op interface \
    ports { f_address0 { O 7 vector } f_ce0 { O 1 bit } f_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename g \
    op interface \
    ports { g_address0 { O 7 vector } g_ce0 { O 1 bit } g_q0 { I 16 vector } } \
} "
} else {
