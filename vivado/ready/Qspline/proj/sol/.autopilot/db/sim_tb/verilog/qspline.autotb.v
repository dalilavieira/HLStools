...
`define AUTOTB_TVIN_a  "./c.qspline.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.qspline.autotvin_b.dat"
`define AUTOTB_TVIN_c  "./c.qspline.autotvin_c.dat"
`define AUTOTB_TVIN_e  "./c.qspline.autotvin_e.dat"
`define AUTOTB_TVIN_f  "./c.qspline.autotvin_f.dat"
`define AUTOTB_TVIN_g  "./c.qspline.autotvin_g.dat"
`define AUTOTB_TVIN_out_r  "./c.qspline.autotvin_out_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.qspline.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.qspline.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.qspline.autotvin_c.dat"
`define AUTOTB_TVIN_e_out_wrapc  "./rtl.qspline.autotvin_e.dat"
`define AUTOTB_TVIN_f_out_wrapc  "./rtl.qspline.autotvin_f.dat"
`define AUTOTB_TVIN_g_out_wrapc  "./rtl.qspline.autotvin_g.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.qspline.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.qspline.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return  "./c.qspline.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.qspline.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.qspline.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.qspline.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.qspline.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.qspline.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.qspline.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.qspline.autotvout_out_r.dat with impl_rtl.qspline.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.qspline.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.qspline.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.qspline.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.qspline.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.qspline.autotvout_ap_return.dat with impl_rtl.qspline.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
