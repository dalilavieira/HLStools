...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "qspline.autotvin.dat"
	set constFileTvOut       "qspline.autotvout.dat"
	set constFileHdlTvIn     "qspline.autohdltvin.dat"
	set constFileHdlTvOut    "qspline.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
