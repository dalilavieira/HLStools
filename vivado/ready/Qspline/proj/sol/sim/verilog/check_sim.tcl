...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.qspline.autotvin_a.dat"
         "c.qspline.autotvin_b.dat"
         "c.qspline.autotvin_c.dat"
         "c.qspline.autotvin_e.dat"
         "c.qspline.autotvin_f.dat"
         "c.qspline.autotvin_g.dat"
         "c.qspline.autotvin_out_r.dat"
         "c.qspline.autotvout_out_r.dat"
         "c.qspline.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.qspline.autotvout_out_r.dat"
         "rtl.qspline.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
