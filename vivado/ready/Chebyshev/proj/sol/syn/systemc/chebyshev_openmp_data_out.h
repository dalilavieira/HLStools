...
// ==============================================================
#ifndef __chebyshev_openmp_data_out_H__
#define __chebyshev_openmp_data_out_H__
...
struct chebyshev_openmp_data_out_ram : public sc_core::sc_module {

  static const unsigned DataWidth = 32;
  static const unsigned AddressRange = 67108864;
  static const unsigned AddressWidth = 27;
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(chebyshev_openmp_data_out_ram) {
...
SC_MODULE(chebyshev_openmp_data_out) {
...
chebyshev_openmp_data_out_ram* meminst;


SC_CTOR(chebyshev_openmp_data_out) {
meminst = new chebyshev_openmp_data_out_ram("chebyshev_openmp_data_out_ram");
