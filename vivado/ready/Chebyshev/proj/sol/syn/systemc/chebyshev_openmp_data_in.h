...
// ==============================================================
#ifndef __chebyshev_openmp_data_in_H__
#define __chebyshev_openmp_data_in_H__
...
struct chebyshev_openmp_data_in_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(chebyshev_openmp_data_in_ram) {
...
SC_MODULE(chebyshev_openmp_data_in) {
...
chebyshev_openmp_data_in_ram* meminst;


SC_CTOR(chebyshev_openmp_data_in) {
meminst = new chebyshev_openmp_data_in_ram("chebyshev_openmp_data_in_ram");
