...
entity chebyshev_openmp_data_in_ram is 
    generic(
...
architecture rtl of chebyshev_openmp_data_in_ram is 
...
entity chebyshev_openmp_data_in is
    generic (
...
architecture arch of chebyshev_openmp_data_in is
    component chebyshev_openmp_data_in_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    chebyshev_openmp_data_in_ram_U :  component chebyshev_openmp_data_in_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
