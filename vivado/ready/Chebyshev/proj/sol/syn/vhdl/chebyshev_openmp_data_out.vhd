...
entity chebyshev_openmp_data_out_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 27; 
            MEM_SIZE    : integer := 67108864
    ); 
    port (
...
architecture rtl of chebyshev_openmp_data_out_ram is 
...
entity chebyshev_openmp_data_out is
    generic (
        DataWidth : INTEGER := 32;
        AddressRange : INTEGER := 67108864;
        AddressWidth : INTEGER := 27);
    port (
        reset : IN STD_LOGIC;
        clk : IN STD_LOGIC;
...
architecture arch of chebyshev_openmp_data_out is
    component chebyshev_openmp_data_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    chebyshev_openmp_data_out_ram_U :  component chebyshev_openmp_data_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
