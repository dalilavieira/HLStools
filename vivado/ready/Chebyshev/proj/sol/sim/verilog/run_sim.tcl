...
if {[file isfile chebyshev_openmp.autotvin.dat]} {
	file delete -force chebyshev_openmp.autotvin.dat
}

if {[file isfile chebyshev_openmp.autotvout.dat]} {
	file delete -force chebyshev_openmp.autotvout.dat
}
