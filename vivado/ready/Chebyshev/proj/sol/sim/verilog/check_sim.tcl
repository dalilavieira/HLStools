...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.chebyshev_openmp.autotvin_data_in.dat"
         "c.chebyshev_openmp.autotvin_data_out.dat"
         "c.chebyshev_openmp.autotvout_data_out.dat"
         "c.chebyshev_openmp.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.chebyshev_openmp.autotvout_data_out.dat"
         "rtl.chebyshev_openmp.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
