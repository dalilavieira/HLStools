...
#define AUTOTB_TVOUT_PC_data_out  "../tv/rtldatafile/rtl.chebyshev_openmp.autotvout_data_out.dat"
// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.chebyshev_openmp.autotvout_ap_return.dat"
...
extern int chebyshev_openmp (
short data_in[100],
int data_out[100]);

int AESL_WRAP_chebyshev_openmp (
short data_in[100],
int data_out[100])
{
	...
	else
	{
		...
		sc_bv<16>* data_in_tvin_wrapc_buffer = new sc_bv<16>[100];
		...
		tcl_file.set_num(100, &tcl_file.data_in_depth);
...
// [call_c_dut] ---------->
		...
		int AESL_return = chebyshev_openmp(data_in, data_out);
