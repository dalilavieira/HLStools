...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "chebyshev_openmp.autotvin.dat"
	set constFileTvOut       "chebyshev_openmp.autotvout.dat"
	set constFileHdlTvIn     "chebyshev_openmp.autohdltvin.dat"
	set constFileHdlTvOut    "chebyshev_openmp.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
