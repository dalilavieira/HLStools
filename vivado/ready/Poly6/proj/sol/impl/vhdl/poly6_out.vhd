...
architecture rtl of poly6_out_ram is 
...
architecture arch of poly6_out is
    component poly6_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    poly6_out_ram_U :  component poly6_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
