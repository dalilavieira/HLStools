...
`define AUTOTB_DUT      poly6
`define AUTOTB_DUT_INST AESL_inst_poly6
`define AUTOTB_TOP      apatb_poly6_top
`define AUTOTB_LAT_RESULT_FILE "poly6.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "poly6.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_poly6_top
...
`define AUTOTB_TVIN_a  "./c.poly6.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.poly6.autotvin_b.dat"
`define AUTOTB_TVIN_c  "./c.poly6.autotvin_c.dat"
`define AUTOTB_TVIN_out_r  "./c.poly6.autotvin_out_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.poly6.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.poly6.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.poly6.autotvin_c.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.poly6.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.poly6.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return  "./c.poly6.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.poly6.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.poly6.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 40202;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.poly6.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.poly6.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.poly6.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.poly6.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.poly6.autotvout_out_r.dat with impl_rtl.poly6.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.poly6.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.poly6.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.poly6.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.poly6.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.poly6.autotvout_ap_return.dat with impl_rtl.poly6.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
