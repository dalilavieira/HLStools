...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "poly6.autotvin.dat"
	set constFileTvOut       "poly6.autotvout.dat"
	set constFileHdlTvIn     "poly6.autohdltvin.dat"
	set constFileHdlTvOut    "poly6.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
