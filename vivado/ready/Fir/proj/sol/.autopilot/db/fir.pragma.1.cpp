...
int fir(int16_t coef[100], int16_t data_in[(100)+100], int32_t data_out[(100)+100]){_ssdm_SpecArrayDimSize(coef, 100);_ssdm_SpecArrayDimSize(data_in, 200);_ssdm_SpecArrayDimSize(data_out, 200);
