...
entity fir_data_out_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 16; 
            AWIDTH     : integer := 24; 
            MEM_SIZE    : integer := 8388708
    ); 
    port (
...
architecture rtl of fir_data_out_ram is 
...
entity fir_data_out is
    generic (
        DataWidth : INTEGER := 16;
        AddressRange : INTEGER := 8388708;
...
architecture arch of fir_data_out is
    component fir_data_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    fir_data_out_ram_U :  component fir_data_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
