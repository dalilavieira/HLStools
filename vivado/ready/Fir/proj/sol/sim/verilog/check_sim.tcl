...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fir.autotvin_coef.dat"
         "c.fir.autotvin_data_in.dat"
         "c.fir.autotvin_data_out.dat"
         "c.fir.autotvout_data_out.dat"
         "c.fir.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fir.autotvout_data_out.dat"
         "rtl.fir.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
