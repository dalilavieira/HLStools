...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kmeans.autotvin_data_in.dat"
         "c.kmeans.autotvin_data_out.dat"
         "c.kmeans.autotvin_centroids.dat"
         "c.kmeans.autotvin_num_clusters.dat"
         "c.kmeans.autotvin_num_dim.dat"
         "c.kmeans.autotvout_data_out.dat"
         "c.kmeans.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kmeans.autotvout_data_out.dat"
         "rtl.kmeans.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
