...
entity kmeans_centroids_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 31; 
            AWIDTH     : integer := 20; 
            MEM_SIZE    : integer := 999900
    ); 
    port (
...
architecture rtl of kmeans_centroids_ram is 
...
entity kmeans_centroids is
    generic (
        DataWidth : INTEGER := 31;
        AddressRange : INTEGER := 999900;
...
architecture arch of kmeans_centroids is
    component kmeans_centroids_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    kmeans_centroids_ram_U :  component kmeans_centroids_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
