...
entity kmeans_data_in_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 31; 
            AWIDTH     : integer := 30; 
            MEM_SIZE    : integer := 838860800
    ); 
    port (
...
architecture rtl of kmeans_data_in_ram is 
...
entity kmeans_data_in is
    generic (
        DataWidth : INTEGER := 31;
        AddressRange : INTEGER := 838860800;
...
architecture arch of kmeans_data_in is
    component kmeans_data_in_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    kmeans_data_in_ram_U :  component kmeans_data_in_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
