...
entity kmeans_data_out_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 16; 
            AWIDTH     : integer := 23; 
            MEM_SIZE    : integer := 8388608
    ); 
    port (
...
architecture rtl of kmeans_data_out_ram is 
...
entity kmeans_data_out is
    generic (
        DataWidth : INTEGER := 16;
        AddressRange : INTEGER := 8388608;
...
architecture arch of kmeans_data_out is
    component kmeans_data_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    kmeans_data_out_ram_U :  component kmeans_data_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
