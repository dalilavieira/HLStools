...
// ==============================================================
#ifndef __kmeans_data_in_H__
#define __kmeans_data_in_H__
...
struct kmeans_data_in_ram : public sc_core::sc_module {

  static const unsigned DataWidth = 31;
  static const unsigned AddressRange = 838860800;
  static const unsigned AddressWidth = 30;
...
kmeans_data_in_ram* meminst;


SC_CTOR(kmeans_data_in) {
meminst = new kmeans_data_in_ram("kmeans_data_in_ram");
