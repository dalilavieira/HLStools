...
// ==============================================================
#ifndef __kmeans_centroids_H__
#define __kmeans_centroids_H__
...
struct kmeans_centroids_ram : public sc_core::sc_module {

  static const unsigned DataWidth = 31;
  static const unsigned AddressRange = 999900;
...
kmeans_centroids_ram* meminst;


SC_CTOR(kmeans_centroids) {
meminst = new kmeans_centroids_ram("kmeans_centroids_ram");
