...
if {[file isfile sgfilter.autotvin.dat]} {
	file delete -force sgfilter.autotvin.dat
}

if {[file isfile sgfilter.autotvout.dat]} {
	file delete -force sgfilter.autotvout.dat
}
