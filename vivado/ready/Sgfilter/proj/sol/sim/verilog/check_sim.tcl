...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sgfilter.autotvin_a.dat"
         "c.sgfilter.autotvin_b.dat"
         "c.sgfilter.autotvin_OUT_r.dat"
         "c.sgfilter.autotvout_OUT_r.dat"
         "c.sgfilter.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sgfilter.autotvout_OUT_r.dat"
         "rtl.sgfilter.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
