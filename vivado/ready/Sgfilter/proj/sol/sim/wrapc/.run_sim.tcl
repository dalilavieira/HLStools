...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sgfilter.autotvin.dat"
	set constFileTvOut       "sgfilter.autotvout.dat"
	set constFileHdlTvIn     "sgfilter.autohdltvin.dat"
	set constFileHdlTvOut    "sgfilter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
