...
entity sgfilter_OUT_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 25; 
            MEM_SIZE    : integer := 25952256
    ); 
    port (
...
architecture rtl of sgfilter_OUT_ram is 
...
entity sgfilter_OUT is
    generic (
        DataWidth : INTEGER := 32;
        AddressRange : INTEGER := 25952256;
...
architecture arch of sgfilter_OUT is
    component sgfilter_OUT_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    sgfilter_OUT_ram_U :  component sgfilter_OUT_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
