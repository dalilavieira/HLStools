...
// ==============================================================
#ifndef __sgfilter_a_H__
#define __sgfilter_a_H__
...
struct sgfilter_a_ram : public sc_core::sc_module {
...
sgfilter_a_ram* meminst;


SC_CTOR(sgfilter_a) {
meminst = new sgfilter_a_ram("sgfilter_a_ram");
