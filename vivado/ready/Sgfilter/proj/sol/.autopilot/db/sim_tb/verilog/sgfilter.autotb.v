...
`define AUTOTB_DUT      sgfilter
`define AUTOTB_DUT_INST AESL_inst_sgfilter
`define AUTOTB_TOP      apatb_sgfilter_top
`define AUTOTB_LAT_RESULT_FILE "sgfilter.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sgfilter.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sgfilter_top
...
`define AUTOTB_TVIN_a  "./c.sgfilter.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.sgfilter.autotvin_b.dat"
`define AUTOTB_TVIN_OUT_r  "./c.sgfilter.autotvin_OUT_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.sgfilter.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.sgfilter.autotvin_b.dat"
`define AUTOTB_TVIN_OUT_r_out_wrapc  "./rtl.sgfilter.autotvin_OUT_r.dat"
`define AUTOTB_TVOUT_OUT_r  "./c.sgfilter.autotvout_OUT_r.dat"
`define AUTOTB_TVOUT_ap_return  "./c.sgfilter.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_OUT_r_out_wrapc  "./impl_rtl.sgfilter.autotvout_OUT_r.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.sgfilter.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.sgfilter.autotvout_OUT_r.dat", "r");
    fp2 = $fopen("./impl_rtl.sgfilter.autotvout_OUT_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.sgfilter.autotvout_OUT_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.sgfilter.autotvout_OUT_r.dat\"!");
    else begin
        $display("Comparing rtl.sgfilter.autotvout_OUT_r.dat with impl_rtl.sgfilter.autotvout_OUT_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.sgfilter.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.sgfilter.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.sgfilter.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.sgfilter.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.sgfilter.autotvout_ap_return.dat with impl_rtl.sgfilter.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
