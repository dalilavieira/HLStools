...
architecture rtl of poly8_out_ram is 
...
architecture arch of poly8_out is
    component poly8_out_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    poly8_out_ram_U :  component poly8_out_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
