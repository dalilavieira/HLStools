...
// ==============================================================
#ifndef __poly8_out_H__
#define __poly8_out_H__
...
struct poly8_out_ram : public sc_core::sc_module {
...
poly8_out_ram* meminst;


SC_CTOR(poly8_out) {
meminst = new poly8_out_ram("poly8_out_ram");
