...
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.poly8.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.poly8.autotvin_b.dat"
`define AUTOTB_TVIN_c  "../tv/cdatafile/c.poly8.autotvin_c.dat"
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.poly8.autotvin_out_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.poly8.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.poly8.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.poly8.autotvin_c.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.poly8.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.poly8.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.poly8.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.poly8.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.poly8.autotvout_ap_return.dat"
module `AUTOTB_TOP;
