...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "poly8.autotvin.dat"
	set constFileTvOut       "poly8.autotvout.dat"
	set constFileHdlTvIn     "poly8.autohdltvin.dat"
	set constFileHdlTvOut    "poly8.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
