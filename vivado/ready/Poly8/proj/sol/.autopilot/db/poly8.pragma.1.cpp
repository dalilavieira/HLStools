...
int poly8(int16_t a[(100)],int16_t b[(100)],int16_t c[(100)],int32_t out[(100)]) {_ssdm_SpecArrayDimSize(a, 100);_ssdm_SpecArrayDimSize(b, 100);_ssdm_SpecArrayDimSize(c, 100);_ssdm_SpecArrayDimSize(out, 100);
