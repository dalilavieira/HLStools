set moduleName ttaenc_filter_process_c
set isTopModule 1
...
set C_modelName {ttaenc_filter_process_c}
...
set ArgLastReadFirstWriteLatency {
	ttaenc_filter_process_c {
		...
		dl {Type IO LastRead 12 FirstWrite 12}
		error {Type IO LastRead 0 FirstWrite 15}
