# 1 "extr_.FFmpeglibavcodecsbrdsp.c_sbr_autocorrelate_c_with_main.c"
# 1 "extr_.FFmpeglibavcodecsbrdsp.c_sbr_autocorrelate_c_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavcodecsbrdsp.c_sbr_autocorrelate_c_with_main.c" 2

typedef unsigned long size_t;
typedef int scalar_t__;

typedef int bool;
# 15 "extr_.FFmpeglibavcodecsbrdsp.c_sbr_autocorrelate_c_with_main.c"
void sbr_autocorrelate_c(const float x[40][2], float phi[3][2][2])
{_ssdm_SpecArrayDimSize(x, 40);_ssdm_SpecArrayDimSize(phi, 3);
