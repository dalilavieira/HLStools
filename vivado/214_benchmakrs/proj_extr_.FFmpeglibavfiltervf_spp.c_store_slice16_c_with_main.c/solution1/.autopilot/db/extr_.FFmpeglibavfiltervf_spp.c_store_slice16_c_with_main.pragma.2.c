# 1 "extr_.FFmpeglibavfiltervf_spp.c_store_slice16_c_with_main.c"
# 1 "extr_.FFmpeglibavfiltervf_spp.c_store_slice16_c_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavfiltervf_spp.c_store_slice16_c_with_main.c" 2
...
typedef int int16_t ;
 ...
 void store_slice16_c(uint16_t dst[8], const int16_t src[8],
...
# 33 "extr_.FFmpeglibavfiltervf_spp.c_store_slice16_c_with_main.c"
    for (y = 0; y < height; y++) {
...
# 56 "extr_.FFmpeglibavfiltervf_spp.c_store_slice16_c_with_main.c"
