# 1 "extr_.FFmpeglibavfiltervf_colorbalance.c_apply_lut16_p_with_main.c"
# 1 "extr_.FFmpeglibavfiltervf_colorbalance.c_apply_lut16_p_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavfiltervf_colorbalance.c_apply_lut16_p_with_main.c" 2
...
struct TYPE_9__ {int height; int const* linesize; int width; int ** data; } ;
struct TYPE_8__ {size_t** lut; } ;
...
int main() {
  ...
  int jobnr;
  int nb_jobs;
  apply_lut16_p(ctx, arg, jobnr, nb_jobs);
  return 0;
}
