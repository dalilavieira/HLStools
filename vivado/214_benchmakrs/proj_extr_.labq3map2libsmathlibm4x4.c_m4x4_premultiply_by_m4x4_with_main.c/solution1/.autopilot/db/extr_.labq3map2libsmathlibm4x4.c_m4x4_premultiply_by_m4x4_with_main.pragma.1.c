# 1 "extr_.labq3map2libsmathlibm4x4.c_m4x4_premultiply_by_m4x4_with_main.c"
# 1 "extr_.labq3map2libsmathlibm4x4.c_m4x4_premultiply_by_m4x4_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.labq3map2libsmathlibm4x4.c_m4x4_premultiply_by_m4x4_with_main.c" 2
...
void m4x4_premultiply_by_m4x4( m4x4_t dst, const m4x4_t src ){_ssdm_SpecArrayDimSize(dst, 1000);_ssdm_SpecArrayDimSize(src, 1000);
...
# 75 "extr_.labq3map2libsmathlibm4x4.c_m4x4_premultiply_by_m4x4_with_main.c"
}
int main() {
  m4x4_t dst;
  const m4x4_t src;
_ssdm_SpecConstant(src);
# 78 "extr_.labq3map2libsmathlibm4x4.c_m4x4_premultiply_by_m4x4_with_main.c"

  m4x4_premultiply_by_m4x4(dst, src);
  return 0;
}
