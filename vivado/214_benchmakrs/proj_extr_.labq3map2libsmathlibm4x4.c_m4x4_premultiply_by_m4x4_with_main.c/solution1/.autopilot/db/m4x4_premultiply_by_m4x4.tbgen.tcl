set moduleName m4x4_premultiply_by_m4x4
set isTopModule 1
...
set C_modelName {m4x4_premultiply_by_m4x4}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 32 regular {array 1000 { 2 2 } 1 1 }  }
	{ src int 32 regular {array 1000 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dst", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dst","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} , 
...
set ArgLastReadFirstWriteLatency {
	m4x4_premultiply_by_m4x4 {
		dst {Type IO LastRead 8 FirstWrite 8}
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 10 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 32 }  { dst_q0 mem_dout 0 32 }  { dst_address1 MemPortADDR2 1 10 }  { dst_ce1 MemPortCE2 1 1 }  { dst_we1 MemPortWE2 1 1 }  { dst_d1 MemPortDIN2 1 32 }  { dst_q1 MemPortDOUT2 0 32 } } }
