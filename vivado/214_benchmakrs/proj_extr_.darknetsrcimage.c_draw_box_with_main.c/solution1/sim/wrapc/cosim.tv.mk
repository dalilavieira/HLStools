...
$(ObjDir)/extr_.darknetsrcimage.c_draw_box_with_main.c_pre.c.tb.o : extr_.darknetsrcimage.c_draw_box_with_main.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) extr_.darknetsrcimage.c_draw_box_with_main.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
