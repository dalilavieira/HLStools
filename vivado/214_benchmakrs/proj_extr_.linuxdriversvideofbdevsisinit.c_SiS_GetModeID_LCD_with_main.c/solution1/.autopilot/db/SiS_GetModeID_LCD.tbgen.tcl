...
set C_modelName {SiS_GetModeID_LCD}
...
set C_modelArgList {
	...
	{ Depth int 32 unused  }
	{ FSTN int 32 unused  }
	{ CustomT uint 16 unused  }
	{ LCDwidth int 32 unused  }
	{ LCDheight int 32 unused  }
...
set C_modelArgMapList {[ 
	{ "Name" : "VGAEngine", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "VGAEngine","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "FSTN", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "FSTN","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "CustomT", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "CustomT","cData": "unsigned short","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "LCDwidth", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "LCDwidth","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "LCDheight", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "LCDheight","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ FSTN sc_in sc_lv 32 signal 5 } 
	{ CustomT sc_in sc_lv 16 signal 6 } 
	{ LCDwidth sc_in sc_lv 32 signal 7 } 
	{ LCDheight sc_in sc_lv 32 signal 8 } 
	{ VBFlags2 sc_in sc_lv 32 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_start", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "start", "bundle":{"name": "ap_start", "role": "default" }} , 
 	...
 	{ "name": "FSTN", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "FSTN", "role": "default" }} , 
 	{ "name": "CustomT", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "CustomT", "role": "default" }} , 
 	{ "name": "LCDwidth", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "LCDwidth", "role": "default" }} , 
 	{ "name": "LCDheight", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "LCDheight", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "FSTN", "Type" : "None", "Direction" : "I"},
			{"Name" : "CustomT", "Type" : "None", "Direction" : "I"},
			{"Name" : "LCDwidth", "Type" : "None", "Direction" : "I"},
			{"Name" : "LCDheight", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	SiS_GetModeID_LCD {
		...
		FSTN {Type I LastRead -1 FirstWrite -1}
		CustomT {Type I LastRead -1 FirstWrite -1}
		LCDwidth {Type I LastRead -1 FirstWrite -1}
		LCDheight {Type I LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	FSTN { ap_none {  { FSTN in_data 0 32 } } }
	CustomT { ap_none {  { CustomT in_data 0 16 } } }
	LCDwidth { ap_none {  { LCDwidth in_data 0 32 } } }
	LCDheight { ap_none {  { LCDheight in_data 0 32 } } }
