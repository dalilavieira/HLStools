...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "draw_box.autotvin.dat"
	set constFileTvOut       "draw_box.autotvout.dat"
	set constFileHdlTvIn     "draw_box.autohdltvin.dat"
	set constFileHdlTvOut    "draw_box.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
