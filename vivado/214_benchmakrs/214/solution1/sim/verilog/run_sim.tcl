...
if {[file isfile draw_box.autotvin.dat]} {
	file delete -force draw_box.autotvin.dat
}

if {[file isfile draw_box.autotvout.dat]} {
	file delete -force draw_box.autotvout.dat
}
