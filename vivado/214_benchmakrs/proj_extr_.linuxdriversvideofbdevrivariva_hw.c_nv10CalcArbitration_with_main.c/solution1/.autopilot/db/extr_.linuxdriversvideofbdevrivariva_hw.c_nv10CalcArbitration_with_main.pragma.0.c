# 1 "extr_.linuxdriversvideofbdevrivariva_hw.c_nv10CalcArbitration_with_main.c"
# 1 "extr_.linuxdriversvideofbdevrivariva_hw.c_nv10CalcArbitration_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.linuxdriversvideofbdevrivariva_hw.c_nv10CalcArbitration_with_main.c" 2
...
)
{
    ...
    while(found != 1) {
      ...
      if(video_enable) {
        ...
        clwm = us_crt * crtc_drain_rate/(1000*1000);
        clwm++;
# 178 "extr_.linuxdriversvideofbdevrivariva_hw.c_nv10CalcArbitration_with_main.c"
          if(width == 1){
