# 1 "extr_.FFmpeglibavfiltervf_colorbalance.c_apply_lut8_p_with_main.c"
# 1 "extr_.FFmpeglibavfiltervf_colorbalance.c_apply_lut8_p_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavfiltervf_colorbalance.c_apply_lut8_p_with_main.c" 2
...
struct TYPE_9__ {int height; size_t** data; int const* linesize; int width; } ;
...
int main() {
  ...
  int jobnr;
  int nb_jobs;
  apply_lut8_p(ctx, arg, jobnr, nb_jobs);
  return 0;
}
