...
set C_modelName {put_obmc}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 32 regular {array 100 { 0 0 } 0 1 }  }
	{ src int 32 regular {array 500 { 1 1 } 1 1 }  }
	{ stride int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dst", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dst","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
 	{ "Name" : "src", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "src","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1},{"low" : 0,"up" : 4,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "dst", "role": "address0" }} , 
 	...
 	{ "name": "dst_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "dst", "role": "address1" }} , 
 	...
 	{ "name": "src_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "src", "role": "address0" }} , 
 	...
 	{ "name": "src_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "src", "role": "address1" }} , 
...
set ArgLastReadFirstWriteLatency {
	put_obmc {
		...
		src {Type I LastRead 84 FirstWrite -1}
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 7 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 32 }  { dst_address1 MemPortADDR2 1 7 }  { dst_ce1 MemPortCE2 1 1 }  { dst_we1 MemPortWE2 1 1 }  { dst_d1 MemPortDIN2 1 32 } } }
	src { ap_memory {  { src_address0 mem_address 1 9 }  { src_ce0 mem_ce 1 1 }  { src_q0 mem_dout 0 32 }  { src_address1 MemPortADDR2 1 9 }  { src_ce1 MemPortCE2 1 1 }  { src_q1 MemPortDOUT2 0 32 } } }
