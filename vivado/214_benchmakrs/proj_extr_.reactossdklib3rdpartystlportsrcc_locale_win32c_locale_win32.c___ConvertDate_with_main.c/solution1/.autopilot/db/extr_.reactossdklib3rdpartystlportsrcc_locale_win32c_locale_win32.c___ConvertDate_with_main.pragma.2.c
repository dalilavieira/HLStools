# 1 "extr_.reactossdklib3rdpartystlportsrcc_locale_win32c_locale_win32.c___ConvertDate_with_main.c"
# 1 "extr_.reactossdklib3rdpartystlportsrcc_locale_win32c_locale_win32.c___ConvertDate_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.reactossdklib3rdpartystlportsrcc_locale_win32c_locale_win32.c___ConvertDate_with_main.c" 2

typedef unsigned long size_t;
typedef int scalar_t__;

typedef int bool;
# 15 "extr_.reactossdklib3rdpartystlportsrcc_locale_win32c_locale_win32.c___ConvertDate_with_main.c"
int __ConvertDate(const char NTDate[200], char buffer[200], int buf_size) {_ssdm_SpecArrayDimSize(NTDate, 200);_ssdm_SpecArrayDimSize(buffer, 200);
...
int main() {
  ...
  char * buffer;
  int buf_size;
  __ConvertDate(NTDate, buffer, buf_size);
  return 0;
}
