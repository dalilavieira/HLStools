...
set C_modelName {Mat4Multiply}
set C_modelType { void 0 }
set C_modelArgList {
	{ in1 int 32 regular {array 1000 { 1 1 } 1 1 }  }
	{ in2 int 32 regular {array 1000 { 1 1 } 1 1 }  }
	{ out_r int 32 regular {array 1000 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in1","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} , 
 	{ "Name" : "in2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in2","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in1", "role": "address0" }} , 
 	...
 	{ "name": "in1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in1", "role": "address1" }} , 
 	...
 	{ "name": "in2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in2", "role": "address0" }} , 
 	...
 	{ "name": "in2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in2", "role": "address1" }} , 
...
set ArgLastReadFirstWriteLatency {
	Mat4Multiply {
		in1 {Type I LastRead 8 FirstWrite -1}
...
set Spec2ImplPortList { 
	in1 { ap_memory {  { in1_address0 mem_address 1 10 }  { in1_ce0 mem_ce 1 1 }  { in1_q0 mem_dout 0 32 }  { in1_address1 MemPortADDR2 1 10 }  { in1_ce1 MemPortCE2 1 1 }  { in1_q1 MemPortDOUT2 0 32 } } }
	in2 { ap_memory {  { in2_address0 mem_address 1 10 }  { in2_ce0 mem_ce 1 1 }  { in2_q0 mem_dout 0 32 }  { in2_address1 MemPortADDR2 1 10 }  { in2_ce1 MemPortCE2 1 1 }  { in2_q1 MemPortDOUT2 0 32 } } }
