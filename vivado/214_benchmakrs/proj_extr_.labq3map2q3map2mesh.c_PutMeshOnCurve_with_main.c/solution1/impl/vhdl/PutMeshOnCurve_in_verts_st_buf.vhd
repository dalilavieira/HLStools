...
entity PutMeshOnCurve_in_verts_st_buf_ram is 
    generic(
...
architecture rtl of PutMeshOnCurve_in_verts_st_buf_ram is 
...
entity PutMeshOnCurve_in_verts_st_buf is
    generic (
...
architecture arch of PutMeshOnCurve_in_verts_st_buf is
    component PutMeshOnCurve_in_verts_st_buf_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    PutMeshOnCurve_in_verts_st_buf_ram_U :  component PutMeshOnCurve_in_verts_st_buf_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
