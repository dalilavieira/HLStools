...
// ==============================================================
`timescale 1 ns / 1 ps
module PutMeshOnCurve_in_verts_st_buf_ram (addr0, ce0, d0, we0, q0, addr1, ce1, d1, we1, q1,  clk);
...
`timescale 1 ns / 1 ps
module PutMeshOnCurve_in_verts_st_buf(
    reset,
    clk,
    address0,
    ce0,
...
PutMeshOnCurve_in_verts_st_buf_ram PutMeshOnCurve_in_verts_st_buf_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
