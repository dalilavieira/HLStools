...
set C_modelName {ifwht}
set C_modelType { void 0 }
set C_modelArgList {
	{ block_r int 32 regular {array 20 { 1 1 } 1 1 }  }
	{ output_block int 32 regular {array 20 { 2 2 } 1 1 }  }
	{ intra int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "block_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "block","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 19,"step" : 1}]}]}]} , 
 	{ "Name" : "output_block", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "output_block","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 19,"step" : 1}]}]}]} , 
...
set ArgLastReadFirstWriteLatency {
	ifwht {
		...
		output_block {Type IO LastRead 11 FirstWrite 5}
