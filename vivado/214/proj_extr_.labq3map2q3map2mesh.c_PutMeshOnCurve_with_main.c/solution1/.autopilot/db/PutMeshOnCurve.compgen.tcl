...
set id 1
set name PutMeshOnCurve_fadd_32ns_32ns_32_4_full_dsp_1
...
set id 2
set name PutMeshOnCurve_fptrunc_64ns_32_2_1
...
set id 4
set name PutMeshOnCurve_fpext_32ns_64_2_1
...
set id 5
set name PutMeshOnCurve_dadd_64ns_64ns_64_5_full_dsp_1
...
set id 7
set name PutMeshOnCurve_dmul_64ns_64ns_64_5_max_dsp_1
...
set ID 14
set hasByteEnable 0
set MemName PutMeshOnCurve_in_verts_st_buf
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename in_verts_xyz \
    op interface \
    ports { in_verts_xyz_address0 { O 20 vector } in_verts_xyz_ce0 { O 1 bit } in_verts_xyz_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_verts_xyz'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename in_verts_st \
    op interface \
    ports { in_verts_st_address0 { O 20 vector } in_verts_st_ce0 { O 1 bit } in_verts_st_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_verts_st'"
}
}
