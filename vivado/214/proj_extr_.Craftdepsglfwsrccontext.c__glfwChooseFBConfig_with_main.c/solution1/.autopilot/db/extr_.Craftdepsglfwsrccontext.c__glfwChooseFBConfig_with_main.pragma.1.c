# 1 "extr_.Craftdepsglfwsrccontext.c__glfwChooseFBConfig_with_main.c"
# 1 "extr_.Craftdepsglfwsrccontext.c__glfwChooseFBConfig_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.Craftdepsglfwsrccontext.c__glfwChooseFBConfig_with_main.c" 2
...
int main() {
  ...
  const _GLFWfbconfig * alternatives;
  unsigned int count;
  _glfwChooseFBConfig(desired, alternatives, count);
  return 0;
}
