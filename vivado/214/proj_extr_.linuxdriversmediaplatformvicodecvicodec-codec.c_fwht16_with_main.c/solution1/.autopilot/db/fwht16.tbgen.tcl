...
set C_modelName {fwht16}
set C_modelType { void 0 }
set C_modelArgList {
	{ block_r int 32 regular {array 100 { 1 1 } 1 1 }  }
	{ output_block int 32 regular {array 100 { 2 2 } 1 1 }  }
	{ stride int 32 regular  }
	{ intra int 32 unused  }
}
set C_modelArgMapList {[ 
	{ "Name" : "block_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "block","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
 	{ "Name" : "output_block", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "output_block","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ output_block_address1 sc_out sc_lv 7 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_r_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "block_r", "role": "address0" }} , 
 	...
 	{ "name": "block_r_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "block_r", "role": "address1" }} , 
 	...
 	{ "name": "output_block_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "output_block", "role": "address0" }} , 
 	...
 	{ "name": "output_block_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "output_block", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	block_r { ap_memory {  { block_r_address0 mem_address 1 7 }  { block_r_ce0 mem_ce 1 1 }  { block_r_q0 mem_dout 0 32 }  { block_r_address1 MemPortADDR2 1 7 }  { block_r_ce1 MemPortCE2 1 1 }  { block_r_q1 MemPortDOUT2 0 32 } } }
	output_block { ap_memory {  { output_block_address0 mem_address 1 7 }  { output_block_ce0 mem_ce 1 1 }  { output_block_we0 mem_we 1 1 }  { output_block_d0 mem_din 1 32 }  { output_block_q0 mem_dout 0 32 }  { output_block_address1 MemPortADDR2 1 7 }  { output_block_ce1 MemPortCE2 1 1 }  { output_block_we1 MemPortWE2 1 1 }  { output_block_d1 MemPortDIN2 1 32 }  { output_block_q1 MemPortDOUT2 0 32 } } }
