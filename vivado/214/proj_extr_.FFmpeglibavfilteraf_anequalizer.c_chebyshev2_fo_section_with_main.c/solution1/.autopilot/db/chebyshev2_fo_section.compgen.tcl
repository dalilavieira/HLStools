...
set id 1
set name chebyshev2_fo_section_dadddsub_64ns_64ns_64_5_full_dsp_1
...
set id 4
set name chebyshev2_fo_section_dsub_64ns_64ns_64_5_full_dsp_1
...
set id 5
set name chebyshev2_fo_section_dadd_64ns_64ns_64_5_full_dsp_1
...
set id 8
set name chebyshev2_fo_section_dmul_64ns_64ns_64_5_max_dsp_1
...
set id 17
set name chebyshev2_fo_section_ddiv_64ns_64ns_64_22_1
...
set id 22
set name chebyshev2_fo_section_dcmp_64ns_64ns_1_2_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_b0 \
    op interface \
    ports { S_b0 { O 64 vector } S_b0_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_b1 \
    op interface \
    ports { S_b1 { O 32 vector } S_b1_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_b2 \
    op interface \
    ports { S_b2 { O 64 vector } S_b2_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_b3 \
    op interface \
    ports { S_b3 { O 32 vector } S_b3_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_b4 \
    op interface \
    ports { S_b4 { O 64 vector } S_b4_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_a0 \
    op interface \
    ports { S_a0 { O 32 vector } S_a0_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_a1 \
    op interface \
    ports { S_a1 { O 32 vector } S_a1_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_a2 \
    op interface \
    ports { S_a2 { O 64 vector } S_a2_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_a3 \
    op interface \
    ports { S_a3 { O 32 vector } S_a3_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S_a4 \
    op interface \
    ports { S_a4 { O 64 vector } S_a4_ap_vld { O 1 bit } } \
} "
}
