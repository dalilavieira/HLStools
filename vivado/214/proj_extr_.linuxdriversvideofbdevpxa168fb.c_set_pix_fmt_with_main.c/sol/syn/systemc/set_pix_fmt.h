...
#ifndef _set_pix_fmt_HH_
#define _set_pix_fmt_HH_
...
struct set_pix_fmt : public sc_module {
    ...
    // Module declarations
    set_pix_fmt(sc_module_name name);
    SC_HAS_PROCESS(set_pix_fmt);
    ...
    sc_signal< sc_lv<32> > pix_fmt_read_read_fu_70_p2;
    ...
    void thread_pix_fmt_read_read_fu_70_p2();
