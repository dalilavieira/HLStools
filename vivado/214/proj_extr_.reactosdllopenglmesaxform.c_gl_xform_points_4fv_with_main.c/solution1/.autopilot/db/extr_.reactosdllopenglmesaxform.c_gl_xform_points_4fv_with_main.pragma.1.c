# 1 "extr_.reactosdllopenglmesaxform.c_gl_xform_points_4fv_with_main.c"
# 1 "extr_.reactosdllopenglmesaxform.c_gl_xform_points_4fv_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.reactosdllopenglmesaxform.c_gl_xform_points_4fv_with_main.c" 2
...
void gl_xform_points_4fv( GLuint n, GLfloat q[300][4], const GLfloat m[16],
                          GLfloat p[300][4] )
{_ssdm_SpecArrayDimSize(q, 300);_ssdm_SpecArrayDimSize(m, 16);_ssdm_SpecArrayDimSize(p, 300);
