# 1 "extr_.kphp-kdbtargtarg-search.c_postprocess_res_std_with_main.c"
# 1 "extr_.kphp-kdbtargtarg-search.c_postprocess_res_std_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.kphp-kdbtargtarg-search.c_postprocess_res_std_with_main.c" 2

typedef unsigned long size_t;
typedef int scalar_t__;

typedef int bool;
# 14 "extr_.kphp-kdbtargtarg-search.c_postprocess_res_std_with_main.c"
 int Q_limit ;
 int Q_order ;
 size_t* R ;
 int R_cnt ;
