# 1 "extr_.FFmpeglibswscalergb2rgb_template.c_planar2x_c_with_main.c"
# 1 "extr_.FFmpeglibswscalergb2rgb_template.c_planar2x_c_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibswscalergb2rgb_template.c_planar2x_c_with_main.c" 2
