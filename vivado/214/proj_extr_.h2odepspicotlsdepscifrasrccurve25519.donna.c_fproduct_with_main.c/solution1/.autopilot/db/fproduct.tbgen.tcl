...
set C_modelName {fproduct}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 32 regular {array 1000 { 0 0 } 0 1 }  }
	{ in2 int 32 regular {array 1000 { 1 1 } 1 1 }  }
	{ in_r int 32 regular {array 1000 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "output","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "in_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ in_r_q1 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	in_r { ap_memory {  { in_r_address0 mem_address 1 10 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 32 }  { in_r_address1 MemPortADDR2 1 10 }  { in_r_ce1 MemPortCE2 1 1 }  { in_r_q1 MemPortDOUT2 0 32 } } }
}
