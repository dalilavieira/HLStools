...
set C_modelArgMapList {[ 
	{ "Name" : "h", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "h","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "g", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "g","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ g_address1 sc_out sc_lv 10 signal 2 } 
	{ g_ce1 sc_out sc_logic 1 signal 2 } 
	{ g_q1 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fe_mul_mac_muladd_13s_7s_32s_32_1_1_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fe_mul {
		h {Type O LastRead -1 FirstWrite 14}
		f {Type I LastRead 6 FirstWrite -1}
		g {Type I LastRead 5 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	g { ap_memory {  { g_address0 mem_address 1 10 }  { g_ce0 mem_ce 1 1 }  { g_q0 mem_dout 0 32 }  { g_address1 MemPortADDR2 1 10 }  { g_ce1 MemPortCE2 1 1 }  { g_q1 MemPortDOUT2 0 32 } } }
}
