# 1 "extr_.emscriptensystemliblibcmuslsrccryptcrypt_des.c___do_des_with_main.c"
# 1 "extr_.emscriptensystemliblibcmuslsrccryptcrypt_des.c___do_des_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.emscriptensystemliblibcmuslsrccryptcrypt_des.c___do_des_with_main.c" 2
...
int main() {
  ...
  __do_des(l_in, r_in, l_out, r_out, count, saltbits, ekey);
  return 0;
}
