# 1 "extr_.kphp-kdbisearchutf8_utils.c_translit_from_en_to_ru_with_main.c"
# 1 "extr_.kphp-kdbisearchutf8_utils.c_translit_from_en_to_ru_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.kphp-kdbisearchutf8_utils.c_translit_from_en_to_ru_with_main.c" 2

typedef unsigned long size_t;
typedef int scalar_t__;

typedef int bool;
# 14 "extr_.kphp-kdbisearchutf8_utils.c_translit_from_en_to_ru_with_main.c"
 long long HASH_MUL ;
 int _a_10_ ;
 int _a_11_ ;
 int _a_12_ ;
...
# 168 "extr_.kphp-kdbisearchutf8_utils.c_translit_from_en_to_ru_with_main.c"
  *hn = 0;
  int *ns = s, i;
  long long h = 0, nh = 0;
