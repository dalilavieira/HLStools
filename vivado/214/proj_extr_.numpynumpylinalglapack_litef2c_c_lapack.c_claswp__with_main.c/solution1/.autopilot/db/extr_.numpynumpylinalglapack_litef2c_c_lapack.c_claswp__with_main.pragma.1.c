# 1 "extr_.numpynumpylinalglapack_litef2c_c_lapack.c_claswp__with_main.c"
# 1 "extr_.numpynumpylinalglapack_litef2c_c_lapack.c_claswp__with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.numpynumpylinalglapack_litef2c_c_lapack.c_claswp__with_main.c" 2
...
{_ssdm_SpecArrayDimSize(a, 1000);_ssdm_SpecArrayDimSize(ipiv, 1000);
    ...
    static complex temp;
# 87 "extr_.numpynumpylinalglapack_litef2c_c_lapack.c_claswp__with_main.c"
    a_dim1 = *lda;
    a_offset = 1 + a_dim1;
    a -= a_offset;
    --ipiv;
