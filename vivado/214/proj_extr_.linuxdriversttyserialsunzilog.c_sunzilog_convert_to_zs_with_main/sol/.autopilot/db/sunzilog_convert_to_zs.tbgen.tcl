set moduleName sunzilog_convert_to_zs
set isTopModule 1
...
set C_modelName {sunzilog_convert_to_zs}
set C_modelType { void 0 }
set C_modelArgList {
	{ up_curregs int 32 regular {array 100 { 2 3 } 1 1 }  }
...
set ArgLastReadFirstWriteLatency {
	sunzilog_convert_to_zs {
		up_curregs {Type IO LastRead 23 FirstWrite 0}
		up_parity_mask {Type O LastRead -1 FirstWrite 24}
		up_port_read_status_mask {Type O LastRead -1 FirstWrite 24}
		up_port_ignore_status_mask {Type O LastRead -1 FirstWrite 23}
		cflag {Type I LastRead -1 FirstWrite -1}
		iflag {Type I LastRead -1 FirstWrite -1}
		brg {Type I LastRead 6 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	up_curregs { ap_memory {  { up_curregs_address0 mem_address 1 7 }  { up_curregs_ce0 mem_ce 1 1 }  { up_curregs_we0 mem_we 1 1 }  { up_curregs_d0 mem_din 1 32 }  { up_curregs_q0 mem_dout 0 32 } } }
