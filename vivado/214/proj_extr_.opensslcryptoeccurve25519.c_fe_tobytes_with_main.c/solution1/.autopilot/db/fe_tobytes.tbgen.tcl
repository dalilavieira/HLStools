...
set C_modelName {fe_tobytes}
set C_modelType { void 0 }
set C_modelArgList {
	{ s int 32 regular {array 10000 { 0 0 } 0 1 }  }
	{ h int 32 unused {array 1000 { } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "s","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 9999,"step" : 1}]}]}]} , 
 	{ "Name" : "h", "interface" : "memory", "bitwidth" : 32, "direction" : "NONE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "h","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ s_address0 sc_out sc_lv 14 signal 0 } 
	{ s_ce0 sc_out sc_logic 1 signal 0 } 
	{ s_we0 sc_out sc_logic 1 signal 0 } 
	{ s_d0 sc_out sc_lv 32 signal 0 } 
	{ s_address1 sc_out sc_lv 14 signal 0 } 
	{ s_ce1 sc_out sc_logic 1 signal 0 } 
	{ s_we1 sc_out sc_logic 1 signal 0 } 
	{ s_d1 sc_out sc_lv 32 signal 0 } 
	{ h_address0 sc_out sc_lv 10 signal 1 } 
	{ h_ce0 sc_out sc_logic 1 signal 1 } 
	{ h_we0 sc_out sc_logic 1 signal 1 } 
	{ h_d0 sc_out sc_lv 32 signal 1 } 
	{ h_q0 sc_in sc_lv 32 signal 1 } 
	{ h_address1 sc_out sc_lv 10 signal 1 } 
	{ h_ce1 sc_out sc_logic 1 signal 1 } 
	{ h_we1 sc_out sc_logic 1 signal 1 } 
	{ h_d1 sc_out sc_lv 32 signal 1 } 
	{ h_q1 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "s", "role": "address0" }} , 
 	...
 	{ "name": "s_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "s", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "h", "Type" : "Memory", "Direction" : "X"}]}]}


set ArgLastReadFirstWriteLatency {
	fe_tobytes {
		s {Type O LastRead -1 FirstWrite 0}
		h {Type X LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	s { ap_memory {  { s_address0 mem_address 1 14 }  { s_ce0 mem_ce 1 1 }  { s_we0 mem_we 1 1 }  { s_d0 mem_din 1 32 }  { s_address1 MemPortADDR2 1 14 }  { s_ce1 MemPortCE2 1 1 }  { s_we1 MemPortWE2 1 1 }  { s_d1 MemPortDIN2 1 32 } } }
	h { ap_memory {  { h_address0 mem_address 1 10 }  { h_ce0 mem_ce 1 1 }  { h_we0 mem_we 1 1 }  { h_d0 mem_din 1 32 }  { h_q0 mem_dout 0 32 }  { h_address1 MemPortADDR2 1 10 }  { h_ce1 MemPortCE2 1 1 }  { h_we1 MemPortWE2 1 1 }  { h_d1 MemPortDIN2 1 32 }  { h_q1 MemPortDOUT2 0 32 } } }
}
