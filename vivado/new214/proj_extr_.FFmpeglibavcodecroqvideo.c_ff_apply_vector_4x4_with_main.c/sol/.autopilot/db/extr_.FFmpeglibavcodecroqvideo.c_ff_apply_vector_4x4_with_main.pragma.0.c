# 1 "extr_.FFmpeglibavcodecroqvideo.c_ff_apply_vector_4x4_with_main.c"
# 1 "extr_.FFmpeglibavcodecroqvideo.c_ff_apply_vector_4x4_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavcodecroqvideo.c_ff_apply_vector_4x4_with_main.c" 2
...
void ff_apply_vector_4x4(volatile RoqContext *ri, int x, int y, volatile roq_cell *cell)
{
    unsigned char *bptr;
    int boffs,stride;
