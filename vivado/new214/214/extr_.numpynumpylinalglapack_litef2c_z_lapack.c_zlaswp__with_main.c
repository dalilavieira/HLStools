...
int zlaswp_(volatile integer *n, volatile doublecomplex *a, volatile integer *lda,
	volatile integer *k1,volatile integer *k2, volatile integer *ipiv, volatile integer *incx)
{
