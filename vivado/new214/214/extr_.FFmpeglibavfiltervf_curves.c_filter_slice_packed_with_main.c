...
__attribute__((used)) static int filter_slice_packed(volatile AVFilterContext *ctx, volatile void *arg, int jobnr, int nb_jobs)
{
    int x, y;
    ...
    return 0;
}/* Main routine for filter_slice_packed */
int main() {
  AVFilterContext * ctx;
  void * arg;
  int jobnr;
