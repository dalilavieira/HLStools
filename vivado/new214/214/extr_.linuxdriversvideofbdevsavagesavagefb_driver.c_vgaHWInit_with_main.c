...
__attribute__((used)) static void vgaHWInit(volatile struct fb_var_screeninfo *var,
		     volatile struct savagefb_par            *par,
		     volatile struct xtimings                *timings,
		     volatile struct savage_reg              *reg)
{
	reg->MiscOutReg = 0x23;
