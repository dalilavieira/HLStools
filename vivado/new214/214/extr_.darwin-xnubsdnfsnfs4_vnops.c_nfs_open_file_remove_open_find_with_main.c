...
nfs_open_file_remove_open_find(
	volatile struct nfs_open_file *nofp,
	uint32_t accessMode,
	uint32_t denyMode,
	volatile uint32_t *newAccessMode,
	volatile uint32_t *newDenyMode,
	volatile int *delegated)
{
	/*
...
}/* Main routine for nfs_open_file_remove_open_find */
int main() {
