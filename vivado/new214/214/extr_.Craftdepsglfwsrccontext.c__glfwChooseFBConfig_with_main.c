...
const _GLFWfbconfig* _glfwChooseFBConfig(volatile const _GLFWfbconfig* desired,
                                         volatile const _GLFWfbconfig* alternatives,
                                         unsigned int count)
{
    unsigned int i;
    ...
    return closest;
}/* Main routine for _glfwChooseFBConfig */
int main() {
