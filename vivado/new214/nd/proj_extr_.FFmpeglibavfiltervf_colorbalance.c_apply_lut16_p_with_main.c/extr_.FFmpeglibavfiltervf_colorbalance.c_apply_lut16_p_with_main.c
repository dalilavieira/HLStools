...
struct TYPE_9__ {int height; int const* linesize; int width; int /*<<< orphan*/ ** data; } ;
...
__attribute__((used)) static int apply_lut16_p(volatile AVFilterContext *ctx,volatile void *arg, int jobnr, int nb_jobs)
{
    ...
    return 0;
}/* Main routine for apply_lut16_p */
int main() {
  AVFilterContext * ctx;
  void * arg;
  int jobnr;
