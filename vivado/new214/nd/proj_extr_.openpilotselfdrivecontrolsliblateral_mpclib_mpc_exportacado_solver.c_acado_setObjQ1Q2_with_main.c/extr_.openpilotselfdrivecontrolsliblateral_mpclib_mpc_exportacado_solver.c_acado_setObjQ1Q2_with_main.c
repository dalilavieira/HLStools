...
void acado_setObjQ1Q2(volatile real_t* const tmpFx,volatile real_t* const tmpObjS, volatile real_t* const tmpQ1,volatile real_t* const tmpQ2 )
{
...
}/* Main routine for acado_setObjQ1Q2 */
int main() {
  real_t *const tmpFx;
