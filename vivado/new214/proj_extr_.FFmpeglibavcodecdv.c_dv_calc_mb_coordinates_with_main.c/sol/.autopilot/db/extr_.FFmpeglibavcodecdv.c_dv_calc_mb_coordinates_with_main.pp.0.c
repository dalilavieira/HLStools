...
__attribute__((used)) static inline void dv_calc_mb_coordinates(volatile const AVDVProfile *d, int chan,
                                          int seq, int slot, volatile uint16_t *tbl)
{
...
# 30 "extr_.FFmpeglibavcodecdv.c_dv_calc_mb_coordinates_with_main.c"
...
# 33 "extr_.FFmpeglibavcodecdv.c_dv_calc_mb_coordinates_with_main.c"
...
# 35 "extr_.FFmpeglibavcodecdv.c_dv_calc_mb_coordinates_with_main.c"
...
# 42 "extr_.FFmpeglibavcodecdv.c_dv_calc_mb_coordinates_with_main.c"
...
# 48 "extr_.FFmpeglibavcodecdv.c_dv_calc_mb_coordinates_with_main.c"
