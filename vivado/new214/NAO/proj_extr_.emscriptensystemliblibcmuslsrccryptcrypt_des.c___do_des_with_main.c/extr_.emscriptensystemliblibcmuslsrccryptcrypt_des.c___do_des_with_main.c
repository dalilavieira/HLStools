...
void __do_des(uint32_t l_in, volatile uint32_t r_in,
    volatile uint32_t *l_out, volatile uint32_t *r_out,
    uint32_t count, uint32_t saltbits, volatile const struct expanded_key *ekey)
{
	uint32_t l, r;
