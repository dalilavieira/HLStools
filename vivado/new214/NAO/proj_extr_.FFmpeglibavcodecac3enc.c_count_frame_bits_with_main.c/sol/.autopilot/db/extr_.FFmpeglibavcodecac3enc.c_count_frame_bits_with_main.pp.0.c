# 1 "extr_.FFmpeglibavcodecac3enc.c_count_frame_bits_with_main.c"
# 1 "extr_.FFmpeglibavcodecac3enc.c_count_frame_bits_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavcodecac3enc.c_count_frame_bits_with_main.c" 2
...
__attribute__((used)) static void count_frame_bits(volatile AC3EncodeContext *s)
{
