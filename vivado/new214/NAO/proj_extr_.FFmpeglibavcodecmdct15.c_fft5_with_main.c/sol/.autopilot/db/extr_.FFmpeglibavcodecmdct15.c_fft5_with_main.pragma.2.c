# 1 "extr_.FFmpeglibavcodecmdct15.c_fft5_with_main.c"
# 1 "extr_.FFmpeglibavcodecmdct15.c_fft5_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.FFmpeglibavcodecmdct15.c_fft5_with_main.c" 2
...
__attribute__((used)) static inline void fft5(volatile FFTComplex *out,volatile FFTComplex *in, FFTComplex exptab[2])
{_ssdm_SpecArrayDimSize(exptab, 2);
    FFTComplex z0[4], t[6];
