# 1 "extr_.kphp-kdbhintsutf8_utils.c_translit_from_ru_to_en_with_main.c"
# 1 "extr_.kphp-kdbhintsutf8_utils.c_translit_from_ru_to_en_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.kphp-kdbhintsutf8_utils.c_translit_from_ru_to_en_with_main.c" 2

typedef unsigned long size_t;
typedef int scalar_t__;

typedef int bool;
# 14 "extr_.kphp-kdbhintsutf8_utils.c_translit_from_ru_to_en_with_main.c"
 long long HASH_MUL ;
 int _a_44_ ;
 int _a_45_ ;
 int _a_46_ ;
...
# 147 "extr_.kphp-kdbhintsutf8_utils.c_translit_from_ru_to_en_with_main.c"
  *hn = 0;
  int *ns = s, i;
  long long h = 0, nh = 0;
