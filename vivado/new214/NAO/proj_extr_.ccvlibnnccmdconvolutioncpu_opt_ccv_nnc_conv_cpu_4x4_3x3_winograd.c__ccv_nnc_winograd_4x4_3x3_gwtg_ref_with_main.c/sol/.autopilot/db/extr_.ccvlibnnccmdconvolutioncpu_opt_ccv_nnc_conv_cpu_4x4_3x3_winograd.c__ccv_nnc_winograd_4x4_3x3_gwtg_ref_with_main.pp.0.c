...
typedef int bool;
# 16 "extr_.ccvlibnnccmdconvolutioncpu_opt_ccv_nnc_conv_cpu_4x4_3x3_winograd.c__ccv_nnc_winograd_4x4_3x3_gwtg_ref_with_main.c"
__attribute__((used)) void _ccv_nnc_winograd_4x4_3x3_gwtg_ref(volatile const float* const w, const int c,volatile float* gwtg)
{
 int i;
 for (i = 0; i < c; i++)
 {
  float g[18];
# 34 "extr_.ccvlibnnccmdconvolutioncpu_opt_ccv_nnc_conv_cpu_4x4_3x3_winograd.c__ccv_nnc_winograd_4x4_3x3_gwtg_ref_with_main.c"
  g[0] = w[i] / 4;
  g[1] = w[c + i] / 4;
  g[2] = w[2 * c + i] / 4;
  ...
  g[16] = w[7 * c + i];
  g[17] = w[8 * c + i];
# 72 "extr_.ccvlibnnccmdconvolutioncpu_opt_ccv_nnc_conv_cpu_4x4_3x3_winograd.c__ccv_nnc_winograd_4x4_3x3_gwtg_ref_with_main.c"
  gwtg[0] = g[0] / 4;
