...
__attribute__((used)) uint32_t _ccv_sparse_matrix_index_for_hash(const uint32_t hash, const int prime_index)
{
	switch(prime_index)
	{
	case 0:
...
}/* Main routine for _ccv_sparse_matrix_index_for_hash */
int main() {
  const uint32_t hash;
