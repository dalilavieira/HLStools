# 1 "extr_.disquedepsjemallocsrcctl.c_ctl_arena_stats_smerge_with_main.c"
# 1 "extr_.disquedepsjemallocsrcctl.c_ctl_arena_stats_smerge_with_main.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "extr_.disquedepsjemallocsrcctl.c_ctl_arena_stats_smerge_with_main.c" 2
...
ctl_arena_stats_smerge(volatile ctl_arena_stats_t *sstats, volatile ctl_arena_stats_t *astats)
{
 unsigned i;
