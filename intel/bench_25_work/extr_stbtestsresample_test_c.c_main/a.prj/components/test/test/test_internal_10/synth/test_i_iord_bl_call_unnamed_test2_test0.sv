...
// SystemVerilog created from test_i_iord_bl_call_unnamed_test2_test0
...
module test_i_iord_bl_call_unnamed_test2_test0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_test_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_test_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_test_i_fifodata),
    ...
    assign out_iord_bl_call_test_o_fifoready = iord_o_fifoready;
