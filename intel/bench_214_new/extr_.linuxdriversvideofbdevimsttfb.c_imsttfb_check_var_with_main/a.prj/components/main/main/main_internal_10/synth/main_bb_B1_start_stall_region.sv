...
module main_bb_B1_start_stall_region (
    ...
    // i_cmp14_i_main12(LOGICAL,14)@11
    assign i_cmp14_i_main12_q = $unsigned(bubble_select_i_llvm_fpga_mem_unnamed_main2_main11_b != c_i32_026_q ? 1'b1 : 1'b0);

    // i_notcmp_main14(LOGICAL,25)@11
    assign i_notcmp_main14_q = i_cmp14_i_main12_q ^ VCC_q;
