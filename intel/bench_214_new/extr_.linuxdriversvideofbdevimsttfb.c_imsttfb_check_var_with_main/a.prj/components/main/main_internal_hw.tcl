...
#### Parameter FB_VMODE_NONINTERLACED interface
add_interface FB_VMODE_NONINTERLACED conduit sink
set_interface_property FB_VMODE_NONINTERLACED associatedClock clock
set_interface_property FB_VMODE_NONINTERLACED associatedReset reset
set_interface_assignment FB_VMODE_NONINTERLACED hls.cosim.name {@FB_VMODE_NONINTERLACED}
add_interface_port FB_VMODE_NONINTERLACED FB_VMODE_NONINTERLACED data input 64
