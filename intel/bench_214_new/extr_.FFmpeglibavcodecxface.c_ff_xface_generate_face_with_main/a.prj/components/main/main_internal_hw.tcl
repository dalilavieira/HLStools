...
add_fileset_file "main_i_llvm_fpga_mem_pr1_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_mem_pr1_0.sv"
add_fileset_file "main_readdata_reg_pr1_0.sv" SYSTEM_VERILOG PATH "ip/main_readdata_reg_pr1_0.sv"
...
#### Parameter XFACE_HEIGHT interface
add_interface XFACE_HEIGHT conduit sink
set_interface_property XFACE_HEIGHT associatedClock clock
set_interface_property XFACE_HEIGHT associatedReset reset
set_interface_assignment XFACE_HEIGHT hls.cosim.name {@XFACE_HEIGHT}
add_interface_port XFACE_HEIGHT XFACE_HEIGHT data input 64
