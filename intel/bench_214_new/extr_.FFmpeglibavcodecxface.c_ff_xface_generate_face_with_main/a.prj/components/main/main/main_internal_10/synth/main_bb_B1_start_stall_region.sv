...
module main_bb_B1_start_stall_region (
    ...
    input wire [63:0] in_pr1_main_avm_readdata,
    input wire [0:0] in_pr1_main_avm_writeack,
    input wire [0:0] in_pr1_main_avm_waitrequest,
    input wire [0:0] in_pr1_main_avm_readdatavalid,
    ...
    output wire [63:0] out_pr1_main_avm_address,
    output wire [0:0] out_pr1_main_avm_enable,
    output wire [0:0] out_pr1_main_avm_read,
    output wire [0:0] out_pr1_main_avm_write,
    output wire [63:0] out_pr1_main_avm_writedata,
    output wire [7:0] out_pr1_main_avm_byteenable,
    output wire [0:0] out_pr1_main_avm_burstcount,
    ...
    wire [31:0] i_iowr_bl_return_main_unnamed_main2_main19_out_iowr_bl_return_main_o_fifodata;
    wire [0:0] i_iowr_bl_return_main_unnamed_main2_main19_out_iowr_bl_return_main_o_fifovalid;
    wire [0:0] i_iowr_bl_return_main_unnamed_main2_main19_out_o_stall;
    wire [0:0] i_iowr_bl_return_main_unnamed_main2_main19_out_o_valid;
    wire [31:0] i_llvm_fpga_mem_pr1_main11_out_o_readdata;
    wire [0:0] i_llvm_fpga_mem_pr1_main11_out_o_stall;
    wire [0:0] i_llvm_fpga_mem_pr1_main11_out_o_valid;
    wire [63:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_address;
    wire [0:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_burstcount;
    wire [7:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_byteenable;
    wire [0:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_enable;
    wire [0:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_read;
    wire [0:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_write;
    wire [63:0] i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_writedata;
    ...
    wire [31:0] bubble_join_i_llvm_fpga_mem_pr1_main11_q;
    wire [31:0] bubble_select_i_llvm_fpga_mem_pr1_main11_b;
    ...
    wire [0:0] SE_out_i_iowr_bl_return_main_unnamed_main2_main19_wireValid;
    wire [0:0] SE_out_i_iowr_bl_return_main_unnamed_main2_main19_and0;
    wire [0:0] SE_out_i_iowr_bl_return_main_unnamed_main2_main19_and1;
    wire [0:0] SE_out_i_iowr_bl_return_main_unnamed_main2_main19_backStall;
    wire [0:0] SE_out_i_iowr_bl_return_main_unnamed_main2_main19_V0;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_wireValid;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_wireStall;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_StallValid;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_toReg0;
    reg [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_fromReg0;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_consumed0;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_toReg1;
    reg [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_fromReg1;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_consumed1;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_or0;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_backStall;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_V0;
    wire [0:0] SE_out_i_llvm_fpga_mem_pr1_main11_V1;
    ...
    // i_llvm_fpga_mem_pr1_main11(BLACKBOX,17)@3
    // in in_i_stall@20000000
    // out out_o_readdata@11
    // out out_o_stall@20000000
    // out out_o_valid@11
    // out out_pr1_main_avm_address@20000000
    // out out_pr1_main_avm_burstcount@20000000
    // out out_pr1_main_avm_byteenable@20000000
    // out out_pr1_main_avm_enable@20000000
    // out out_pr1_main_avm_read@20000000
    // out out_pr1_main_avm_write@20000000
    // out out_pr1_main_avm_writedata@20000000
    main_i_llvm_fpga_mem_pr1_0 thei_llvm_fpga_mem_pr1_main11 (
        .in_flush(in_flush),
        .in_i_address(bubble_select_i_iord_bl_call_main_unnamed_main1_main9_aunroll_x_b),
        .in_i_predicate(i_xor_main7_q),
        .in_i_stall(SE_out_i_llvm_fpga_mem_pr1_main11_backStall),
        .in_i_valid(SE_out_i_iord_bl_call_main_unnamed_main1_main9_aunroll_x_V0),
        .in_pr1_main_avm_readdata(in_pr1_main_avm_readdata),
        .in_pr1_main_avm_readdatavalid(in_pr1_main_avm_readdatavalid),
        .in_pr1_main_avm_waitrequest(in_pr1_main_avm_waitrequest),
        .in_pr1_main_avm_writeack(in_pr1_main_avm_writeack),
        .out_o_readdata(i_llvm_fpga_mem_pr1_main11_out_o_readdata),
        .out_o_stall(i_llvm_fpga_mem_pr1_main11_out_o_stall),
        .out_o_valid(i_llvm_fpga_mem_pr1_main11_out_o_valid),
        .out_pr1_main_avm_address(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_address),
        .out_pr1_main_avm_burstcount(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_burstcount),
        .out_pr1_main_avm_byteenable(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_byteenable),
        .out_pr1_main_avm_enable(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_enable),
        .out_pr1_main_avm_read(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_read),
        .out_pr1_main_avm_write(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_write),
        .out_pr1_main_avm_writedata(i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_writedata),
        .clock(clock),
        .resetn(resetn)
    );

    // SE_out_i_llvm_fpga_mem_pr1_main11(STALLENABLE,141)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            SE_out_i_llvm_fpga_mem_pr1_main11_fromReg0 <= '0;
            SE_out_i_llvm_fpga_mem_pr1_main11_fromReg1 <= '0;
        end
        else
        begin
            // Successor 0
            SE_out_i_llvm_fpga_mem_pr1_main11_fromReg0 <= SE_out_i_llvm_fpga_mem_pr1_main11_toReg0;
            // Successor 1
            SE_out_i_llvm_fpga_mem_pr1_main11_fromReg1 <= SE_out_i_llvm_fpga_mem_pr1_main11_toReg1;
        end
    end
    // Input Stall processing
    assign SE_out_i_llvm_fpga_mem_pr1_main11_consumed0 = (~ (SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_backStall) & SE_out_i_llvm_fpga_mem_pr1_main11_wireValid) | SE_out_i_llvm_fpga_mem_pr1_main11_fromReg0;
    assign SE_out_i_llvm_fpga_mem_pr1_main11_consumed1 = (~ (SE_out_redist4_i_xor_main7_q_8_fifo_backStall) & SE_out_i_llvm_fpga_mem_pr1_main11_wireValid) | SE_out_i_llvm_fpga_mem_pr1_main11_fromReg1;
    // Consuming
    assign SE_out_i_llvm_fpga_mem_pr1_main11_StallValid = SE_out_i_llvm_fpga_mem_pr1_main11_backStall & SE_out_i_llvm_fpga_mem_pr1_main11_wireValid;
    assign SE_out_i_llvm_fpga_mem_pr1_main11_toReg0 = SE_out_i_llvm_fpga_mem_pr1_main11_StallValid & SE_out_i_llvm_fpga_mem_pr1_main11_consumed0;
    assign SE_out_i_llvm_fpga_mem_pr1_main11_toReg1 = SE_out_i_llvm_fpga_mem_pr1_main11_StallValid & SE_out_i_llvm_fpga_mem_pr1_main11_consumed1;
    // Backward Stall generation
    assign SE_out_i_llvm_fpga_mem_pr1_main11_or0 = SE_out_i_llvm_fpga_mem_pr1_main11_consumed0;
    assign SE_out_i_llvm_fpga_mem_pr1_main11_wireStall = ~ (SE_out_i_llvm_fpga_mem_pr1_main11_consumed1 & SE_out_i_llvm_fpga_mem_pr1_main11_or0);
    assign SE_out_i_llvm_fpga_mem_pr1_main11_backStall = SE_out_i_llvm_fpga_mem_pr1_main11_wireStall;
    // Valid signal propagation
    assign SE_out_i_llvm_fpga_mem_pr1_main11_V0 = SE_out_i_llvm_fpga_mem_pr1_main11_wireValid & ~ (SE_out_i_llvm_fpga_mem_pr1_main11_fromReg0);
    assign SE_out_i_llvm_fpga_mem_pr1_main11_V1 = SE_out_i_llvm_fpga_mem_pr1_main11_wireValid & ~ (SE_out_i_llvm_fpga_mem_pr1_main11_fromReg1);
    // Computing multiple Valid(s)
    assign SE_out_i_llvm_fpga_mem_pr1_main11_wireValid = i_llvm_fpga_mem_pr1_main11_out_o_valid;
    ...
    assign SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_consumed1 = (~ (SE_out_i_iowr_bl_return_main_unnamed_main2_main19_backStall) & SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_wireValid) | SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_fromReg1;
    // Consuming
    ...
    assign SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_wireValid = SE_out_i_llvm_fpga_mem_pr1_main11_V0 & SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_and0;
    ...
    // Backward Stall generation
    assign SE_out_i_iord_bl_call_main_unnamed_main1_main9_aunroll_x_backStall = i_llvm_fpga_mem_pr1_main11_out_o_stall | ~ (SE_out_i_iord_bl_call_main_unnamed_main1_main9_aunroll_x_wireValid);
    // Computing multiple Valid(s)
    ...
    // bubble_join_i_llvm_fpga_mem_pr1_main11(BITJOIN,104)
    assign bubble_join_i_llvm_fpga_mem_pr1_main11_q = i_llvm_fpga_mem_pr1_main11_out_o_readdata;

    // bubble_select_i_llvm_fpga_mem_pr1_main11(BITSELECT,105)
    assign bubble_select_i_llvm_fpga_mem_pr1_main11_b = $unsigned(bubble_join_i_llvm_fpga_mem_pr1_main11_q[31:0]);

    // i_cmp_i_main12(COMPARE,14)@11
    assign i_cmp_i_main12_a = $unsigned({{2{bubble_select_i_llvm_fpga_mem_pr1_main11_b[31]}}, bubble_select_i_llvm_fpga_mem_pr1_main11_b});
    ...
    // i_iowr_bl_return_main_unnamed_main2_main19(BLACKBOX,16)@11
    // in in_i_stall@20000000
    // out out_iowr_bl_return_main_o_fifodata@20000000
    // out out_iowr_bl_return_main_o_fifovalid@20000000
    // out out_o_stall@20000000
    main_i_iowr_bl_return_unnamed_main2_main0 thei_iowr_bl_return_main_unnamed_main2_main19 (
        .in_i_data(c_i32_027_q),
        .in_i_stall(SE_out_i_iowr_bl_return_main_unnamed_main2_main19_backStall),
        .in_i_valid(SE_out_redist4_i_xor_main7_q_8_fifo_V1),
        .in_iowr_bl_return_main_i_fifoready(in_iowr_bl_return_main_i_fifoready),
        .in_or(i_or_main16_q),
        .out_iowr_bl_return_main_o_fifodata(i_iowr_bl_return_main_unnamed_main2_main19_out_iowr_bl_return_main_o_fifodata),
        .out_iowr_bl_return_main_o_fifovalid(i_iowr_bl_return_main_unnamed_main2_main19_out_iowr_bl_return_main_o_fifovalid),
        .out_o_ack(),
        .out_o_stall(i_iowr_bl_return_main_unnamed_main2_main19_out_o_stall),
        .out_o_valid(i_iowr_bl_return_main_unnamed_main2_main19_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    assign SE_out_redist4_i_xor_main7_q_8_fifo_consumed1 = (~ (i_iowr_bl_return_main_unnamed_main2_main19_out_o_stall) & SE_out_redist4_i_xor_main7_q_8_fifo_wireValid) | SE_out_redist4_i_xor_main7_q_8_fifo_fromReg1;
    // Consuming
    ...
    assign SE_out_redist4_i_xor_main7_q_8_fifo_wireValid = SE_out_i_llvm_fpga_mem_pr1_main11_V1 & SE_out_redist4_i_xor_main7_q_8_fifo_and0;
    ...
    // SE_out_i_iowr_bl_return_main_unnamed_main2_main19(STALLENABLE,139)
    // Valid signal propagation
    assign SE_out_i_iowr_bl_return_main_unnamed_main2_main19_V0 = SE_out_i_iowr_bl_return_main_unnamed_main2_main19_wireValid;
    // Backward Stall generation
    assign SE_out_i_iowr_bl_return_main_unnamed_main2_main19_backStall = in_stall_in | ~ (SE_out_i_iowr_bl_return_main_unnamed_main2_main19_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_iowr_bl_return_main_unnamed_main2_main19_and0 = i_iowr_bl_return_main_unnamed_main2_main19_out_o_valid;
    assign SE_out_i_iowr_bl_return_main_unnamed_main2_main19_and1 = SE_out_redist3_i_first_cleanup_main2_sel_x_b_8_fifo_V1 & SE_out_i_iowr_bl_return_main_unnamed_main2_main19_and0;
    assign SE_out_i_iowr_bl_return_main_unnamed_main2_main19_wireValid = SE_out_i_sfc_s_c0_in_wt_entry_mains_c0_enter1_main5_aunroll_x_V0 & SE_out_i_iowr_bl_return_main_unnamed_main2_main19_and1;
    ...
    // Input Stall processing
    assign SE_out_i_sfc_s_c0_in_wt_entry_mains_c0_enter1_main5_aunroll_x_consumed0 = (~ (SE_out_i_iowr_bl_return_main_unnamed_main2_main19_backStall) & SE_out_i_sfc_s_c0_in_wt_entry_mains_c0_enter1_main5_aunroll_x_wireValid) | SE_out_i_sfc_s_c0_in_wt_entry_mains_c0_enter1_main5_aunroll_x_fromReg0;
    ...
    assign out_valid_out = SE_out_i_iowr_bl_return_main_unnamed_main2_main19_V0;

    // dupName_1_ext_sig_sync_out_x(GPOUT,62)
    assign out_pr1_main_avm_address = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_address;
    assign out_pr1_main_avm_enable = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_enable;
    assign out_pr1_main_avm_read = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_read;
    assign out_pr1_main_avm_write = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_write;
    assign out_pr1_main_avm_writedata = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_writedata;
    assign out_pr1_main_avm_byteenable = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_byteenable;
    assign out_pr1_main_avm_burstcount = i_llvm_fpga_mem_pr1_main11_out_pr1_main_avm_burstcount;

    // dupName_2_ext_sig_sync_out_x(GPOUT,63)
    assign out_iowr_bl_return_main_o_fifodata = i_iowr_bl_return_main_unnamed_main2_main19_out_iowr_bl_return_main_o_fifodata;
    assign out_iowr_bl_return_main_o_fifovalid = i_iowr_bl_return_main_unnamed_main2_main19_out_iowr_bl_return_main_o_fifovalid;
