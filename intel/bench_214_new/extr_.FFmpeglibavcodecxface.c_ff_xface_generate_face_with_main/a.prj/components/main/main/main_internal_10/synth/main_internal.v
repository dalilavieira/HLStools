...
(
   ...
   (
      ...
      // AVM avm_pr1_main
      .avm_pr1_main_enable(avmm_0_global_avm_enable[0]),
      .avm_pr1_main_read(avmm_0_global_avm_read[0]),
      .avm_pr1_main_write(avmm_0_global_avm_write[0]),
      .avm_pr1_main_address(avmm_0_global_avm_address[0]),
      .avm_pr1_main_writedata(avmm_0_global_avm_writedata[0]),
      .avm_pr1_main_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_pr1_main_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_pr1_main_readdata(avmm_0_global_avm_readdata[0]),
      .avm_pr1_main_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_pr1_main_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_pr1_main_writeack(avmm_0_global_avm_writeack[0])
   );
