...
module main_bb_B1_start (
    ...
    wire [63:0] bb_main_B1_start_stall_region_out_pr1_main_avm_address;
    wire [0:0] bb_main_B1_start_stall_region_out_pr1_main_avm_burstcount;
    wire [7:0] bb_main_B1_start_stall_region_out_pr1_main_avm_byteenable;
    wire [0:0] bb_main_B1_start_stall_region_out_pr1_main_avm_enable;
    wire [0:0] bb_main_B1_start_stall_region_out_pr1_main_avm_read;
    wire [0:0] bb_main_B1_start_stall_region_out_pr1_main_avm_write;
    wire [63:0] bb_main_B1_start_stall_region_out_pr1_main_avm_writedata;
    ...
    main_bb_B1_start_stall_region thebb_main_B1_start_stall_region (
        ...
        .out_pr1_main_avm_address(bb_main_B1_start_stall_region_out_pr1_main_avm_address),
        .out_pr1_main_avm_burstcount(bb_main_B1_start_stall_region_out_pr1_main_avm_burstcount),
        .out_pr1_main_avm_byteenable(bb_main_B1_start_stall_region_out_pr1_main_avm_byteenable),
        .out_pr1_main_avm_enable(bb_main_B1_start_stall_region_out_pr1_main_avm_enable),
        .out_pr1_main_avm_read(bb_main_B1_start_stall_region_out_pr1_main_avm_read),
        .out_pr1_main_avm_write(bb_main_B1_start_stall_region_out_pr1_main_avm_write),
        .out_pr1_main_avm_writedata(bb_main_B1_start_stall_region_out_pr1_main_avm_writedata),
    ...
    // out_pr1_main_avm_address(GPOUT,24)
    assign out_pr1_main_avm_address = bb_main_B1_start_stall_region_out_pr1_main_avm_address;

    // out_pr1_main_avm_burstcount(GPOUT,25)
    assign out_pr1_main_avm_burstcount = bb_main_B1_start_stall_region_out_pr1_main_avm_burstcount;

    // out_pr1_main_avm_byteenable(GPOUT,26)
    assign out_pr1_main_avm_byteenable = bb_main_B1_start_stall_region_out_pr1_main_avm_byteenable;

    // out_pr1_main_avm_enable(GPOUT,27)
    assign out_pr1_main_avm_enable = bb_main_B1_start_stall_region_out_pr1_main_avm_enable;

    // out_pr1_main_avm_read(GPOUT,28)
    assign out_pr1_main_avm_read = bb_main_B1_start_stall_region_out_pr1_main_avm_read;

    // out_pr1_main_avm_write(GPOUT,29)
    assign out_pr1_main_avm_write = bb_main_B1_start_stall_region_out_pr1_main_avm_write;

    // out_pr1_main_avm_writedata(GPOUT,30)
    assign out_pr1_main_avm_writedata = bb_main_B1_start_stall_region_out_pr1_main_avm_writedata;
