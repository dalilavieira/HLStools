...
(
   ...
   (
      ...
      // AVM avm_memdep_1_main
      .avm_memdep_1_main_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_1_main_read(avmm_0_global_avm_read[0]),
      .avm_memdep_1_main_write(avmm_0_global_avm_write[0]),
      .avm_memdep_1_main_address(avmm_0_global_avm_address[0]),
      .avm_memdep_1_main_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_1_main_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_1_main_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_1_main_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_1_main_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_1_main_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_1_main_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_main1_main
      .avm_unnamed_main1_main_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_main1_main_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_main1_main_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_main1_main_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_main1_main_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_main1_main_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_main1_main_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_main1_main_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_main1_main_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_main1_main_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_main1_main_writeack(avmm_0_global_avm_writeack[1])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of main_internal_ic_4428217573090046649
      main_internal_ic_4428217573090046649 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE main_internal_ic_4428217573090046649
/////////////////////////////////////////////////////////////////
module main_internal_ic_4428217573090046649
(
   input logic clock,
