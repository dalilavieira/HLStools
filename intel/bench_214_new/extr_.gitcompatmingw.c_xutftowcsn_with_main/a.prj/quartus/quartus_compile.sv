module quartus_compile (
	...
	, input logic [63:0] main_EINVAL
	, input logic [63:0] main_errno
	...
	logic [63:0] main_EINVAL_reg;
	logic [63:0] main_errno_reg;
	...
	always @(posedge clock) begin
		...
		main_EINVAL_reg <= main_EINVAL;
		main_errno_reg <= main_errno;
	...
	main main_inst (
		...
		, .EINVAL(main_EINVAL_reg)
		, .errno(main_errno_reg)
