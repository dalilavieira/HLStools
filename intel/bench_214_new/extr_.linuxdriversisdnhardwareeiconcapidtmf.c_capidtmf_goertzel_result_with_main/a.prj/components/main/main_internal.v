...
(
   input logic clock,
   input logic resetn,
   input logic [63:0] CAPIDTMF_RECV_TOTAL_FREQUENCY_COUNT,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   ...
   (
      .clock(clock),
      .resetn(resetn),
      .CAPIDTMF_RECV_TOTAL_FREQUENCY_COUNT(CAPIDTMF_RECV_TOTAL_FREQUENCY_COUNT),
      .start(start),
      .busy(busy),
      .done(done),
      .stall(stall),
      ...
      .avm_unnamed_main2_main_enable(avmm_0_global_avm_enable[0]),
      .avm_unnamed_main2_main_read(avmm_0_global_avm_read[0]),
      .avm_unnamed_main2_main_write(avmm_0_global_avm_write[0]),
      .avm_unnamed_main2_main_address(avmm_0_global_avm_address[0]),
      .avm_unnamed_main2_main_writedata(avmm_0_global_avm_writedata[0]),
      .avm_unnamed_main2_main_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_unnamed_main2_main_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_unnamed_main2_main_readdata(avmm_0_global_avm_readdata[0]),
      .avm_unnamed_main2_main_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_unnamed_main2_main_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_unnamed_main2_main_writeack(avmm_0_global_avm_writeack[0])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of main_internal_ic_11797103729985604047
      main_internal_ic_11797103729985604047 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE main_internal_ic_11797103729985604047
/////////////////////////////////////////////////////////////////
module main_internal_ic_11797103729985604047
(
   input logic clock,
