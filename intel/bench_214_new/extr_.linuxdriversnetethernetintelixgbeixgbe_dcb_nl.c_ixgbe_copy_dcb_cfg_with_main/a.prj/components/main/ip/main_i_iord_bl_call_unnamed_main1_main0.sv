...
// SystemVerilog created from main_i_iord_bl_call_unnamed_main1_main0
...
module main_i_iord_bl_call_unnamed_main1_main0 (
    ...
    assign iord_i_predicate = in_xor;
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,20)@3
