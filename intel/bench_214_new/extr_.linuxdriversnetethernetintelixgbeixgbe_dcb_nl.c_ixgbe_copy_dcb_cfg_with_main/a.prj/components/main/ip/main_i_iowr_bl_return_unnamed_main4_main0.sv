...
// SystemVerilog created from main_i_iowr_bl_return_unnamed_main4_main0
...
module main_i_iowr_bl_return_unnamed_main4_main0 (
    ...
    assign iowr_i_predicate = in_first_cleanup_xor7_or;
