...
add_fileset_file "main_i_iowr_bl_return_unnamed_main4_main0.sv" SYSTEM_VERILOG PATH "ip/main_i_iowr_bl_return_unnamed_main4_main0.sv"
add_fileset_file "main_i_llvm_fpga_mem_lm1_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_mem_lm1_0.sv"
add_fileset_file "main_readdata_reg_lm1_2.sv" SYSTEM_VERILOG PATH "ip/main_readdata_reg_lm1_2.sv"
add_fileset_file "main_i_llvm_fpga_mem_lm42_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_mem_lm42_0.sv"
add_fileset_file "main_readdata_reg_lm42_3.sv" SYSTEM_VERILOG PATH "ip/main_readdata_reg_lm42_3.sv"
...
add_fileset_file "main_i_llvm_fpga_mem_unnamed_3_main0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_mem_unnamed_3_main0.sv"
add_fileset_file "main_readdata_reg_unnamed_3_main1.sv" SYSTEM_VERILOG PATH "ip/main_readdata_reg_unnamed_3_main1.sv"
...
add_fileset_file "main_i_llvm_fpga_pop_i17_cleanups_pop4_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_pop_i17_cleanups_pop4_0.sv"
add_fileset_file "main_i_llvm_fpga_pop_i17_cleanups_pop4_0_reg.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_pop_i17_cleanups_pop4_0_reg.sv"
add_fileset_file "main_i_llvm_fpga_push_i17_cleanups_push4_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_push_i17_cleanups_push4_0.sv"
add_fileset_file "main_i_llvm_fpga_push_i17_cleanups_push4_31_reg.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_push_i17_cleanups_push4_31_reg.sv"
...
add_fileset_file "main_i_llvm_fpga_push_i1_notexitcond_25_reg.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_push_i1_notexitcond_25_reg.sv"
...
add_fileset_file "main_i_llvm_fpga_pop_i17_initerations_pop3_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_pop_i17_initerations_pop3_0.sv"
add_fileset_file "main_i_llvm_fpga_push_i17_initerations_push3_0.sv" SYSTEM_VERILOG PATH "ip/main_i_llvm_fpga_push_i17_initerations_push3_0.sv"
...
#### Parameter DCB_PFC_UP_ATTR_0 interface
add_interface DCB_PFC_UP_ATTR_0 conduit sink
set_interface_property DCB_PFC_UP_ATTR_0 associatedClock clock
set_interface_property DCB_PFC_UP_ATTR_0 associatedReset reset
set_interface_assignment DCB_PFC_UP_ATTR_0 hls.cosim.name {@DCB_PFC_UP_ATTR_0}
add_interface_port DCB_PFC_UP_ATTR_0 DCB_PFC_UP_ATTR_0 data input 64

#### Parameter DCB_PFC_UP_ATTR_MAX interface
add_interface DCB_PFC_UP_ATTR_MAX conduit sink
set_interface_property DCB_PFC_UP_ATTR_MAX associatedClock clock
set_interface_property DCB_PFC_UP_ATTR_MAX associatedReset reset
set_interface_assignment DCB_PFC_UP_ATTR_MAX hls.cosim.name {@DCB_PFC_UP_ATTR_MAX}
add_interface_port DCB_PFC_UP_ATTR_MAX DCB_PFC_UP_ATTR_MAX data input 64

#### Parameter DCB_PG_ATTR_BW_ID_0 interface
add_interface DCB_PG_ATTR_BW_ID_0 conduit sink
set_interface_property DCB_PG_ATTR_BW_ID_0 associatedClock clock
set_interface_property DCB_PG_ATTR_BW_ID_0 associatedReset reset
set_interface_assignment DCB_PG_ATTR_BW_ID_0 hls.cosim.name {@DCB_PG_ATTR_BW_ID_0}
add_interface_port DCB_PG_ATTR_BW_ID_0 DCB_PG_ATTR_BW_ID_0 data input 64

#### Parameter DCB_PG_ATTR_BW_ID_MAX interface
add_interface DCB_PG_ATTR_BW_ID_MAX conduit sink
set_interface_property DCB_PG_ATTR_BW_ID_MAX associatedClock clock
set_interface_property DCB_PG_ATTR_BW_ID_MAX associatedReset reset
set_interface_assignment DCB_PG_ATTR_BW_ID_MAX hls.cosim.name {@DCB_PG_ATTR_BW_ID_MAX}
add_interface_port DCB_PG_ATTR_BW_ID_MAX DCB_PG_ATTR_BW_ID_MAX data input 64
