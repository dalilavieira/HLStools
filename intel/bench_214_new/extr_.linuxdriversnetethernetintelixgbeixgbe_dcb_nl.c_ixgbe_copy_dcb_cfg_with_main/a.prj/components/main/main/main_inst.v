	main u0 (
		...
		.DCB_PFC_UP_ATTR_0     (_connected_to_DCB_PFC_UP_ATTR_0_),     //   input,  width = 64,     DCB_PFC_UP_ATTR_0.data
		.DCB_PFC_UP_ATTR_MAX   (_connected_to_DCB_PFC_UP_ATTR_MAX_),   //   input,  width = 64,   DCB_PFC_UP_ATTR_MAX.data
		.DCB_PG_ATTR_BW_ID_0   (_connected_to_DCB_PG_ATTR_BW_ID_0_),   //   input,  width = 64,   DCB_PG_ATTR_BW_ID_0.data
		.DCB_PG_ATTR_BW_ID_MAX (_connected_to_DCB_PG_ATTR_BW_ID_MAX_), //   input,  width = 64, DCB_PG_ATTR_BW_ID_MAX.data
