...
module main (
	...
	main_internal main_internal_inst (
		...
		.DCB_PFC_UP_ATTR_0     (DCB_PFC_UP_ATTR_0),     //   input,  width = 64,     DCB_PFC_UP_ATTR_0.data
		.DCB_PFC_UP_ATTR_MAX   (DCB_PFC_UP_ATTR_MAX),   //   input,  width = 64,   DCB_PFC_UP_ATTR_MAX.data
		.DCB_PG_ATTR_BW_ID_0   (DCB_PG_ATTR_BW_ID_0),   //   input,  width = 64,   DCB_PG_ATTR_BW_ID_0.data
		.DCB_PG_ATTR_BW_ID_MAX (DCB_PG_ATTR_BW_ID_MAX), //   input,  width = 64, DCB_PG_ATTR_BW_ID_MAX.data
