...
(
   input logic clock,
   input logic resetn,
   input logic [63:0] DCB_PFC_UP_ATTR_0,
   input logic [63:0] DCB_PFC_UP_ATTR_MAX,
   input logic [63:0] DCB_PG_ATTR_BW_ID_0,
   input logic [63:0] DCB_PG_ATTR_BW_ID_MAX,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   ...
   // INST main_internal of main_function_wrapper
   main_function_wrapper main_internal
   (
      .clock(clock),
      .resetn(resetn),
      .DCB_PFC_UP_ATTR_0(DCB_PFC_UP_ATTR_0),
      .DCB_PFC_UP_ATTR_MAX(DCB_PFC_UP_ATTR_MAX),
      .DCB_PG_ATTR_BW_ID_0(DCB_PG_ATTR_BW_ID_0),
      .DCB_PG_ATTR_BW_ID_MAX(DCB_PG_ATTR_BW_ID_MAX),
      .start(start),
      .busy(busy),
      .done(done),
      .stall(stall),
      ...
      // AVM avm_lm1_main
      .avm_lm1_main_enable(avmm_0_global_avm_enable[0]),
      .avm_lm1_main_read(avmm_0_global_avm_read[0]),
      .avm_lm1_main_write(avmm_0_global_avm_write[0]),
      .avm_lm1_main_address(avmm_0_global_avm_address[0]),
      .avm_lm1_main_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm1_main_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm1_main_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm1_main_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm1_main_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm1_main_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm1_main_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_lm42_main
      .avm_lm42_main_enable(avmm_0_global_avm_enable[1]),
      .avm_lm42_main_read(avmm_0_global_avm_read[1]),
      .avm_lm42_main_write(avmm_0_global_avm_write[1]),
      .avm_lm42_main_address(avmm_0_global_avm_address[1]),
      .avm_lm42_main_writedata(avmm_0_global_avm_writedata[1]),
      .avm_lm42_main_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_lm42_main_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_lm42_main_readdata(avmm_0_global_avm_readdata[1]),
      .avm_lm42_main_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_lm42_main_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_lm42_main_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_unnamed_main2_main
      .avm_unnamed_main2_main_enable(avmm_0_global_avm_enable[2]),
      .avm_unnamed_main2_main_read(avmm_0_global_avm_read[2]),
      .avm_unnamed_main2_main_write(avmm_0_global_avm_write[2]),
      .avm_unnamed_main2_main_address(avmm_0_global_avm_address[2]),
      .avm_unnamed_main2_main_writedata(avmm_0_global_avm_writedata[2]),
      .avm_unnamed_main2_main_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_unnamed_main2_main_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_unnamed_main2_main_readdata(avmm_0_global_avm_readdata[2]),
      .avm_unnamed_main2_main_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_unnamed_main2_main_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_unnamed_main2_main_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_unnamed_main3_main
      .avm_unnamed_main3_main_enable(avmm_0_global_avm_enable[3]),
      .avm_unnamed_main3_main_read(avmm_0_global_avm_read[3]),
      .avm_unnamed_main3_main_write(avmm_0_global_avm_write[3]),
      .avm_unnamed_main3_main_address(avmm_0_global_avm_address[3]),
      .avm_unnamed_main3_main_writedata(avmm_0_global_avm_writedata[3]),
      .avm_unnamed_main3_main_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_unnamed_main3_main_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_unnamed_main3_main_readdata(avmm_0_global_avm_readdata[3]),
      .avm_unnamed_main3_main_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_unnamed_main3_main_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_unnamed_main3_main_writeack(avmm_0_global_avm_writeack[3])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of main_internal_ic_11074848305052637784
      main_internal_ic_11074848305052637784 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE main_internal_ic_11074848305052637784
/////////////////////////////////////////////////////////////////
module main_internal_ic_11074848305052637784
(
   input logic clock,
