...
main main_inst (
  ...
  // Interface: DCB_PFC_UP_ATTR_0 (conduit sink)
  .DCB_PFC_UP_ATTR_0    ( ), // 64-bit data input
  // Interface: DCB_PFC_UP_ATTR_MAX (conduit sink)
  .DCB_PFC_UP_ATTR_MAX  ( ), // 64-bit data input
  // Interface: DCB_PG_ATTR_BW_ID_0 (conduit sink)
  .DCB_PG_ATTR_BW_ID_0  ( ), // 64-bit data input
  // Interface: DCB_PG_ATTR_BW_ID_MAX (conduit sink)
  .DCB_PG_ATTR_BW_ID_MAX( ), // 64-bit data input
