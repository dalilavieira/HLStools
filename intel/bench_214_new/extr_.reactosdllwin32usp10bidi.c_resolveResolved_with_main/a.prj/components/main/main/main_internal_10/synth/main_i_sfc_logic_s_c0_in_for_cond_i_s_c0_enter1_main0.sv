...
// SystemVerilog created from main_i_sfc_logic_s_c0_in_for_cond_i_s_c0_enter1_main0
...
module main_i_sfc_logic_s_c0_in_for_cond_i_s_c0_enter1_main0 (
    ...
    output wire [0:0] out_unnamed_main2,
    input wire clock,
    input wire resetn
    );
    ...
    assign out_unnamed_main2 = GND_q;
