...
// SystemVerilog created from cmain_i_iord_bl_call_unnamed_cmain2_cmain0
...
module cmain_i_iord_bl_call_unnamed_cmain2_cmain0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_cmain_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_cmain_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_cmain_i_fifodata),
    ...
    assign out_iord_bl_call_cmain_o_fifoready = iord_o_fifoready;
