...
// SystemVerilog created from obs_key_to_virtual_key_i_iord_bl_call_unA000000Z_key_to_virtual_key0
...
module obs_key_to_virtual_key_i_iord_bl_call_unA000000Z_key_to_virtual_key0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_obs_key_to_virtual_key_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_obs_key_to_virtual_key_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_obs_key_to_virtual_key_i_fifodata),
    ...
    // regfree_osync(GPOUT,225)
    assign out_iord_bl_call_obs_key_to_virtual_key_o_fifoready = iord_o_fifoready;

    // sync_out(GPOUT,227)@20000000
    ...
    // ip_dsdk_adapt_bitselect98(BITSELECT,114)
    assign ip_dsdk_adapt_bitselect98_b = iord_o_data[3135:3072];

    // ip_dsdk_adapt_bitselect96(BITSELECT,113)
    assign ip_dsdk_adapt_bitselect96_b = iord_o_data[3071:3008];

    // ip_dsdk_adapt_bitselect94(BITSELECT,112)
    ...
    // ip_dsdk_adapt_bitselect8(BITSELECT,104)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[255:192];

    // ip_dsdk_adapt_bitselect6(BITSELECT,93)
    assign ip_dsdk_adapt_bitselect6_b = iord_o_data[191:128];

    // ip_dsdk_adapt_bitselect4(BITSELECT,82)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,229)@1
