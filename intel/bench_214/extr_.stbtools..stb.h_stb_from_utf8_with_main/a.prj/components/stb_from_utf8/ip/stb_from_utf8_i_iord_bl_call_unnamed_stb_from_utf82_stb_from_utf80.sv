...
// SystemVerilog created from stb_from_utf8_i_iord_bl_call_unnamed_stb_from_utf82_stb_from_utf80
...
module stb_from_utf8_i_iord_bl_call_unnamed_stb_from_utf82_stb_from_utf80 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_stb_from_utf8_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_stb_from_utf8_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_stb_from_utf8_i_fifodata),
    ...
    assign out_iord_bl_call_stb_from_utf8_o_fifoready = iord_o_fifoready;
