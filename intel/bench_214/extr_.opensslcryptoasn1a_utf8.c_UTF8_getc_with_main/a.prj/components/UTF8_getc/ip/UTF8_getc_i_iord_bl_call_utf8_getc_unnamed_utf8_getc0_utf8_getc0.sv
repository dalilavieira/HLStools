...
// SystemVerilog created from UTF8_getc_i_iord_bl_call_utf8_getc_unnamed_utf8_getc0_utf8_getc0
...
module UTF8_getc_i_iord_bl_call_utf8_getc_unnamed_utf8_getc0_utf8_getc0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_UTF8_getc_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_UTF8_getc_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_UTF8_getc_i_fifodata),
    ...
    assign out_iord_bl_call_UTF8_getc_o_fifoready = iord_o_fifoready;
