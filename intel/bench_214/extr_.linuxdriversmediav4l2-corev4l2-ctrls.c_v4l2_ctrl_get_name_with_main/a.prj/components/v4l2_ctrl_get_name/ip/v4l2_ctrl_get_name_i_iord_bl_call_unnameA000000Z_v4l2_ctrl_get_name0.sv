...
// SystemVerilog created from v4l2_ctrl_get_name_i_iord_bl_call_unnameA000000Z_v4l2_ctrl_get_name0
...
module v4l2_ctrl_get_name_i_iord_bl_call_unnameA000000Z_v4l2_ctrl_get_name0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_v4l2_ctrl_get_name_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_v4l2_ctrl_get_name_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_v4l2_ctrl_get_name_i_fifodata),
    ...
    assign out_iord_bl_call_v4l2_ctrl_get_name_o_fifoready = iord_o_fifoready;
