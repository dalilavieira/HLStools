...
// SystemVerilog created from c2c_decode_stats_i_iord_bl_call_unnamed_A000000Zs0_c2c_decode_stats0
...
module c2c_decode_stats_i_iord_bl_call_unnamed_A000000Zs0_c2c_decode_stats0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_c2c_decode_stats_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_c2c_decode_stats_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_c2c_decode_stats_i_fifodata),
    ...
    assign out_iord_bl_call_c2c_decode_stats_o_fifoready = iord_o_fifoready;
    ...
    // ip_dsdk_adapt_bitselect8(BITSELECT,22)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,45)@4
