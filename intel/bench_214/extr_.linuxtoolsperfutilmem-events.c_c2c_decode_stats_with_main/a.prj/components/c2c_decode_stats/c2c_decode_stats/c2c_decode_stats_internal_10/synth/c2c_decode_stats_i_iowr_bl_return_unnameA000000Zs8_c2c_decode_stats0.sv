...
// SystemVerilog created from c2c_decode_stats_i_iowr_bl_return_unnameA000000Zs8_c2c_decode_stats0
...
module c2c_decode_stats_i_iowr_bl_return_unnameA000000Zs8_c2c_decode_stats0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_c2c_decode_stats_i_fifoready;
    ...
    assign out_iowr_bl_return_c2c_decode_stats_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_c2c_decode_stats_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,13)@1651
