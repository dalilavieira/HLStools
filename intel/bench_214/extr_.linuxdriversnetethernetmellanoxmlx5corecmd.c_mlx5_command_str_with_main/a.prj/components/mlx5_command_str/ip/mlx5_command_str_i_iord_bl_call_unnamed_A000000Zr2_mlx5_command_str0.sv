...
// SystemVerilog created from mlx5_command_str_i_iord_bl_call_unnamed_A000000Zr2_mlx5_command_str0
...
module mlx5_command_str_i_iord_bl_call_unnamed_A000000Zr2_mlx5_command_str0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_mlx5_command_str_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_mlx5_command_str_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_mlx5_command_str_i_fifodata),
    ...
    assign out_iord_bl_call_mlx5_command_str_o_fifoready = iord_o_fifoready;
