...
// SystemVerilog created from xmlCheckLanguageID_i_iord_bl_call_xmlcheA000000Z_xmlchecklanguageid0
...
module xmlCheckLanguageID_i_iord_bl_call_xmlcheA000000Z_xmlchecklanguageid0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_xmlCheckLanguageID_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_xmlCheckLanguageID_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_xmlCheckLanguageID_i_fifodata),
    ...
    assign out_iord_bl_call_xmlCheckLanguageID_o_fifoready = iord_o_fifoready;
