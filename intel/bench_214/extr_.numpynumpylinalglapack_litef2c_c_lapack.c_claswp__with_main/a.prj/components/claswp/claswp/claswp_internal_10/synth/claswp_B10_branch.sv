...
// SystemVerilog created from claswp_B10_branch
...
module claswp_B10_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] claswp_B10_branch_enable_q;
    wire [0:0] claswp_B10_branch_enable_not_q;
    ...
    // notcmp193223_pop338_cmp(LOGICAL,14)
    ...
    begin
        ...
        else if (claswp_B10_branch_enable_q == 1'b1)
        begin
    ...
    // claswp_B10_branch_enable(LOGICAL,2)
    assign claswp_B10_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // claswp_B10_branch_enable_not(LOGICAL,3)
    assign claswp_B10_branch_enable_not_q = ~ (claswp_B10_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = claswp_B10_branch_enable_not_q;
