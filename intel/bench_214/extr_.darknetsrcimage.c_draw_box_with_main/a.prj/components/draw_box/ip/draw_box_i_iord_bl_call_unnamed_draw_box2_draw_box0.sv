...
// SystemVerilog created from draw_box_i_iord_bl_call_unnamed_draw_box2_draw_box0
...
module draw_box_i_iord_bl_call_unnamed_draw_box2_draw_box0 (
    ...
    wire [127:0] ip_dsdk_adapt_bitselect2_b;
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_draw_box_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_draw_box_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_draw_box_i_fifodata),
    ...
    assign out_iord_bl_call_draw_box_o_fifoready = iord_o_fifoready;

    // sync_out(GPOUT,32)@20000000
    assign out_o_stall = iord_o_stall;

    // ip_dsdk_adapt_bitselect22(BITSELECT,14)
    assign ip_dsdk_adapt_bitselect22_b = iord_o_data[351:320];

    // ip_dsdk_adapt_bitselect20(BITSELECT,13)
    assign ip_dsdk_adapt_bitselect20_b = iord_o_data[319:288];

    // ip_dsdk_adapt_bitselect18(BITSELECT,11)
    assign ip_dsdk_adapt_bitselect18_b = iord_o_data[287:256];

    // ip_dsdk_adapt_bitselect16(BITSELECT,10)
    assign ip_dsdk_adapt_bitselect16_b = iord_o_data[255:224];

    // ip_dsdk_adapt_bitselect14(BITSELECT,9)
    assign ip_dsdk_adapt_bitselect14_b = iord_o_data[223:192];

    // ip_dsdk_adapt_bitselect12(BITSELECT,8)
    assign ip_dsdk_adapt_bitselect12_b = iord_o_data[191:160];
    ...
    assign ip_dsdk_adapt_bitselect2_b = iord_o_data[127:0];

    // ip_dsdk_adapt_bitselect8(BITSELECT,17)
    assign ip_dsdk_adapt_bitselect8_b = ip_dsdk_adapt_bitselect2_b[127:64];

    // ip_dsdk_adapt_bitselect6(BITSELECT,16)
    assign ip_dsdk_adapt_bitselect6_b = ip_dsdk_adapt_bitselect2_b[63:32];

    // ip_dsdk_adapt_bitselect4(BITSELECT,15)
    assign ip_dsdk_adapt_bitselect4_b = ip_dsdk_adapt_bitselect2_b[31:0];

    // dupName_0_sync_out_aunroll_x(GPOUT,34)@2
