...
// SystemVerilog created from draw_box_B4_branch
...
module draw_box_B4_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] draw_box_B4_branch_enable_q;
    wire [0:0] draw_box_B4_branch_enable_not_q;
    ...
    begin
        ...
        else if (draw_box_B4_branch_enable_q == 1'b1)
        begin
    ...
    // draw_box_B4_branch_enable(LOGICAL,2)
    assign draw_box_B4_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // draw_box_B4_branch_enable_not(LOGICAL,3)
    assign draw_box_B4_branch_enable_not_q = ~ (draw_box_B4_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = draw_box_B4_branch_enable_not_q;
