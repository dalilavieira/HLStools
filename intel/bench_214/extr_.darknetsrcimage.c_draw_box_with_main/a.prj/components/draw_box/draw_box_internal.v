...
(
   ...
   genvar __i;
   logic avmm_0_global_avm_enable [12];
   logic avmm_0_global_avm_read [12];
   logic avmm_0_global_avm_write [12];
   logic [63:0] avmm_0_global_avm_address [12];
   logic [63:0] avmm_0_global_avm_writedata [12];
   logic [7:0] avmm_0_global_avm_byteenable [12];
   logic avmm_0_global_avm_waitrequest [12];
   logic [63:0] avmm_0_global_avm_readdata [12];
   logic avmm_0_global_avm_readdatavalid [12];
   logic avmm_0_global_avm_burstcount [12];
   logic avmm_0_global_avm_writeack [12];

   // INST draw_box_internal of draw_box_function_wrapper
   draw_box_function_wrapper draw_box_internal
   (
      .clock(clock),
      .resetn(resetn),
      .a(a),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_memdep_10_draw_box
      .avm_memdep_10_draw_box_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_10_draw_box_read(avmm_0_global_avm_read[0]),
      .avm_memdep_10_draw_box_write(avmm_0_global_avm_write[0]),
      .avm_memdep_10_draw_box_address(avmm_0_global_avm_address[0]),
      .avm_memdep_10_draw_box_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_10_draw_box_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_10_draw_box_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_10_draw_box_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_10_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_10_draw_box_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_10_draw_box_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_memdep_15_draw_box
      .avm_memdep_15_draw_box_enable(avmm_0_global_avm_enable[1]),
      .avm_memdep_15_draw_box_read(avmm_0_global_avm_read[1]),
      .avm_memdep_15_draw_box_write(avmm_0_global_avm_write[1]),
      .avm_memdep_15_draw_box_address(avmm_0_global_avm_address[1]),
      .avm_memdep_15_draw_box_writedata(avmm_0_global_avm_writedata[1]),
      .avm_memdep_15_draw_box_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_memdep_15_draw_box_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_memdep_15_draw_box_readdata(avmm_0_global_avm_readdata[1]),
      .avm_memdep_15_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_memdep_15_draw_box_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_memdep_15_draw_box_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_memdep_1_draw_box
      .avm_memdep_1_draw_box_enable(avmm_0_global_avm_enable[2]),
      .avm_memdep_1_draw_box_read(avmm_0_global_avm_read[2]),
      .avm_memdep_1_draw_box_write(avmm_0_global_avm_write[2]),
      .avm_memdep_1_draw_box_address(avmm_0_global_avm_address[2]),
      .avm_memdep_1_draw_box_writedata(avmm_0_global_avm_writedata[2]),
      .avm_memdep_1_draw_box_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_memdep_1_draw_box_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_memdep_1_draw_box_readdata(avmm_0_global_avm_readdata[2]),
      .avm_memdep_1_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_memdep_1_draw_box_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_memdep_1_draw_box_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_memdep_20_draw_box
      .avm_memdep_20_draw_box_enable(avmm_0_global_avm_enable[3]),
      .avm_memdep_20_draw_box_read(avmm_0_global_avm_read[3]),
      .avm_memdep_20_draw_box_write(avmm_0_global_avm_write[3]),
      .avm_memdep_20_draw_box_address(avmm_0_global_avm_address[3]),
      .avm_memdep_20_draw_box_writedata(avmm_0_global_avm_writedata[3]),
      .avm_memdep_20_draw_box_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_memdep_20_draw_box_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_memdep_20_draw_box_readdata(avmm_0_global_avm_readdata[3]),
      .avm_memdep_20_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_memdep_20_draw_box_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_memdep_20_draw_box_writeack(avmm_0_global_avm_writeack[3]),
      // AVM avm_memdep_26_draw_box
      .avm_memdep_26_draw_box_enable(avmm_0_global_avm_enable[4]),
      .avm_memdep_26_draw_box_read(avmm_0_global_avm_read[4]),
      .avm_memdep_26_draw_box_write(avmm_0_global_avm_write[4]),
      .avm_memdep_26_draw_box_address(avmm_0_global_avm_address[4]),
      .avm_memdep_26_draw_box_writedata(avmm_0_global_avm_writedata[4]),
      .avm_memdep_26_draw_box_byteenable(avmm_0_global_avm_byteenable[4]),
      .avm_memdep_26_draw_box_waitrequest(avmm_0_global_avm_waitrequest[4]),
      .avm_memdep_26_draw_box_readdata(avmm_0_global_avm_readdata[4]),
      .avm_memdep_26_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[4]),
      .avm_memdep_26_draw_box_burstcount(avmm_0_global_avm_burstcount[4]),
      .avm_memdep_26_draw_box_writeack(avmm_0_global_avm_writeack[4]),
      // AVM avm_memdep_28_draw_box
      .avm_memdep_28_draw_box_enable(avmm_0_global_avm_enable[5]),
      .avm_memdep_28_draw_box_read(avmm_0_global_avm_read[5]),
      .avm_memdep_28_draw_box_write(avmm_0_global_avm_write[5]),
      .avm_memdep_28_draw_box_address(avmm_0_global_avm_address[5]),
      .avm_memdep_28_draw_box_writedata(avmm_0_global_avm_writedata[5]),
      .avm_memdep_28_draw_box_byteenable(avmm_0_global_avm_byteenable[5]),
      .avm_memdep_28_draw_box_waitrequest(avmm_0_global_avm_waitrequest[5]),
      .avm_memdep_28_draw_box_readdata(avmm_0_global_avm_readdata[5]),
      .avm_memdep_28_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[5]),
      .avm_memdep_28_draw_box_burstcount(avmm_0_global_avm_burstcount[5]),
      .avm_memdep_28_draw_box_writeack(avmm_0_global_avm_writeack[5]),
      // AVM avm_memdep_32_draw_box
      .avm_memdep_32_draw_box_enable(avmm_0_global_avm_enable[6]),
      .avm_memdep_32_draw_box_read(avmm_0_global_avm_read[6]),
      .avm_memdep_32_draw_box_write(avmm_0_global_avm_write[6]),
      .avm_memdep_32_draw_box_address(avmm_0_global_avm_address[6]),
      .avm_memdep_32_draw_box_writedata(avmm_0_global_avm_writedata[6]),
      .avm_memdep_32_draw_box_byteenable(avmm_0_global_avm_byteenable[6]),
      .avm_memdep_32_draw_box_waitrequest(avmm_0_global_avm_waitrequest[6]),
      .avm_memdep_32_draw_box_readdata(avmm_0_global_avm_readdata[6]),
      .avm_memdep_32_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[6]),
      .avm_memdep_32_draw_box_burstcount(avmm_0_global_avm_burstcount[6]),
      .avm_memdep_32_draw_box_writeack(avmm_0_global_avm_writeack[6]),
      // AVM avm_memdep_37_draw_box
      .avm_memdep_37_draw_box_enable(avmm_0_global_avm_enable[7]),
      .avm_memdep_37_draw_box_read(avmm_0_global_avm_read[7]),
      .avm_memdep_37_draw_box_write(avmm_0_global_avm_write[7]),
      .avm_memdep_37_draw_box_address(avmm_0_global_avm_address[7]),
      .avm_memdep_37_draw_box_writedata(avmm_0_global_avm_writedata[7]),
      .avm_memdep_37_draw_box_byteenable(avmm_0_global_avm_byteenable[7]),
      .avm_memdep_37_draw_box_waitrequest(avmm_0_global_avm_waitrequest[7]),
      .avm_memdep_37_draw_box_readdata(avmm_0_global_avm_readdata[7]),
      .avm_memdep_37_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[7]),
      .avm_memdep_37_draw_box_burstcount(avmm_0_global_avm_burstcount[7]),
      .avm_memdep_37_draw_box_writeack(avmm_0_global_avm_writeack[7]),
      // AVM avm_memdep_42_draw_box
      .avm_memdep_42_draw_box_enable(avmm_0_global_avm_enable[8]),
      .avm_memdep_42_draw_box_read(avmm_0_global_avm_read[8]),
      .avm_memdep_42_draw_box_write(avmm_0_global_avm_write[8]),
      .avm_memdep_42_draw_box_address(avmm_0_global_avm_address[8]),
      .avm_memdep_42_draw_box_writedata(avmm_0_global_avm_writedata[8]),
      .avm_memdep_42_draw_box_byteenable(avmm_0_global_avm_byteenable[8]),
      .avm_memdep_42_draw_box_waitrequest(avmm_0_global_avm_waitrequest[8]),
      .avm_memdep_42_draw_box_readdata(avmm_0_global_avm_readdata[8]),
      .avm_memdep_42_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[8]),
      .avm_memdep_42_draw_box_burstcount(avmm_0_global_avm_burstcount[8]),
      .avm_memdep_42_draw_box_writeack(avmm_0_global_avm_writeack[8]),
      // AVM avm_memdep_47_draw_box
      .avm_memdep_47_draw_box_enable(avmm_0_global_avm_enable[9]),
      .avm_memdep_47_draw_box_read(avmm_0_global_avm_read[9]),
      .avm_memdep_47_draw_box_write(avmm_0_global_avm_write[9]),
      .avm_memdep_47_draw_box_address(avmm_0_global_avm_address[9]),
      .avm_memdep_47_draw_box_writedata(avmm_0_global_avm_writedata[9]),
      .avm_memdep_47_draw_box_byteenable(avmm_0_global_avm_byteenable[9]),
      .avm_memdep_47_draw_box_waitrequest(avmm_0_global_avm_waitrequest[9]),
      .avm_memdep_47_draw_box_readdata(avmm_0_global_avm_readdata[9]),
      .avm_memdep_47_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[9]),
      .avm_memdep_47_draw_box_burstcount(avmm_0_global_avm_burstcount[9]),
      .avm_memdep_47_draw_box_writeack(avmm_0_global_avm_writeack[9]),
      // AVM avm_memdep_5_draw_box
      .avm_memdep_5_draw_box_enable(avmm_0_global_avm_enable[10]),
      .avm_memdep_5_draw_box_read(avmm_0_global_avm_read[10]),
      .avm_memdep_5_draw_box_write(avmm_0_global_avm_write[10]),
      .avm_memdep_5_draw_box_address(avmm_0_global_avm_address[10]),
      .avm_memdep_5_draw_box_writedata(avmm_0_global_avm_writedata[10]),
      .avm_memdep_5_draw_box_byteenable(avmm_0_global_avm_byteenable[10]),
      .avm_memdep_5_draw_box_waitrequest(avmm_0_global_avm_waitrequest[10]),
      .avm_memdep_5_draw_box_readdata(avmm_0_global_avm_readdata[10]),
      .avm_memdep_5_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[10]),
      .avm_memdep_5_draw_box_burstcount(avmm_0_global_avm_burstcount[10]),
      .avm_memdep_5_draw_box_writeack(avmm_0_global_avm_writeack[10]),
      // AVM avm_memdep_draw_box
      .avm_memdep_draw_box_enable(avmm_0_global_avm_enable[11]),
      .avm_memdep_draw_box_read(avmm_0_global_avm_read[11]),
      .avm_memdep_draw_box_write(avmm_0_global_avm_write[11]),
      .avm_memdep_draw_box_address(avmm_0_global_avm_address[11]),
      .avm_memdep_draw_box_writedata(avmm_0_global_avm_writedata[11]),
      .avm_memdep_draw_box_byteenable(avmm_0_global_avm_byteenable[11]),
      .avm_memdep_draw_box_waitrequest(avmm_0_global_avm_waitrequest[11]),
      .avm_memdep_draw_box_readdata(avmm_0_global_avm_readdata[11]),
      .avm_memdep_draw_box_readdatavalid(avmm_0_global_avm_readdatavalid[11]),
      .avm_memdep_draw_box_burstcount(avmm_0_global_avm_burstcount[11]),
      .avm_memdep_draw_box_writeack(avmm_0_global_avm_writeack[11])
   );

   generate
   begin:avmm_0_
      logic avmm_0_icm_in_arb_request [12];
      logic avmm_0_icm_in_arb_enable [12];
      logic avmm_0_icm_in_arb_read [12];
      logic avmm_0_icm_in_arb_write [12];
      logic avmm_0_icm_in_arb_burstcount [12];
      logic [60:0] avmm_0_icm_in_arb_address [12];
      logic [63:0] avmm_0_icm_in_arb_writedata [12];
      logic [7:0] avmm_0_icm_in_arb_byteenable [12];
      logic avmm_0_icm_in_arb_stall [12];
      logic avmm_0_icm_in_wrp_ack [12];
      logic avmm_0_icm_in_rrp_datavalid [12];
      logic [63:0] avmm_0_icm_in_rrp_data [12];
      ...
      logic icm_routedavmm_0_rw_arb_request [12];
      logic icm_routedavmm_0_rw_arb_enable [12];
      logic icm_routedavmm_0_rw_arb_read [12];
      logic icm_routedavmm_0_rw_arb_write [12];
      logic icm_routedavmm_0_rw_arb_burstcount [12];
      logic [60:0] icm_routedavmm_0_rw_arb_address [12];
      logic [63:0] icm_routedavmm_0_rw_arb_writedata [12];
      logic [7:0] icm_routedavmm_0_rw_arb_byteenable [12];
      logic icm_routedavmm_0_rw_arb_stall [12];
      logic icm_routedavmm_0_rw_wrp_ack [12];
      logic icm_routedavmm_0_rw_rrp_datavalid [12];
      logic [63:0] icm_routedavmm_0_rw_rrp_data [12];
      ...
      // INST global_icavmm_0_rw of draw_box_internal_ic_8858379747209513912
      draw_box_internal_ic_8858379747209513912 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE draw_box_internal_ic_8858379747209513912
/////////////////////////////////////////////////////////////////
module draw_box_internal_ic_8858379747209513912
(
   input logic clock,
   ...
   input logic [60:0] m_arb_address [12],
   input logic [63:0] m_arb_writedata [12],
   input logic [7:0] m_arb_byteenable [12],
   output logic m_arb_stall [12],
   output logic m_wrp_ack [12],
   output logic m_rrp_datavalid [12],
   output logic [63:0] m_rrp_data [12],
   // ICM mout
