...
glfwChooseFBConfig glfwChooseFBConfig_inst (
  ...
  // Interface: desired (conduit sink)
  .desired             ( ), // 64-bit data input
  // Interface: alternatives (conduit sink)
  .alternatives        ( ), // 64-bit data input
  // Interface: count (conduit sink)
  .count               ( ), // 32-bit data input
  // Interface: GLFW_DONT_CARE (conduit sink)
  .GLFW_DONT_CARE      ( ), // 64-bit data input
  // Interface: UINT_MAX (conduit sink)
  .UINT_MAX            ( ), // 64-bit data input
