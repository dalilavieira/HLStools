...
// SystemVerilog created from glfwChooseFBConfig_i_iord_bl_call_glfwchA000000Z_glfwchoosefbconfig0
...
module glfwChooseFBConfig_i_iord_bl_call_glfwchA000000Z_glfwchoosefbconfig0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_glfwChooseFBConfig_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_glfwChooseFBConfig_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_glfwChooseFBConfig_i_fifodata),
    ...
    assign out_iord_bl_call_glfwChooseFBConfig_o_fifoready = iord_o_fifoready;
