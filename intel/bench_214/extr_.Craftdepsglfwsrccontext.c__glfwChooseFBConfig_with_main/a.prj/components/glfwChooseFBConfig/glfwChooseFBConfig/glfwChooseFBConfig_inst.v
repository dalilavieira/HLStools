	glfwChooseFBConfig u0 (
		...
		.returndata           (_connected_to_returndata_),           //  output,  width = 64,     returndata.data
		.desired              (_connected_to_desired_),              //   input,  width = 64,        desired.data
		.alternatives         (_connected_to_alternatives_),         //   input,  width = 64,   alternatives.data
		.count                (_connected_to_count_),                //   input,  width = 32,          count.data
		.GLFW_DONT_CARE       (_connected_to_GLFW_DONT_CARE_),       //   input,  width = 64, GLFW_DONT_CARE.data
		.UINT_MAX             (_connected_to_UINT_MAX_),             //   input,  width = 64,       UINT_MAX.data
