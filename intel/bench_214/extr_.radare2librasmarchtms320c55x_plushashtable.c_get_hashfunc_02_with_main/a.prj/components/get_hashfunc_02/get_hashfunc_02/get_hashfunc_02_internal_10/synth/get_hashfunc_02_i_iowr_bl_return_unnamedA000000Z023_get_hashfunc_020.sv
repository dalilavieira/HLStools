...
// SystemVerilog created from get_hashfunc_02_i_iowr_bl_return_unnamedA000000Z023_get_hashfunc_020
...
module get_hashfunc_02_i_iowr_bl_return_unnamedA000000Z023_get_hashfunc_020 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_get_hashfunc_02_i_fifoready;
    ...
    assign out_iowr_bl_return_get_hashfunc_02_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_get_hashfunc_02_o_fifovalid = iowr_o_fifovalid;
