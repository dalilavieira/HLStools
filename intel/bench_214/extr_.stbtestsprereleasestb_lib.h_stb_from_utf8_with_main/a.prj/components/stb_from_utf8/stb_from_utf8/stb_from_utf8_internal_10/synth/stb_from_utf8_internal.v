...
/////////////////////////////////////////////////////////////////
// MODULE stb_from_utf8_internal
/////////////////////////////////////////////////////////////////
module stb_from_utf8_internal
(
   input logic clock,
   input logic resetn,
   input logic [63:0] buffer0,
   input logic [63:0] ostr,
   input logic [31:0] n,
   input logic start,
   output logic busy,
   output logic done,
   ...
   genvar __i;
   logic avmm_0_global_avm_enable [8];
   logic avmm_0_global_avm_read [8];
   logic avmm_0_global_avm_write [8];
   logic [63:0] avmm_0_global_avm_address [8];
   logic [63:0] avmm_0_global_avm_writedata [8];
   logic [7:0] avmm_0_global_avm_byteenable [8];
   logic avmm_0_global_avm_waitrequest [8];
   logic [63:0] avmm_0_global_avm_readdata [8];
   logic avmm_0_global_avm_readdatavalid [8];
   logic avmm_0_global_avm_burstcount [8];
   logic avmm_0_global_avm_writeack [8];

   // INST stb_from_utf8_internal of stb_from_utf8_function_wrapper
   stb_from_utf8_function_wrapper stb_from_utf8_internal
   (
      .clock(clock),
      .resetn(resetn),
      .buffer0(buffer0),
      ...
      // AVM avm_lm2002_stb_from_utf8
      .avm_lm2002_stb_from_utf8_enable(avmm_0_global_avm_enable[0]),
      .avm_lm2002_stb_from_utf8_read(avmm_0_global_avm_read[0]),
      .avm_lm2002_stb_from_utf8_write(avmm_0_global_avm_write[0]),
      .avm_lm2002_stb_from_utf8_address(avmm_0_global_avm_address[0]),
      .avm_lm2002_stb_from_utf8_writedata(avmm_0_global_avm_writedata[0]),
      .avm_lm2002_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_lm2002_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_lm2002_stb_from_utf8_readdata(avmm_0_global_avm_readdata[0]),
      .avm_lm2002_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_lm2002_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_lm2002_stb_from_utf8_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_lm2545_stb_from_utf8
      .avm_lm2545_stb_from_utf8_enable(avmm_0_global_avm_enable[1]),
      .avm_lm2545_stb_from_utf8_read(avmm_0_global_avm_read[1]),
      .avm_lm2545_stb_from_utf8_write(avmm_0_global_avm_write[1]),
      .avm_lm2545_stb_from_utf8_address(avmm_0_global_avm_address[1]),
      .avm_lm2545_stb_from_utf8_writedata(avmm_0_global_avm_writedata[1]),
      .avm_lm2545_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_lm2545_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_lm2545_stb_from_utf8_readdata(avmm_0_global_avm_readdata[1]),
      .avm_lm2545_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_lm2545_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_lm2545_stb_from_utf8_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_memdep_1_stb_from_utf8
      .avm_memdep_1_stb_from_utf8_enable(avmm_0_global_avm_enable[2]),
      .avm_memdep_1_stb_from_utf8_read(avmm_0_global_avm_read[2]),
      .avm_memdep_1_stb_from_utf8_write(avmm_0_global_avm_write[2]),
      .avm_memdep_1_stb_from_utf8_address(avmm_0_global_avm_address[2]),
      .avm_memdep_1_stb_from_utf8_writedata(avmm_0_global_avm_writedata[2]),
      .avm_memdep_1_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_memdep_1_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_memdep_1_stb_from_utf8_readdata(avmm_0_global_avm_readdata[2]),
      .avm_memdep_1_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_memdep_1_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_memdep_1_stb_from_utf8_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_memdep_6_stb_from_utf8
      .avm_memdep_6_stb_from_utf8_enable(avmm_0_global_avm_enable[3]),
      .avm_memdep_6_stb_from_utf8_read(avmm_0_global_avm_read[3]),
      .avm_memdep_6_stb_from_utf8_write(avmm_0_global_avm_write[3]),
      .avm_memdep_6_stb_from_utf8_address(avmm_0_global_avm_address[3]),
      .avm_memdep_6_stb_from_utf8_writedata(avmm_0_global_avm_writedata[3]),
      .avm_memdep_6_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_memdep_6_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_memdep_6_stb_from_utf8_readdata(avmm_0_global_avm_readdata[3]),
      .avm_memdep_6_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_memdep_6_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_memdep_6_stb_from_utf8_writeack(avmm_0_global_avm_writeack[3]),
      // AVM avm_memdep_stb_from_utf8
      .avm_memdep_stb_from_utf8_enable(avmm_0_global_avm_enable[4]),
      .avm_memdep_stb_from_utf8_read(avmm_0_global_avm_read[4]),
      .avm_memdep_stb_from_utf8_write(avmm_0_global_avm_write[4]),
      .avm_memdep_stb_from_utf8_address(avmm_0_global_avm_address[4]),
      .avm_memdep_stb_from_utf8_writedata(avmm_0_global_avm_writedata[4]),
      .avm_memdep_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[4]),
      .avm_memdep_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[4]),
      .avm_memdep_stb_from_utf8_readdata(avmm_0_global_avm_readdata[4]),
      .avm_memdep_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[4]),
      .avm_memdep_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[4]),
      .avm_memdep_stb_from_utf8_writeack(avmm_0_global_avm_writeack[4]),
      // AVM avm_ml2664_stb_from_utf8
      .avm_ml2664_stb_from_utf8_enable(avmm_0_global_avm_enable[5]),
      .avm_ml2664_stb_from_utf8_read(avmm_0_global_avm_read[5]),
      .avm_ml2664_stb_from_utf8_write(avmm_0_global_avm_write[5]),
      .avm_ml2664_stb_from_utf8_address(avmm_0_global_avm_address[5]),
      .avm_ml2664_stb_from_utf8_writedata(avmm_0_global_avm_writedata[5]),
      .avm_ml2664_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[5]),
      .avm_ml2664_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[5]),
      .avm_ml2664_stb_from_utf8_readdata(avmm_0_global_avm_readdata[5]),
      .avm_ml2664_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[5]),
      .avm_ml2664_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[5]),
      .avm_ml2664_stb_from_utf8_writeack(avmm_0_global_avm_writeack[5]),
      // AVM avm_ml3_stb_from_utf8
      .avm_ml3_stb_from_utf8_enable(avmm_0_global_avm_enable[6]),
      .avm_ml3_stb_from_utf8_read(avmm_0_global_avm_read[6]),
      .avm_ml3_stb_from_utf8_write(avmm_0_global_avm_write[6]),
      .avm_ml3_stb_from_utf8_address(avmm_0_global_avm_address[6]),
      .avm_ml3_stb_from_utf8_writedata(avmm_0_global_avm_writedata[6]),
      .avm_ml3_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[6]),
      .avm_ml3_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[6]),
      .avm_ml3_stb_from_utf8_readdata(avmm_0_global_avm_readdata[6]),
      .avm_ml3_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[6]),
      .avm_ml3_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[6]),
      .avm_ml3_stb_from_utf8_writeack(avmm_0_global_avm_writeack[6]),
      // AVM avm_unnamed_stb_from_utf83_stb_from_utf8
      .avm_unnamed_stb_from_utf83_stb_from_utf8_enable(avmm_0_global_avm_enable[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_read(avmm_0_global_avm_read[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_write(avmm_0_global_avm_write[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_address(avmm_0_global_avm_address[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_writedata(avmm_0_global_avm_writedata[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_byteenable(avmm_0_global_avm_byteenable[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_waitrequest(avmm_0_global_avm_waitrequest[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_readdata(avmm_0_global_avm_readdata[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_readdatavalid(avmm_0_global_avm_readdatavalid[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_burstcount(avmm_0_global_avm_burstcount[7]),
      .avm_unnamed_stb_from_utf83_stb_from_utf8_writeack(avmm_0_global_avm_writeack[7])
   );

   generate
   begin:avmm_0_
      logic avmm_0_icm_in_arb_request [8];
      logic avmm_0_icm_in_arb_enable [8];
      logic avmm_0_icm_in_arb_read [8];
      logic avmm_0_icm_in_arb_write [8];
      logic avmm_0_icm_in_arb_burstcount [8];
      logic [60:0] avmm_0_icm_in_arb_address [8];
      logic [63:0] avmm_0_icm_in_arb_writedata [8];
      logic [7:0] avmm_0_icm_in_arb_byteenable [8];
      logic avmm_0_icm_in_arb_stall [8];
      logic avmm_0_icm_in_wrp_ack [8];
      logic avmm_0_icm_in_rrp_datavalid [8];
      logic [63:0] avmm_0_icm_in_rrp_data [8];
      ...
      logic icm_routedavmm_0_rw_arb_request [8];
      logic icm_routedavmm_0_rw_arb_enable [8];
      logic icm_routedavmm_0_rw_arb_read [8];
      logic icm_routedavmm_0_rw_arb_write [8];
      logic icm_routedavmm_0_rw_arb_burstcount [8];
      logic [60:0] icm_routedavmm_0_rw_arb_address [8];
      logic [63:0] icm_routedavmm_0_rw_arb_writedata [8];
      logic [7:0] icm_routedavmm_0_rw_arb_byteenable [8];
      logic icm_routedavmm_0_rw_arb_stall [8];
      logic icm_routedavmm_0_rw_wrp_ack [8];
      logic icm_routedavmm_0_rw_rrp_datavalid [8];
      logic [63:0] icm_routedavmm_0_rw_rrp_data [8];
      ...
      // INST global_icavmm_0_rw of stb_from_utf8_internal_ic_410561915769707772
      stb_from_utf8_internal_ic_410561915769707772 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE stb_from_utf8_internal_ic_410561915769707772
/////////////////////////////////////////////////////////////////
module stb_from_utf8_internal_ic_410561915769707772
(
   input logic clock,
   ...
   input logic [60:0] m_arb_address [8],
   input logic [63:0] m_arb_writedata [8],
   input logic [7:0] m_arb_byteenable [8],
   output logic m_arb_stall [8],
   output logic m_wrp_ack [8],
   output logic m_rrp_datavalid [8],
   output logic [63:0] m_rrp_data [8],
   // ICM mout
   ...
   assign dp[1].in_intf.req = a[6].mout_intf.req;
   assign a[6].mout_intf.stall = dp[1].in_intf.stall;
   ...
   assign a[2].m0_intf.req = dp[6].out_intf.req;
   assign dp[6].out_intf.stall = a[2].m0_intf.stall;
   assign a[2].m1_intf.req = dp[7].out_intf.req;
   assign dp[7].out_intf.stall = a[2].m1_intf.stall;
   assign a[3].m0_intf.req = dp[8].out_intf.req;
   assign dp[8].out_intf.stall = a[3].m0_intf.stall;
   assign a[3].m1_intf.req = dp[9].out_intf.req;
   assign dp[9].out_intf.stall = a[3].m1_intf.stall;
   ...
   assign dp[6].in_intf.req = m[4].arb_intf.req;
   assign m[4].arb_intf.stall = dp[6].in_intf.stall;
   assign dp[7].in_intf.req = m[5].arb_intf.req;
   assign m[5].arb_intf.stall = dp[7].in_intf.stall;
   assign dp[8].in_intf.req = m[6].arb_intf.req;
   assign m[6].arb_intf.stall = dp[8].in_intf.stall;
   assign dp[9].in_intf.req = m[7].arb_intf.req;
   assign m[7].arb_intf.stall = dp[9].in_intf.stall;
endmodule
