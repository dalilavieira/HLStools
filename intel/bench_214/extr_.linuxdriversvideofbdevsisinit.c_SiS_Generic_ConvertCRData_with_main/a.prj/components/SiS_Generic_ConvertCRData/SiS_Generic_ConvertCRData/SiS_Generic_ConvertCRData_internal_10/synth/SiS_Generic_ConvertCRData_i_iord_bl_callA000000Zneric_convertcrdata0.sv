...
// SystemVerilog created from SiS_Generic_ConvertCRData_i_iord_bl_callA000000Zneric_convertcrdata0
...
module SiS_Generic_ConvertCRData_i_iord_bl_callA000000Zneric_convertcrdata0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_SiS_Generic_ConvertCRData_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_SiS_Generic_ConvertCRData_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_SiS_Generic_ConvertCRData_i_fifodata),
    ...
    assign out_iord_bl_call_SiS_Generic_ConvertCRData_o_fifoready = iord_o_fifoready;

    // sync_out(GPOUT,23)@20000000
    assign out_o_stall = iord_o_stall;

    // ip_dsdk_adapt_bitselect12(BITSELECT,9)
    assign ip_dsdk_adapt_bitselect12_b = iord_o_data[256:256];
    ...
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[191:160];
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,25)@3
