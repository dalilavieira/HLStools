...
// SystemVerilog created from nfs_open_file_remove_open_find_i_iord_blA000000Zle_remove_open_find0
...
module nfs_open_file_remove_open_find_i_iord_blA000000Zle_remove_open_find0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_nfs_open_file_remove_open_find_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_nfs_open_file_remove_open_find_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_nfs_open_file_remove_open_find_i_fifodata),
    ...
    assign out_iord_bl_call_nfs_open_file_remove_open_find_o_fifoready = iord_o_fifoready;

    // sync_out(GPOUT,35)@20000000
    assign out_o_stall = iord_o_stall;

    // ip_dsdk_adapt_bitselect24(BITSELECT,15)
    assign ip_dsdk_adapt_bitselect24_b = iord_o_data[703:640];

    // ip_dsdk_adapt_bitselect22(BITSELECT,14)
    assign ip_dsdk_adapt_bitselect22_b = iord_o_data[639:576];

    // ip_dsdk_adapt_bitselect20(BITSELECT,13)
    assign ip_dsdk_adapt_bitselect20_b = iord_o_data[575:512];

    // ip_dsdk_adapt_bitselect18(BITSELECT,11)
    assign ip_dsdk_adapt_bitselect18_b = iord_o_data[511:448];

    // ip_dsdk_adapt_bitselect16(BITSELECT,10)
    assign ip_dsdk_adapt_bitselect16_b = iord_o_data[447:384];

    // ip_dsdk_adapt_bitselect14(BITSELECT,9)
    assign ip_dsdk_adapt_bitselect14_b = iord_o_data[383:320];

    // ip_dsdk_adapt_bitselect12(BITSELECT,8)
    assign ip_dsdk_adapt_bitselect12_b = iord_o_data[319:256];

    // ip_dsdk_adapt_bitselect10(BITSELECT,7)
    assign ip_dsdk_adapt_bitselect10_b = iord_o_data[255:192];

    // ip_dsdk_adapt_bitselect8(BITSELECT,18)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[191:128];

    // ip_dsdk_adapt_bitselect6(BITSELECT,17)
    assign ip_dsdk_adapt_bitselect6_b = iord_o_data[127:96];

    // ip_dsdk_adapt_bitselect4(BITSELECT,16)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,37)@940
