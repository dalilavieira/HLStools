...
// SystemVerilog created from nfs_open_file_remove_open_find_i_iowr_blA000000Zle_remove_open_find0
...
module nfs_open_file_remove_open_find_i_iowr_blA000000Zle_remove_open_find0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_nfs_open_file_remove_open_find_i_fifoready;
    ...
    assign out_iowr_bl_return_nfs_open_file_remove_open_find_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_nfs_open_file_remove_open_find_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,15)@1910
