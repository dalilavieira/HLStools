...
// SystemVerilog created from obs_key_from_virtual_key_i_iowr_bl_returA000000Zey_from_virtual_key0
...
module obs_key_from_virtual_key_i_iowr_bl_returA000000Zey_from_virtual_key0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_obs_key_from_virtual_key_i_fifoready;
    ...
    assign out_iowr_bl_return_obs_key_from_virtual_key_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_obs_key_from_virtual_key_o_fifovalid = iowr_o_fifovalid;
