...
// SystemVerilog created from obs_key_from_virtual_key_i_llvm_fpga_pipeline_keep_going_1_sr
...
module obs_key_from_virtual_key_i_llvm_fpga_pipeline_keep_going_1_sr (
