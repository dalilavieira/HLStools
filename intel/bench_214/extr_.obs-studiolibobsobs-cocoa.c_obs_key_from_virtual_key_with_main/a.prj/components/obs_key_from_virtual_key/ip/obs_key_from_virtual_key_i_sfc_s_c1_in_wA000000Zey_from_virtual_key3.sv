...
// SystemVerilog created from obs_key_from_virtual_key_i_sfc_s_c1_in_wA000000Zey_from_virtual_key3
...
module obs_key_from_virtual_key_i_sfc_s_c1_in_wA000000Zey_from_virtual_key3 (
    ...
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_stall_entry;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_valid_out;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_data_out_0_tpl;
    wire [31:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_data_out_1_tpl;
    wire [0:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_o_valid;
    wire [63:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_address;
    wire [0:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_burstcount;
    wire [7:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_byteenable;
    wire [0:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_enable;
    wire [0:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_read;
    wire [0:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_write;
    wire [63:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_writedata;
    wire [0:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_c1_exi1_0_tpl;
    wire [31:0] i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_c1_exi1_1_tpl;


    // GND(CONSTANT,0)
    assign GND_q = $unsigned(1'b0);

    // i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x(BLACKBOX,19)@21
    ...
    obs_key_from_virtual_key_i_llvm_fpga_sfcA000001Zey_from_virtual_key0 thei_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x (
        .in_input_accepted(input_accepted_and_q),
        .in_mask_valid(GND_q),
        .in_stall_in(in_i_stall),
        .in_valid_in(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_o_valid),
        .in_data_in_0_tpl(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_c1_exi1_0_tpl),
        .in_data_in_1_tpl(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_c1_exi1_1_tpl),
        .out_stall_entry(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_stall_entry),
        .out_valid_out(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_valid_out),
        .out_data_out_0_tpl(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_data_out_0_tpl),
        .out_data_out_1_tpl(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_data_out_1_tpl),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    assign not_stall_out_q = ~ (i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_stall_entry);

    // input_accepted_and(LOGICAL,3)
    assign input_accepted_and_q = in_i_valid & not_stall_out_q;

    // i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x(BLACKBOX,20)@1
    // out out_o_valid@21
    ...
    // out out_unnamed_obs_key_from_virtual_key1@21
    // out out_c1_exi1_0_tpl@21
    // out out_c1_exi1_1_tpl@21
    obs_key_from_virtual_key_i_sfc_logic_s_cA000001Zey_from_virtual_key0 thei_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x (
        .in_flush(in_flush),
        ...
        .out_o_valid(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_o_valid),
        .out_retval_01_obs_key_from_virtual_key_avm_address(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_address),
        .out_retval_01_obs_key_from_virtual_key_avm_burstcount(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_burstcount),
        .out_retval_01_obs_key_from_virtual_key_avm_byteenable(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_byteenable),
        .out_retval_01_obs_key_from_virtual_key_avm_enable(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_enable),
        .out_retval_01_obs_key_from_virtual_key_avm_read(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_read),
        .out_retval_01_obs_key_from_virtual_key_avm_write(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_write),
        .out_retval_01_obs_key_from_virtual_key_avm_writedata(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_writedata),
        .out_unnamed_obs_key_from_virtual_key1(),
        .out_c1_exi1_0_tpl(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_c1_exi1_0_tpl),
        .out_c1_exi1_1_tpl(i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_c1_exi1_1_tpl),
        .clock(clock),
        .resetn(resetn)
    );

    // regfree_osync(GPOUT,10)
    assign out_retval_01_obs_key_from_virtual_key_avm_address = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_address;

    // sync_out(GPOUT,12)@20000000
    assign out_o_stall = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_stall_entry;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_retval_01_obs_key_from_virtual_key_avm_burstcount = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_burstcount;

    // dupName_1_regfree_osync_x(GPOUT,14)
    assign out_retval_01_obs_key_from_virtual_key_avm_byteenable = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_byteenable;

    // dupName_2_regfree_osync_x(GPOUT,15)
    assign out_retval_01_obs_key_from_virtual_key_avm_enable = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_enable;

    // dupName_3_regfree_osync_x(GPOUT,16)
    assign out_retval_01_obs_key_from_virtual_key_avm_read = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_read;

    // dupName_4_regfree_osync_x(GPOUT,17)
    assign out_retval_01_obs_key_from_virtual_key_avm_write = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_write;

    // dupName_5_regfree_osync_x(GPOUT,18)
    assign out_retval_01_obs_key_from_virtual_key_avm_writedata = i_sfc_logic_s_c1_in_wt_entry_obs_key_from_virtual_keys_c1_enter_obs_key_from_virtual_key0_aunroll_x_out_retval_01_obs_key_from_virtual_key_avm_writedata;

    // dupName_0_sync_out_aunroll_x(GPOUT,22)@24
    assign out_c1_exit_0_tpl = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_data_out_0_tpl;
    assign out_c1_exit_1_tpl = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_data_out_1_tpl;
    assign out_o_valid = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_obs_key_from_virtual_keys_c1_exit_obs_key_from_virtual_key1_aunroll_x_out_valid_out;
