...
// SystemVerilog created from obs_key_from_virtual_key_i_iord_bl_call_A000000Zey_from_virtual_key0
...
module obs_key_from_virtual_key_i_iord_bl_call_A000000Zey_from_virtual_key0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_obs_key_from_virtual_key_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_obs_key_from_virtual_key_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_obs_key_from_virtual_key_i_fifodata),
    ...
    assign out_iord_bl_call_obs_key_from_virtual_key_o_fifoready = iord_o_fifoready;
