...
// SystemVerilog created from eia608_from_utf8_i_iord_bl_call_unnamed_A000000Z82_eia608_from_utf80
...
module eia608_from_utf8_i_iord_bl_call_unnamed_A000000Z82_eia608_from_utf80 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_eia608_from_utf8_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_eia608_from_utf8_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_eia608_from_utf8_i_fifodata),
    ...
    assign out_iord_bl_call_eia608_from_utf8_o_fifoready = iord_o_fifoready;
