...
// SystemVerilog created from ff_snow_horizontal_compose97i_i_iowr_bl_A000000Zrizontal_compose97i0
...
module ff_snow_horizontal_compose97i_i_iowr_bl_A000000Zrizontal_compose97i0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_ff_snow_horizontal_compose97i_i_fifoready;
    ...
    assign out_iowr_bl_return_ff_snow_horizontal_compose97i_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_ff_snow_horizontal_compose97i_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,15)@80
