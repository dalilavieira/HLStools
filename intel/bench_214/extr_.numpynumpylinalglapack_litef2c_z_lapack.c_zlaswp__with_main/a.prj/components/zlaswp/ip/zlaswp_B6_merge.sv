...
// SystemVerilog created from zlaswp_B6_merge
...
module zlaswp_B6_merge (
    ...
    output wire [31:0] out_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237,
    ...
    output wire [0:0] out_reduction_zlaswp_33244,
    output wire [0:0] out_stall_out_0,
    output wire [0:0] out_stall_out_1,
    output wire [31:0] out_storemerge67_replace_phi236,
    output wire [0:0] out_unnamed_zlaswp36,
    ...
    wire [0:0] VCC_q;
    wire [0:0] ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_s;
    reg [31:0] ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_q;
    ...
    wire [0:0] reduction_zlaswp_33244_mux_s;
    reg [0:0] reduction_zlaswp_33244_mux_q;
    wire [0:0] stall_out_q;
    wire [0:0] stall_out_1_specific_q;
    wire [0:0] storemerge67_replace_phi236_mux_s;
    reg [31:0] storemerge67_replace_phi236_mux_q;
    wire [0:0] unnamed_zlaswp36_mux_s;
    reg [0:0] unnamed_zlaswp36_mux_q;
    wire [0:0] valid_or_q;
    ...
    // ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux(MUX,2)
    assign ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_s = in_valid_in_0;
    always @(ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_s or in_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_1 or in_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_0)
    begin
        unique case (ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_s)
            1'b0 : ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_q = in_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_1;
            1'b1 : ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_q = in_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_0;
            default : ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_q = 32'b0;
        endcase
    end

    // out_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237(GPOUT,55)
    assign out_ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237 = ZZ7zlaswp_PiP8TYPE_3_S_S_S_S_S_E2ix_static_1_replace_phi237_mux_q;
    ...
    // reduction_zlaswp_33244_mux(MUX,77)
    assign reduction_zlaswp_33244_mux_s = in_valid_in_0;
    always @(reduction_zlaswp_33244_mux_s or in_reduction_zlaswp_33244_1 or in_reduction_zlaswp_33244_0)
    begin
        unique case (reduction_zlaswp_33244_mux_s)
            1'b0 : reduction_zlaswp_33244_mux_q = in_reduction_zlaswp_33244_1;
            1'b1 : reduction_zlaswp_33244_mux_q = in_reduction_zlaswp_33244_0;
            default : reduction_zlaswp_33244_mux_q = 1'b0;
        endcase
    end

    // out_reduction_zlaswp_33244(GPOUT,70)
    assign out_reduction_zlaswp_33244 = reduction_zlaswp_33244_mux_q;
    ...
    // unnamed_zlaswp36_mux(MUX,81)
    assign unnamed_zlaswp36_mux_s = in_valid_in_0;
    always @(unnamed_zlaswp36_mux_s or in_unnamed_zlaswp36_1 or in_unnamed_zlaswp36_0)
    begin
        unique case (unnamed_zlaswp36_mux_s)
            1'b0 : unnamed_zlaswp36_mux_q = in_unnamed_zlaswp36_1;
            1'b1 : unnamed_zlaswp36_mux_q = in_unnamed_zlaswp36_0;
            default : unnamed_zlaswp36_mux_q = 1'b0;
        endcase
    end

    // out_unnamed_zlaswp36(GPOUT,74)
    assign out_unnamed_zlaswp36 = unnamed_zlaswp36_mux_q;
