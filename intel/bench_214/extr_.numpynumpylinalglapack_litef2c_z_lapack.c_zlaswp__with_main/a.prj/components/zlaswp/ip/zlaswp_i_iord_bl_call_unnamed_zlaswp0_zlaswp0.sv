...
// SystemVerilog created from zlaswp_i_iord_bl_call_unnamed_zlaswp0_zlaswp0
...
module zlaswp_i_iord_bl_call_unnamed_zlaswp0_zlaswp0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_zlaswp_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_zlaswp_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_zlaswp_i_fifodata),
    ...
    assign out_iord_bl_call_zlaswp_o_fifoready = iord_o_fifoready;
