...
// SystemVerilog created from zlaswp_i_iowr_bl_return_unnamed_zlaswp54_zlaswp0
...
module zlaswp_i_iowr_bl_return_unnamed_zlaswp54_zlaswp0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_zlaswp_i_fifoready;
    ...
    assign out_iowr_bl_return_zlaswp_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_zlaswp_o_fifovalid = iowr_o_fifovalid;
