...
// SystemVerilog created from mark_for_codepoint_i_iord_bl_call_unnameA000000Z_mark_for_codepoint0
...
module mark_for_codepoint_i_iord_bl_call_unnameA000000Z_mark_for_codepoint0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_mark_for_codepoint_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_mark_for_codepoint_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_mark_for_codepoint_i_fifodata),
    ...
    assign out_iord_bl_call_mark_for_codepoint_o_fifoready = iord_o_fifoready;
