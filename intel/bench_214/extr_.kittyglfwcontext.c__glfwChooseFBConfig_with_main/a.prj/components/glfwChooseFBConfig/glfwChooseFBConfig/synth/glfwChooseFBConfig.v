...
module glfwChooseFBConfig (
	...
	glfwChooseFBConfig_internal glfwchoosefbconfig_internal_inst (
		...
		.desired              (desired),              //   input,  width = 64,        desired.data
		.alternatives         (alternatives),         //   input,  width = 64,   alternatives.data
		.count                (count),                //   input,  width = 32,          count.data
		.GLFW_DONT_CARE       (GLFW_DONT_CARE),       //   input,  width = 64, GLFW_DONT_CARE.data
		.UINT_MAX             (UINT_MAX),             //   input,  width = 64,       UINT_MAX.data
