...
// SystemVerilog created from emscripten_dom_vk_to_string_i_iord_bl_caA000000Zen_dom_vk_to_string0
...
module emscripten_dom_vk_to_string_i_iord_bl_caA000000Zen_dom_vk_to_string0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_emscripten_dom_vk_to_string_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_emscripten_dom_vk_to_string_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_emscripten_dom_vk_to_string_i_fifodata),
    ...
    assign out_iord_bl_call_emscripten_dom_vk_to_string_o_fifoready = iord_o_fifoready;
