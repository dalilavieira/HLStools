...
/////////////////////////////////////////////////////////////////
// MODULE afs_abort_to_error_internal
/////////////////////////////////////////////////////////////////
module afs_abort_to_error_internal
(
   input logic clock,
   input logic resetn,
   input logic [31:0] abort_code,
   input logic [63:0] EACCES,
   input logic [63:0] EAGAIN,
   input logic [63:0] EBADRQC,
   input logic [63:0] EBUSY,
   input logic [63:0] EDEADLK,
   input logic [63:0] EDOM,
   input logic [63:0] EDQUOT,
   input logic [63:0] EEXIST,
   input logic [63:0] EFBIG,
   input logic [63:0] EINVAL,
   input logic [63:0] EIO,
   input logic [63:0] EISDIR,
   input logic [63:0] EKEYEXPIRED,
   input logic [63:0] EKEYREJECTED,
   input logic [63:0] EMLINK,
   input logic [63:0] ENAMETOOLONG,
   input logic [63:0] ENODEV,
   input logic [63:0] ENOENT,
   input logic [63:0] ENOLCK,
   input logic [63:0] ENOMEDIUM,
   input logic [63:0] ENOMEM,
   input logic [63:0] ENOSPC,
   input logic [63:0] ENOTCONN,
   input logic [63:0] ENOTDIR,
   input logic [63:0] ENOTEMPTY,
   input logic [63:0] ENOTSUPP,
   input logic [63:0] ENXIO,
   input logic [63:0] EPERM,
   input logic [63:0] EPROTO,
   input logic [63:0] ERANGE,
   input logic [63:0] EREMOTEIO,
   input logic [63:0] EROFS,
   input logic [63:0] ETIMEDOUT,
   input logic [63:0] EWOULDBLOCK,
   input logic [63:0] EXDEV,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   ...
   // INST afs_abort_to_error_internal of afs_abort_to_error_function_wrapper
   afs_abort_to_error_function_wrapper afs_abort_to_error_internal
   (
      .clock(clock),
      .resetn(resetn),
      ...
      // AVM avm_pn1_afs_abort_to_error
      .avm_pn1_afs_abort_to_error_enable(avmm_0_global_avm_enable[0]),
      .avm_pn1_afs_abort_to_error_read(avmm_0_global_avm_read[0]),
      .avm_pn1_afs_abort_to_error_write(avmm_0_global_avm_write[0]),
      .avm_pn1_afs_abort_to_error_address(avmm_0_global_avm_address[0]),
      .avm_pn1_afs_abort_to_error_writedata(avmm_0_global_avm_writedata[0]),
      .avm_pn1_afs_abort_to_error_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_pn1_afs_abort_to_error_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_pn1_afs_abort_to_error_readdata(avmm_0_global_avm_readdata[0]),
      .avm_pn1_afs_abort_to_error_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_pn1_afs_abort_to_error_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_pn1_afs_abort_to_error_writeack(avmm_0_global_avm_writeack[0])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of afs_abort_to_error_internal_ic_11797103729985604047
      afs_abort_to_error_internal_ic_11797103729985604047 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE afs_abort_to_error_internal_ic_11797103729985604047
/////////////////////////////////////////////////////////////////
module afs_abort_to_error_internal_ic_11797103729985604047
(
   input logic clock,
