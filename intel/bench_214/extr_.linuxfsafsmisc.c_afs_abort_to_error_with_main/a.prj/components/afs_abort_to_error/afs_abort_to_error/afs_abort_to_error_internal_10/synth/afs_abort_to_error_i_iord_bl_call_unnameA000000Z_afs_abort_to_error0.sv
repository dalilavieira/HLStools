...
// SystemVerilog created from afs_abort_to_error_i_iord_bl_call_unnameA000000Z_afs_abort_to_error0
...
module afs_abort_to_error_i_iord_bl_call_unnameA000000Z_afs_abort_to_error0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_afs_abort_to_error_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_afs_abort_to_error_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_afs_abort_to_error_i_fifodata),
    ...
    // ip_dsdk_adapt_bitselect58(BITSELECT,33)
    assign ip_dsdk_adapt_bitselect58_b = iord_o_data[1855:1792];

    // ip_dsdk_adapt_bitselect56(BITSELECT,32)
    assign ip_dsdk_adapt_bitselect56_b = iord_o_data[1791:1728];

    // ip_dsdk_adapt_bitselect54(BITSELECT,31)
    ...
    // ip_dsdk_adapt_bitselect8(BITSELECT,42)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[255:192];

    // ip_dsdk_adapt_bitselect6(BITSELECT,34)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,85)@1
