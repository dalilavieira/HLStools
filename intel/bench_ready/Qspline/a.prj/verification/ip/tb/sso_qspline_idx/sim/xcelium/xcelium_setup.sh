...
TOP_LEVEL_NAME="sso_qspline_idx.sso_qspline_idx"
QSYS_SIMDIR="./../"
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [sso_qspline_idx::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [sso_qspline_idx::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
