source [file join [file dirname [info script]] ./../../../ip/tb/dpic_qspline/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/main_dpi_controller/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/qspline_en_cfan/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/qspline_cfan/sim/common/xcelium_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/qspline_ir_cfan/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/qspline/qspline/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_qspline_idx/sim/common/xcelium_files.tcl]

namespace eval tb {
  proc get_design_libraries {} {
    set libraries [dict create]
    set libraries [dict merge $libraries [dpic_qspline::get_design_libraries]]
    set libraries [dict merge $libraries [main_dpi_controller::get_design_libraries]]
    set libraries [dict merge $libraries [qspline_en_cfan::get_design_libraries]]
    set libraries [dict merge $libraries [qspline_cfan::get_design_libraries]]
    ...
    set libraries [dict merge $libraries [qspline_ir_cfan::get_design_libraries]]
    set libraries [dict merge $libraries [qspline::get_design_libraries]]
    set libraries [dict merge $libraries [sso_qspline_idx::get_design_libraries]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [dpic_qspline::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/dpic_qspline/sim/"]]
    ...
    set design_files [dict merge $design_files [qspline_en_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/qspline_en_cfan/sim/"]]
    set design_files [dict merge $design_files [qspline_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/qspline_cfan/sim/"]]
    ...
    set design_files [dict merge $design_files [qspline_ir_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/qspline_ir_cfan/sim/"]]
    set design_files [dict merge $design_files [qspline::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../../components/qspline/qspline/sim/"]]
    set design_files [dict merge $design_files [sso_qspline_idx::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_qspline_idx/sim/"]]
    return $design_files
  }
  
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    set design_files [list]
    set design_files [concat $design_files [dpic_qspline::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/dpic_qspline/sim/"]]
    ...
    set design_files [concat $design_files [qspline_en_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/qspline_en_cfan/sim/"]]
    set design_files [concat $design_files [qspline_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/qspline_cfan/sim/"]]
    ...
    set design_files [concat $design_files [qspline_ir_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/qspline_ir_cfan/sim/"]]
    set design_files [concat $design_files [qspline::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../../components/qspline/qspline/sim/"]]
    set design_files [concat $design_files [sso_qspline_idx::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_qspline_idx/sim/"]]
