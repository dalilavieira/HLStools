...
// SystemVerilog created from qspline_i_iord_bl_call_unnamed_qspline2_qspline0
...
module qspline_i_iord_bl_call_unnamed_qspline2_qspline0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_qspline_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_qspline_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_qspline_i_fifodata),
    ...
    assign out_iord_bl_call_qspline_o_fifoready = iord_o_fifoready;
