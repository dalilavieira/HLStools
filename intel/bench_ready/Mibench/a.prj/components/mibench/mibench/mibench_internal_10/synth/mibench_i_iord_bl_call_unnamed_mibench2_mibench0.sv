...
// SystemVerilog created from mibench_i_iord_bl_call_unnamed_mibench2_mibench0
...
module mibench_i_iord_bl_call_unnamed_mibench2_mibench0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_mibench_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_mibench_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_mibench_i_fifodata),
    ...
    assign out_iord_bl_call_mibench_o_fifoready = iord_o_fifoready;
