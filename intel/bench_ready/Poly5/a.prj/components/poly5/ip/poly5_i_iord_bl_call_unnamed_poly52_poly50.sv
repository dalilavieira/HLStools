...
// SystemVerilog created from poly5_i_iord_bl_call_unnamed_poly52_poly50
...
module poly5_i_iord_bl_call_unnamed_poly52_poly50 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_poly5_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_poly5_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_poly5_i_fifodata),
    ...
    assign out_iord_bl_call_poly5_o_fifoready = iord_o_fifoready;
