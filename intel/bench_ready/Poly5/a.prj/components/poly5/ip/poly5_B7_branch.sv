...
// SystemVerilog created from poly5_B7_branch
...
module poly5_B7_branch (
    ...
    wire [0:0] poly5_B7_branch_enable_q;
    wire [0:0] poly5_B7_branch_enable_not_q;
    ...
    begin
        ...
        else if (poly5_B7_branch_enable_q == 1'b1)
        begin
    ...
    // poly5_B7_branch_enable(LOGICAL,19)
    assign poly5_B7_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // poly5_B7_branch_enable_not(LOGICAL,20)
    assign poly5_B7_branch_enable_not_q = ~ (poly5_B7_branch_enable_q);

    // out_stall_out(GPOUT,16)
    assign out_stall_out = poly5_B7_branch_enable_not_q;
