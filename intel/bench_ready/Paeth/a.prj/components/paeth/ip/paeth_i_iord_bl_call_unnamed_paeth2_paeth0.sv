...
// SystemVerilog created from paeth_i_iord_bl_call_unnamed_paeth2_paeth0
...
module paeth_i_iord_bl_call_unnamed_paeth2_paeth0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_paeth_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_paeth_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_paeth_i_fifodata),
    ...
    assign out_iord_bl_call_paeth_o_fifoready = iord_o_fifoready;
