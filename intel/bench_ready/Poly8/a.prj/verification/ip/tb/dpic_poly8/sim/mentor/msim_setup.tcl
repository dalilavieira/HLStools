...
# ----------------------------------------
# If dpic_poly8 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 19.4 64 linux 2020.04.27.09:53:25
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "dpic_poly8.dpic_poly8"
}
...
append ELAB_OPTIONS [subst [dpic_poly8::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [dpic_poly8::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [dpic_poly8::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [dpic_poly8::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [dpic_poly8::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [dpic_poly8::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
