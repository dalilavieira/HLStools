...
// SystemVerilog created from poly8_i_iowr_bl_return_unnamed_poly86_poly80
...
module poly8_i_iowr_bl_return_unnamed_poly86_poly80 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_poly8_i_fifoready;
    ...
    assign out_iowr_bl_return_poly8_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_poly8_o_fifovalid = iowr_o_fifovalid;
