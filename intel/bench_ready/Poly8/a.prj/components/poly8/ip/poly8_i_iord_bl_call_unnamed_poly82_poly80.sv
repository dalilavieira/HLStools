...
// SystemVerilog created from poly8_i_iord_bl_call_unnamed_poly82_poly80
...
module poly8_i_iord_bl_call_unnamed_poly82_poly80 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_poly8_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_poly8_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_poly8_i_fifodata),
    ...
    assign out_iord_bl_call_poly8_o_fifoready = iord_o_fifoready;
