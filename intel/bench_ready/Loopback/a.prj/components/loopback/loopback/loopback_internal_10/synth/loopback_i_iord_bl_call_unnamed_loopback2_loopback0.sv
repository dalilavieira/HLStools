...
// SystemVerilog created from loopback_i_iord_bl_call_unnamed_loopback2_loopback0
...
module loopback_i_iord_bl_call_unnamed_loopback2_loopback0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_loopback_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_loopback_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_loopback_i_fifodata),
    ...
    assign out_iord_bl_call_loopback_o_fifoready = iord_o_fifoready;
