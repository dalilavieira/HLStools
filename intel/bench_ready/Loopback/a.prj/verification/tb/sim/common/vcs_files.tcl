source [file join [file dirname [info script]] ./../../../ip/tb/loopback_ir_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/loopback/loopback/sim/common/vcs_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/loopback_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_loopback/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_loopback_idx/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/loopback_en_cfan/sim/common/vcs_files.tcl]
...
namespace eval tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [loopback_ir_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/loopback_ir_cfan/sim/"]]
    set design_files [dict merge $design_files [loopback::get_common_design_files "$QSYS_SIMDIR/../../../components/loopback/loopback/sim/"]]
    ...
    set design_files [dict merge $design_files [loopback_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/loopback_cfan/sim/"]]
    set design_files [dict merge $design_files [clock_reset::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/clock_reset/sim/"]]
    set design_files [dict merge $design_files [dpic_loopback::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/dpic_loopback/sim/"]]
    set design_files [dict merge $design_files [sso_loopback_idx::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_loopback_idx/sim/"]]
    set design_files [dict merge $design_files [loopback_en_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/loopback_en_cfan/sim/"]]
    return $design_files
  }
  
  proc get_design_files {QSYS_SIMDIR} {
    set design_files [dict create]
    set design_files [dict merge $design_files [loopback_ir_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/loopback_ir_cfan/sim/"]]
    set design_files [dict merge $design_files [loopback::get_design_files "$QSYS_SIMDIR/../../../components/loopback/loopback/sim/"]]
    ...
    set design_files [dict merge $design_files [loopback_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/loopback_cfan/sim/"]]
    set design_files [dict merge $design_files [clock_reset::get_design_files "$QSYS_SIMDIR/../../ip/tb/clock_reset/sim/"]]
    set design_files [dict merge $design_files [dpic_loopback::get_design_files "$QSYS_SIMDIR/../../ip/tb/dpic_loopback/sim/"]]
    set design_files [dict merge $design_files [sso_loopback_idx::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_loopback_idx/sim/"]]
    set design_files [dict merge $design_files [loopback_en_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/loopback_en_cfan/sim/"]]
