source [file join [file dirname [info script]] ./../../../ip/tb/loopback_ir_cfan/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/loopback/loopback/sim/common/vcsmx_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/loopback_cfan/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_loopback/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_loopback_idx/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/loopback_en_cfan/sim/common/vcsmx_files.tcl]
