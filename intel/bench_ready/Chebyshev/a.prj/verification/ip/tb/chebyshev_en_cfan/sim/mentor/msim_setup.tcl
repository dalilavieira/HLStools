...
# ----------------------------------------
# If chebyshev_en_cfan is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "chebyshev_en_cfan.chebyshev_en_cfan"
}
...
append ELAB_OPTIONS [subst [chebyshev_en_cfan::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [chebyshev_en_cfan::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [chebyshev_en_cfan::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [chebyshev_en_cfan::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [chebyshev_en_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [chebyshev_en_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
