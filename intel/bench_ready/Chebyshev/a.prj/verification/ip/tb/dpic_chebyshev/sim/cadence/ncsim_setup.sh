...
TOP_LEVEL_NAME="dpic_chebyshev.dpic_chebyshev"
QSYS_SIMDIR="./../"
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set design_files [dict merge $design_files [dpic_chebyshev::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/ncsim_files.tcl
set files [concat $files [dpic_chebyshev::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
