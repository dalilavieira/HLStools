...
// SystemVerilog created from sgfilter_i_iord_bl_call_unnamed_sgfilter2_sgfilter0
...
module sgfilter_i_iord_bl_call_unnamed_sgfilter2_sgfilter0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_sgfilter_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_sgfilter_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_sgfilter_i_fifodata),
    ...
    assign out_iord_bl_call_sgfilter_o_fifoready = iord_o_fifoready;
