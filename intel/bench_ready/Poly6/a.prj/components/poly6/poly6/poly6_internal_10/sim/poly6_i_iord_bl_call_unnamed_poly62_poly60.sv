...
// SystemVerilog created from poly6_i_iord_bl_call_unnamed_poly62_poly60
...
module poly6_i_iord_bl_call_unnamed_poly62_poly60 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_poly6_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_poly6_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_poly6_i_fifodata),
    ...
    assign out_iord_bl_call_poly6_o_fifoready = iord_o_fifoready;
