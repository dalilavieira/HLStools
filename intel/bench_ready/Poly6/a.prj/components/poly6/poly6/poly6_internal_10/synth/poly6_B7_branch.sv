...
// SystemVerilog created from poly6_B7_branch
...
module poly6_B7_branch (
    ...
    wire [0:0] poly6_B7_branch_enable_q;
    wire [0:0] poly6_B7_branch_enable_not_q;
    ...
    begin
        ...
        else if (poly6_B7_branch_enable_q == 1'b1)
        begin
    ...
    // poly6_B7_branch_enable(LOGICAL,19)
    assign poly6_B7_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // poly6_B7_branch_enable_not(LOGICAL,20)
    assign poly6_B7_branch_enable_not_q = ~ (poly6_B7_branch_enable_q);

    // out_stall_out(GPOUT,16)
    assign out_stall_out = poly6_B7_branch_enable_not_q;
