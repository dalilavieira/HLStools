...
// SystemVerilog created from fir_bb_B9_stall_region
...
module fir_bb_B9_stall_region (
    input wire [0:0] in_stall_in,
    output wire [0:0] out_stall_out,
    input wire [0:0] in_c0_exe51363,
    input wire [0:0] in_valid_in,
    output wire [0:0] out_c0_exe51363,
    ...
    assign bubble_join_stall_entry_q = in_c0_exe51363;

    // bubble_select_stall_entry(BITSELECT,12)
    assign bubble_select_stall_entry_b = $unsigned(bubble_join_stall_entry_q[0:0]);

    // dupName_0_sync_out_x(GPOUT,9)@0
    assign out_c0_exe51363 = bubble_select_stall_entry_b;
