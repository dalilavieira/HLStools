...
// SystemVerilog created from fir_i_iord_bl_call_unnamed_fir2_fir0
...
module fir_i_iord_bl_call_unnamed_fir2_fir0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_fir_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_fir_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_fir_i_fifodata),
    ...
    assign out_iord_bl_call_fir_o_fifoready = iord_o_fifoready;
