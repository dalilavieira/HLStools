...
// SystemVerilog created from fir_bb_B1_start
...
module fir_bb_B1_start (
    ...
    wire [0:0] bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_stall_out;
    wire [0:0] bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_valid_out;
    wire [0:0] bb_fir_B1_start_stall_region_out_feedback_stall_out_1;
    wire [31:0] bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_1_0;
    ...
    wire [31:0] bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_0_0_0_tpl;
    wire [31:0] bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_0_0_1_tpl;
    ...
    wire [0:0] fir_B1_start_merge_out_stall_out_1;
    wire [0:0] fir_B1_start_merge_out_valid_out;


    // fir_B1_start_merge(BLACKBOX,7)
    fir_B1_start_merge thefir_B1_start_merge (
        ...
        .out_stall_out_1(fir_B1_start_merge_out_stall_out_1),
        .out_valid_out(fir_B1_start_merge_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // fir_B1_start_branch(BLACKBOX,6)
    ...
    fir_bb_B1_start_stall_region thebb_fir_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_stall_out(bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_valid_out(bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_valid_out),
        ...
        .out_intel_reserved_ffwd_0_0_0_tpl(bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_0_0_0_tpl),
        .out_intel_reserved_ffwd_0_0_1_tpl(bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_0_0_1_tpl),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    assign out_exiting_stall_out = bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,16)
    assign out_exiting_valid_out = bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going68_fir1_exiting_valid_out;
    ...
    assign out_intel_reserved_ffwd_0_0_0_tpl = bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_0_0_0_tpl;

    // out_intel_reserved_ffwd_0_0_1_tpl(GPOUT,23)
    assign out_intel_reserved_ffwd_0_0_1_tpl = bb_fir_B1_start_stall_region_out_intel_reserved_ffwd_0_0_1_tpl;
