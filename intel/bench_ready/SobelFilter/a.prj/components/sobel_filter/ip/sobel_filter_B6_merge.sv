...
// SystemVerilog created from sobel_filter_B6_merge
...
module sobel_filter_B6_merge (
    ...
    // out_c0_exe32921(GPOUT,7)
    assign out_c0_exe32921 = in_c0_exe32921_0;

    // out_c0_exe42(GPOUT,8)
