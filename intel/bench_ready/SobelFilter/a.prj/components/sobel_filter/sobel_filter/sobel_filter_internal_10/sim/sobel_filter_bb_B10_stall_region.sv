...
// SystemVerilog created from sobel_filter_bb_B10_stall_region
...
module sobel_filter_bb_B10_stall_region (
    input wire [0:0] in_stall_in,
    output wire [0:0] out_stall_out,
    input wire [0:0] in_c0_exe43415,
    input wire [0:0] in_c0_exe53427,
    input wire [0:0] in_c0_exe63439,
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe63439, in_c0_exe53427, in_c0_exe43415};
    ...
    assign out_c0_exe43415 = bubble_select_stall_entry_b;
    assign out_c0_exe53427 = bubble_select_stall_entry_c;
    assign out_c0_exe63439 = bubble_select_stall_entry_d;
