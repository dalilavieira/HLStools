...
// SystemVerilog created from sobel_filter_i_iord_bl_call_unnamed_sobel_filter5_sobel_filter0
...
module sobel_filter_i_iord_bl_call_unnamed_sobel_filter5_sobel_filter0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_sobel_filter_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_sobel_filter_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_sobel_filter_i_fifodata),
    ...
    assign out_iord_bl_call_sobel_filter_o_fifoready = iord_o_fifoready;
