...
// SystemVerilog created from kmeans_bb_B13_sr_0
...
module kmeans_bb_B13_sr_0 (
    ...
    begin
        if (!resetn)
        begin
            sr_0_x_q <= $unsigned(16'b0000000000000000);
        end
