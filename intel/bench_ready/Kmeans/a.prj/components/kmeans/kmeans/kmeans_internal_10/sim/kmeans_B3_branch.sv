...
// SystemVerilog created from kmeans_B3_branch
...
module kmeans_B3_branch (
    ...
    wire [0:0] kmeans_B3_branch_enable_q;
    wire [0:0] kmeans_B3_branch_enable_not_q;
    ...
    begin
        ...
        else if (kmeans_B3_branch_enable_q == 1'b1)
        begin
    ...
    // kmeans_B3_branch_enable(LOGICAL,7)
    assign kmeans_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // kmeans_B3_branch_enable_not(LOGICAL,8)
    assign kmeans_B3_branch_enable_not_q = ~ (kmeans_B3_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = kmeans_B3_branch_enable_not_q;
