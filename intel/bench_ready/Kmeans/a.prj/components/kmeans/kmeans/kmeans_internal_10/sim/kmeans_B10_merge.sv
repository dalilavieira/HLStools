...
// SystemVerilog created from kmeans_B10_merge
...
module kmeans_B10_merge (
    ...
    output wire [0:0] out_notcmp51122,
    ...
    wire [0:0] notcmp51122_mux_s;
    reg [0:0] notcmp51122_mux_q;
    ...
    // out_forked107(GPOUT,11)
    assign out_forked107 = forked107_mux_q;

    // notcmp51122_mux(MUX,10)
    assign notcmp51122_mux_s = in_valid_in_0;
    always @(notcmp51122_mux_s or in_notcmp51122_1 or in_notcmp51122_0)
    begin
        unique case (notcmp51122_mux_s)
            1'b0 : notcmp51122_mux_q = in_notcmp51122_1;
            1'b1 : notcmp51122_mux_q = in_notcmp51122_0;
            default : notcmp51122_mux_q = 1'b0;
        endcase
    end

    // out_notcmp51122(GPOUT,12)
    assign out_notcmp51122 = notcmp51122_mux_q;
