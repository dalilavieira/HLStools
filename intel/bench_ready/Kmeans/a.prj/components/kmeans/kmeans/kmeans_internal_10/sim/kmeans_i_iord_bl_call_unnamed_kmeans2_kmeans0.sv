...
// SystemVerilog created from kmeans_i_iord_bl_call_unnamed_kmeans2_kmeans0
...
module kmeans_i_iord_bl_call_unnamed_kmeans2_kmeans0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_kmeans_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_kmeans_i_fifovalid;
    ...
    st_read #(
        ...
        .i_fifodata(in_iord_bl_call_kmeans_i_fifodata),
    ...
    assign out_iord_bl_call_kmeans_o_fifoready = iord_o_fifoready;
