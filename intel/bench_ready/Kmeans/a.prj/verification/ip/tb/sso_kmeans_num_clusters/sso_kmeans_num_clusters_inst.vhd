	component sso_kmeans_num_clusters is
		generic (
			COMPONENT_NAME                  : string  := "dut";
			INTERFACE_NAME                  : string  := "a";
			STREAM_DATAWIDTH                : integer := 1;
	...
	end component sso_kmeans_num_clusters;

	u0 : component sso_kmeans_num_clusters
		generic map (
