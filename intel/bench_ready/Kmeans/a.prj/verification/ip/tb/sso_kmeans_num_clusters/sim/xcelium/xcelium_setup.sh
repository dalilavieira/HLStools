...
TOP_LEVEL_NAME="sso_kmeans_num_clusters.sso_kmeans_num_clusters"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/opt/altera_pro/19.4/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [sso_kmeans_num_clusters::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [sso_kmeans_num_clusters::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
