...
parameter  LEGUP_F_toGLFWKeyCode_BB_0_1 = 1'd1;
...
begin
cur_state <= LEGUP_F_toGLFWKeyCode_BB_0_1;
if (reset == 1'b0 && ^(LEGUP_F_toGLFWKeyCode_BB_0_1) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
end
...
if (((cur_state == LEGUP_F_toGLFWKeyCode_BB_0_1) & (memory_controller_waitrequest == 1'd1)))
begin
cur_state <= LEGUP_F_toGLFWKeyCode_BB_0_1;
if (reset == 1'b0 && ^(LEGUP_F_toGLFWKeyCode_BB_0_1) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
end
if (((cur_state == LEGUP_F_toGLFWKeyCode_BB_0_1) & (memory_controller_waitrequest == 1'd0)))
begin
cur_state <= LEGUP_0;
if (reset == 1'b0 && ^(LEGUP_0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
end
...
/* toGLFWKeyCode: %0*/
/*   ret i32 0*/
if ((cur_state == LEGUP_F_toGLFWKeyCode_BB_0_1))
begin
