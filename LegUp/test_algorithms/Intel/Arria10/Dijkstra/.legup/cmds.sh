...
/cygdrive/c/LegUp-7.5/legup/examples/mark_labels.pl dijkstra.c > dijkstra_labeled.c;
...
# produces pre-link time optimization binary bitcode: ./.legup/Dijkstra.prelto.bc
...
# to produce Dijkstra.prelto.1.bc
# If not using OpenMP, use Clang
clang-3.5.2 dijkstra_labeled.c -emit-llvm -c -D__LEGUP__  -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/include -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0 -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0/x86_64-unknown-linux-gnu/ -m32 -I /usr/include/i386-linux-gnu -D LEGUP_DEFAULT_FIFO_DEPTH=2 -O3 -fno-builtin -I C:/LegUp-7.5/legup/examples/lib/include/ -I C:/LegUp-7.5/legup/legup-library -I/cygdrive/c/LegUp-7.5/legup/legup-library  -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/include -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0 -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0/x86_64-unknown-linux-gnu/ -fno-vectorize -fno-slp-vectorize -Werror=implicit-function-declaration -Wno-ignored-attributes -fno-exceptions -D __LEGUP__ -I C:/LegUp-7.5/legup/include -I C:/LegUp-7.5/cygwin64/usr/include -I C:/LegUp-7.5/cygwin64/lib/gcc/x86_64-pc-cygwin/5.4.0/include/c++ -I C:/LegUp-7.5/cygwin64/lib/gcc/x86_64-pc-cygwin/5.4.0/include/c++/x86_64-pc-cygwin -g -mllvm -inline-threshold=-9999 -o ./.legup/dijkstra_labeled.bc || { rm -f dijkstra_labeled.c && false; };
#mv dijkstra_labeled.c ./.legup  # this breaks eclipse
rm -f dijkstra_labeled.c
# Then uses llvm-link to link all the .bc file (without optimizations)
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llvm-link  ./.legup/dijkstra_labeled.bc -o ./.legup/Dijkstra.prelto.1.bc; 
# Remove debug info if the TCL parameter REMOVE_DEBUG_INFO is set.
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -remove-debug-info ./.legup/Dijkstra.prelto.1.bc -o ./.legup/Dijkstra.prelto.1.bc
# Set the variable to zero if not set.
#---------------------------------------------------------------------------#
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-preprocessing -always-inline -axi-interface -std-link-opts -break-constgeps -loweratomic ./.legup/Dijkstra.prelto.1.bc -o ./.legup/Dijkstra.preprocessing.bc
# annotated top-level pointer and global variables and remove sw testbench
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-sc-parser  -annotate-toplevel-ptrargs -ANALYZE_WHOLE_PROGRAM=1 -before-removing-tb=1 -removeswtestbench ./.legup/Dijkstra.preprocessing.bc -o ./.legup/Dijkstra.swremoved.bc
# lower special types
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -arbitrary-bitwidth -legup-lower-sc ./.legup/Dijkstra.swremoved.bc -o ./.legup/Dijkstra.lower.int.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -break-constgeps -legup-lower-ap ./.legup/Dijkstra.lower.int.bc -o ./.legup/Dijkstra.lower.ap.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -data-pack -split-legup-force-reg ./.legup/Dijkstra.lower.ap.bc -o ./.legup/Dijkstra.lower.datapack.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-lower-fifos ./.legup/Dijkstra.lower.datapack.bc -o ./.legup/Dijkstra.lower.fifo.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -basiccg -inline-cost -inline -globalopt -globaldce ./.legup/Dijkstra.lower.fifo.bc -o ./.legup/Dijkstra.lower.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -std-link-opts ./.legup/Dijkstra.lower.bc -o ./.legup/Dijkstra.stdlinkopts.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -std-compile-opts ./.legup/Dijkstra.stdlinkopts.bc -o ./.legup/Dijkstra.stdcompileopts.bc	
# performs intrinsic lowering 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-prelto ./.legup/Dijkstra.stdcompileopts.bc -o ./.legup/Dijkstra.legupprelto.bc
# perform link-time optimizations
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -std-link-opts ./.legup/Dijkstra.legupprelto.bc -o ./.legup/Dijkstra.stdlinkopts2.bc
# link libraries
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llvm-link  ./.legup/Dijkstra.stdlinkopts2.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/liblegup.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/liblegupParallel.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/libm.bc -o ./.legup/Dijkstra.postlto.6.bc	
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -internalize-public-api-list=main -globaldce -std-link-opts -internalize ./.legup/Dijkstra.postlto.6.bc -o ./.legup/Dijkstra.postlto.8.bc
# check for unsupported C features 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-code-support-checking -HYBRID_FLOW=0 ./.legup/Dijkstra.postlto.8.bc -o /dev/null
# arbitrary bitwidth
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-process-bw -legup-prop-bw ./.legup/Dijkstra.postlto.8.bc -o ./.legup/Dijkstra.ab.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -indvars2 -mem2reg -simplifycfg -loops -lcssa -loop-simplify -loop-rotate ./.legup/Dijkstra.ab.bc -o ./.legup/Dijkstra.looprotate.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -break-constgeps ./.legup/Dijkstra.loop_nest_merged.bc -o ./.legup/Dijkstra.breakgeps.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-parallel-api -HYBRID_FLOW=0 ./.legup/Dijkstra.breakgeps.bc -o ./.legup/Dijkstra.parallel.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -voidptr-argpromotion -dce -globaldce ./.legup/Dijkstra.parallel.bc -o ./.legup/Dijkstra.voidptr.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -std-link-opts -break-constgeps ./.legup/Dijkstra.voidptr.bc -o ./.legup/Dijkstra.voidptropt.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -mem-partition -axi-interface -axi-rm-unused-mem-only -dce -deadargelim -dce -globaldce ./.legup/Dijkstra.voidptropt.bc -o ./.legup/Dijkstra.mp.bc
# annotate fifo function arguments with their widths and as input/output FIFOs
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-sc-fsm-generator -annotate-toplevel-ptrargs ./.legup/Dijkstra.mp.bc -o ./.legup/Dijkstra.fifo.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-handle-static-objects -dce ./.legup/Dijkstra.fifo.bc -o ./.legup/Dijkstra.static.bc
# 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -mergereturn -legup-ga2l -dce -mem2reg ./.legup/Dijkstra.static.bc -o ./.legup/Dijkstra.ga2l.1.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-crit-edges -legup-ga2l -break-exit-stores -simplifycfg ./.legup/Dijkstra.ga2l.1.bc -o ./.legup/Dijkstra.ga2l.bc
# perform link-time optimizations
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -std-link-opts ./.legup/Dijkstra.ga2l.bc -o ./.legup/Dijkstra.postlto.bc
...
# /cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-constgeps -legup-lower-ap ./.legup/Dijkstra.postlto.bc -o ./.legup/Dijkstra.lower.ap.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-constgeps -legup-struct-support-checking ./.legup/Dijkstra.postlto.bc -o ./.legup/Dijkstra.check.struct.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-promote-ap ./.legup/Dijkstra.check.struct.bc -o ./.legup/Dijkstra.promoted.ap.bc
cp ./.legup/Dijkstra.promoted.ap.bc ./.legup/Dijkstra.ap.1.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -basicaa -loop-simplify -indvars2 -instcombine -gvn -legup-strength-reduction -legup-expr-tree-balance -legup-store-merge ./.legup/Dijkstra.ap.1.bc -o ./.legup/Dijkstra.preifconv.1.bc
# These passes are run before COMBINE_BB_PASS as a preprocessing
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -lowerswitch -simplifycfg ./.legup/Dijkstra.preifconv.1.bc -o ./.legup/Dijkstra.preifconv.2.bc
#/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-combine-bb -combine-bb-aggressive=1 -combine-bb=1 -loops-only=0 -generate-merge-rpt ./.legup/Dijkstra.preifconv.2.bc -o ./.legup/Dijkstra.ifconv.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-if-conversion ./.legup/Dijkstra.preifconv.2.bc -o ./.legup/Dijkstra.ifconv.bc
...
#---------------------------------------------------------------------------#
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -simplifycfg ./.legup/Dijkstra.ifconv.bc -o ./.legup/Dijkstra.ifconv.1.bc
#/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -gvn -legup-strength-reduction ./.legup/Dijkstra.ifconv.bc -o ./.legup/Dijkstra.ifconv.1.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -loop-simplify -indvars2 -instcombine -gvn -legup-strength-reduction -argpromotion -annotate-fifoarguments ./.legup/Dijkstra.ifconv.1.bc -o ./.legup/Dijkstra.ifconv.2.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-reduce-latency -legup-reduce-latency-annotate-depth -fuse-ops -bit-manipulation -globaldce -adce -annotate-legup-force-reg ./.legup/Dijkstra.ifconv.2.bc -o ./.legup/Dijkstra.finaloptimizedir.bc
# Restore predicate metadata with restore-metadata
rm -f reports/pipelining.legup.rpt
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -restore-metadata -basicaa -loop-pipeline -function-pipeline -HYBRID_FLOW=0 ./.legup/Dijkstra.finaloptimizedir.bc -o ./.legup/Dijkstra.bc
...
#---------------------------------------------------------------------------#
# Set the variable to zero if not set.
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llc -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -march=v -HYBRID_FLOW=0 -LEGUP_ACCELERATOR_FILENAME=Dijkstra ./.legup/Dijkstra.bc -o Dijkstra.v
