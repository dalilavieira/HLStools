...
/cygdrive/c/LegUp-7.5/legup/examples/mark_labels.pl mandelbrot.c > mandelbrot_labeled.c;
...
# produces pre-link time optimization binary bitcode: ./.legup/Mandelbrot.prelto.bc
...
# to produce Mandelbrot.prelto.1.bc
# If not using OpenMP, use Clang
clang-3.5.2 mandelbrot_labeled.c -emit-llvm -c -D__LEGUP__  -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/include -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0 -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0/x86_64-unknown-linux-gnu/ -m32 -I /usr/include/i386-linux-gnu -D LEGUP_DEFAULT_FIFO_DEPTH=2 -O3 -fno-builtin -I C:/LegUp-7.5/legup/examples/lib/include/ -I C:/LegUp-7.5/legup/legup-library -I/cygdrive/c/LegUp-7.5/legup/legup-library  -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/include -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0 -I/cygdrive/c/LegUp-7.5/legup/examples/../dependencies/gcc/include/c++/5.4.0/x86_64-unknown-linux-gnu/ -fno-vectorize -fno-slp-vectorize -Werror=implicit-function-declaration -Wno-ignored-attributes -fno-exceptions -D __LEGUP__ -I C:/LegUp-7.5/legup/include -I C:/LegUp-7.5/cygwin64/usr/include -I C:/LegUp-7.5/cygwin64/lib/gcc/x86_64-pc-cygwin/5.4.0/include/c++ -I C:/LegUp-7.5/cygwin64/lib/gcc/x86_64-pc-cygwin/5.4.0/include/c++/x86_64-pc-cygwin -g -mllvm -inline-threshold=-9999 -o ./.legup/mandelbrot_labeled.bc || { rm -f mandelbrot_labeled.c && false; };
#mv mandelbrot_labeled.c ./.legup  # this breaks eclipse
rm -f mandelbrot_labeled.c
# Then uses llvm-link to link all the .bc file (without optimizations)
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llvm-link  ./.legup/mandelbrot_labeled.bc -o ./.legup/Mandelbrot.prelto.1.bc; 
# Remove debug info if the TCL parameter REMOVE_DEBUG_INFO is set.
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -remove-debug-info ./.legup/Mandelbrot.prelto.1.bc -o ./.legup/Mandelbrot.prelto.1.bc
# Set the variable to zero if not set.
#---------------------------------------------------------------------------#
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-preprocessing -always-inline -axi-interface -std-link-opts -break-constgeps -loweratomic ./.legup/Mandelbrot.prelto.1.bc -o ./.legup/Mandelbrot.preprocessing.bc
# annotated top-level pointer and global variables and remove sw testbench
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-sc-parser  -annotate-toplevel-ptrargs -ANALYZE_WHOLE_PROGRAM=1 -before-removing-tb=1 -removeswtestbench ./.legup/Mandelbrot.preprocessing.bc -o ./.legup/Mandelbrot.swremoved.bc
# lower special types
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -arbitrary-bitwidth -legup-lower-sc ./.legup/Mandelbrot.swremoved.bc -o ./.legup/Mandelbrot.lower.int.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -break-constgeps -legup-lower-ap ./.legup/Mandelbrot.lower.int.bc -o ./.legup/Mandelbrot.lower.ap.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -data-pack -split-legup-force-reg ./.legup/Mandelbrot.lower.ap.bc -o ./.legup/Mandelbrot.lower.datapack.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-lower-fifos ./.legup/Mandelbrot.lower.datapack.bc -o ./.legup/Mandelbrot.lower.fifo.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -basiccg -inline-cost -inline -globalopt -globaldce ./.legup/Mandelbrot.lower.fifo.bc -o ./.legup/Mandelbrot.lower.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -std-link-opts ./.legup/Mandelbrot.lower.bc -o ./.legup/Mandelbrot.stdlinkopts.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -std-compile-opts ./.legup/Mandelbrot.stdlinkopts.bc -o ./.legup/Mandelbrot.stdcompileopts.bc	
# performs intrinsic lowering 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-prelto ./.legup/Mandelbrot.stdcompileopts.bc -o ./.legup/Mandelbrot.legupprelto.bc
# perform link-time optimizations
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -std-link-opts ./.legup/Mandelbrot.legupprelto.bc -o ./.legup/Mandelbrot.stdlinkopts2.bc
# link libraries
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llvm-link  ./.legup/Mandelbrot.stdlinkopts2.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/liblegup.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/liblegupParallel.bc /cygdrive/c/LegUp-7.5/legup/examples/lib/llvm/libm.bc -o ./.legup/Mandelbrot.postlto.6.bc	
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -internalize-public-api-list=main -globaldce -std-link-opts -internalize ./.legup/Mandelbrot.postlto.6.bc -o ./.legup/Mandelbrot.postlto.8.bc
# check for unsupported C features 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -legup-code-support-checking -HYBRID_FLOW=0 ./.legup/Mandelbrot.postlto.8.bc -o /dev/null
# arbitrary bitwidth
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-process-bw -legup-prop-bw ./.legup/Mandelbrot.postlto.8.bc -o ./.legup/Mandelbrot.ab.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -indvars2 -mem2reg -simplifycfg -loops -lcssa -loop-simplify -loop-rotate ./.legup/Mandelbrot.ab.bc -o ./.legup/Mandelbrot.looprotate.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1 -break-constgeps ./.legup/Mandelbrot.loop_nest_merged.bc -o ./.legup/Mandelbrot.breakgeps.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-parallel-api -HYBRID_FLOW=0 ./.legup/Mandelbrot.breakgeps.bc -o ./.legup/Mandelbrot.parallel.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -voidptr-argpromotion -dce -globaldce ./.legup/Mandelbrot.parallel.bc -o ./.legup/Mandelbrot.voidptr.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -std-link-opts -break-constgeps ./.legup/Mandelbrot.voidptr.bc -o ./.legup/Mandelbrot.voidptropt.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -mem-partition -axi-interface -axi-rm-unused-mem-only -dce -deadargelim -dce -globaldce ./.legup/Mandelbrot.voidptropt.bc -o ./.legup/Mandelbrot.mp.bc
# annotate fifo function arguments with their widths and as input/output FIFOs
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-sc-fsm-generator -annotate-toplevel-ptrargs ./.legup/Mandelbrot.mp.bc -o ./.legup/Mandelbrot.fifo.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-handle-static-objects -dce ./.legup/Mandelbrot.fifo.bc -o ./.legup/Mandelbrot.static.bc
# 
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -mergereturn -legup-ga2l -dce -mem2reg ./.legup/Mandelbrot.static.bc -o ./.legup/Mandelbrot.ga2l.1.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-crit-edges -legup-ga2l -break-exit-stores -simplifycfg ./.legup/Mandelbrot.ga2l.1.bc -o ./.legup/Mandelbrot.ga2l.bc
# perform link-time optimizations
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -std-link-opts ./.legup/Mandelbrot.ga2l.bc -o ./.legup/Mandelbrot.postlto.bc
...
# /cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-constgeps -legup-lower-ap ./.legup/Mandelbrot.postlto.bc -o ./.legup/Mandelbrot.lower.ap.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -break-constgeps -legup-struct-support-checking ./.legup/Mandelbrot.postlto.bc -o ./.legup/Mandelbrot.check.struct.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-promote-ap ./.legup/Mandelbrot.check.struct.bc -o ./.legup/Mandelbrot.promoted.ap.bc
cp ./.legup/Mandelbrot.promoted.ap.bc ./.legup/Mandelbrot.ap.1.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -basicaa -loop-simplify -indvars2 -instcombine -gvn -legup-strength-reduction -legup-expr-tree-balance -legup-store-merge ./.legup/Mandelbrot.ap.1.bc -o ./.legup/Mandelbrot.preifconv.1.bc
# These passes are run before COMBINE_BB_PASS as a preprocessing
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -lowerswitch -simplifycfg ./.legup/Mandelbrot.preifconv.1.bc -o ./.legup/Mandelbrot.preifconv.2.bc
#/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-combine-bb -combine-bb-aggressive=1 -combine-bb=1 -loops-only=0 -generate-merge-rpt ./.legup/Mandelbrot.preifconv.2.bc -o ./.legup/Mandelbrot.ifconv.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-if-conversion ./.legup/Mandelbrot.preifconv.2.bc -o ./.legup/Mandelbrot.ifconv.bc
...
#---------------------------------------------------------------------------#
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -simplifycfg ./.legup/Mandelbrot.ifconv.bc -o ./.legup/Mandelbrot.ifconv.1.bc
#/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -instcombine -gvn -legup-strength-reduction ./.legup/Mandelbrot.ifconv.bc -o ./.legup/Mandelbrot.ifconv.1.bc
...
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -loop-simplify -indvars2 -instcombine -gvn -legup-strength-reduction -argpromotion -annotate-fifoarguments ./.legup/Mandelbrot.ifconv.1.bc -o ./.legup/Mandelbrot.ifconv.2.bc
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -legup-reduce-latency -legup-reduce-latency-annotate-depth -fuse-ops -bit-manipulation -globaldce -adce -annotate-legup-force-reg ./.legup/Mandelbrot.ifconv.2.bc -o ./.legup/Mandelbrot.finaloptimizedir.bc
# Restore predicate metadata with restore-metadata
rm -f reports/pipelining.legup.rpt
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/opt -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -vectorizer-min-trip-count=1000000 -slp-threshold=1000000 -force-vector-width=1 -simplifycfg-disable-switchtolookup -instcombine-disable-foldphiload  -after-clang=1  -restore-metadata -basicaa -loop-pipeline -function-pipeline -HYBRID_FLOW=0 ./.legup/Mandelbrot.finaloptimizedir.bc -o ./.legup/Mandelbrot.bc
...
#---------------------------------------------------------------------------#
# Set the variable to zero if not set.
/cygdrive/c/LegUp-7.5/legup/examples/../llvm/Release+Asserts/bin/llc -legup-config=/cygdrive/c/LegUp-7.5/legup/examples/legup.tcl -legup-config=config.tcl -march=v -HYBRID_FLOW=0 -LEGUP_ACCELERATOR_FILENAME=Mandelbrot ./.legup/Mandelbrot.bc -o Mandelbrot.v
