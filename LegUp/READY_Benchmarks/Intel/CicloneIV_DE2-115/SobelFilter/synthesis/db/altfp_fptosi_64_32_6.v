...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
module  altfp_fptosi_64_32_6_altbarrel_shift_50g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //altfp_fptosi_64_32_6_altbarrel_shift_50g
...
`endif
	...
	altfp_fptosi_64_32_6_altbarrel_shift_50g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
