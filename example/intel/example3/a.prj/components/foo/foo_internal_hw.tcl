...
set_module_property NAME foo_internal
set_module_property VERSION 1.0
set_module_property INTERNAL true
set_module_property GROUP HLS
set_module_property DISPLAY_NAME foo_internal
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property SUPPORTED_DEVICE_FAMILIES {"Arria 10"}
set_module_assignment hls.cosim.name {_Z3fooi}
set_module_assignment hls.compressed.name {foo}

#### Synthesis fileset
add_fileset QUARTUS_SYNTH QUARTUS_SYNTH "" ""
set_fileset_property QUARTUS_SYNTH TOP_LEVEL foo_internal
...
add_fileset_file "foo_bb_B0_runOnce.sv" SYSTEM_VERILOG PATH "ip/foo_bb_B0_runOnce.sv"
add_fileset_file "foo_bb_B0_runOnce_stall_region.sv" SYSTEM_VERILOG PATH "ip/foo_bb_B0_runOnce_stall_region.sv"
add_fileset_file "foo_B0_runOnce_merge_reg.sv" SYSTEM_VERILOG PATH "ip/foo_B0_runOnce_merge_reg.sv"
add_fileset_file "foo_i_llvm_fpga_pop_token_i1_wt_limpop_0.sv" SYSTEM_VERILOG PATH "ip/foo_i_llvm_fpga_pop_token_i1_wt_limpop_0.sv"
add_fileset_file "foo_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv" SYSTEM_VERILOG PATH "ip/foo_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv"
add_fileset_file "foo_i_llvm_fpga_push_token_i1_wt_limpush_0.sv" SYSTEM_VERILOG PATH "ip/foo_i_llvm_fpga_push_token_i1_wt_limpush_0.sv"
add_fileset_file "foo_i_llvm_fpga_push_token_i1_wt_limpush_1_reg.sv" SYSTEM_VERILOG PATH "ip/foo_i_llvm_fpga_push_token_i1_wt_limpush_1_reg.sv"
add_fileset_file "foo_B0_runOnce_branch.sv" SYSTEM_VERILOG PATH "ip/foo_B0_runOnce_branch.sv"
add_fileset_file "foo_B0_runOnce_merge.sv" SYSTEM_VERILOG PATH "ip/foo_B0_runOnce_merge.sv"
...
set_fileset_property SIM_VERILOG TOP_LEVEL foo_internal
...
#### Parameter t interface
add_interface t conduit sink
set_interface_property t associatedClock clock
set_interface_property t associatedReset reset
set_interface_assignment t hls.cosim.name {t}
add_interface_port t t data input 32
