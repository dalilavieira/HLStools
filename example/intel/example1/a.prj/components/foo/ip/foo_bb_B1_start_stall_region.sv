...
module foo_bb_B1_start_stall_region (
    ...
    wire [63:0] i_iowr_bl_return_foo_unnamed_foo3_foo3_out_iowr_bl_return_foo_o_fifodata;
    wire [0:0] i_iowr_bl_return_foo_unnamed_foo3_foo3_out_iowr_bl_return_foo_o_fifovalid;
    wire [0:0] i_iowr_bl_return_foo_unnamed_foo3_foo3_out_o_stall;
    wire [0:0] i_iowr_bl_return_foo_unnamed_foo3_foo3_out_o_valid;
    ...
    wire [0:0] SE_out_i_iowr_bl_return_foo_unnamed_foo3_foo3_wireValid;
    wire [0:0] SE_out_i_iowr_bl_return_foo_unnamed_foo3_foo3_backStall;
    ...
    // SE_out_i_iowr_bl_return_foo_unnamed_foo3_foo3(STALLENABLE,42)
    // Backward Stall generation
    assign SE_out_i_iowr_bl_return_foo_unnamed_foo3_foo3_backStall = $unsigned(1'b0);
    // Computing multiple Valid(s)
    assign SE_out_i_iowr_bl_return_foo_unnamed_foo3_foo3_wireValid = i_iowr_bl_return_foo_unnamed_foo3_foo3_out_o_valid;

    // bubble_join_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x(BITJOIN,35)
    ...
    // bubble_select_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x(BITSELECT,36)
    ...
    // i_iowr_bl_return_foo_unnamed_foo3_foo3(BLACKBOX,9)@1
    // in in_i_stall@20000000
    // out out_iowr_bl_return_foo_o_fifodata@20000000
    // out out_iowr_bl_return_foo_o_fifovalid@20000000
    // out out_o_stall@20000000
    foo_i_iowr_bl_return_unnamed_foo3_foo0 thei_iowr_bl_return_foo_unnamed_foo3_foo3 (
        .in_i_data(bubble_select_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x_b),
        .in_i_stall(SE_out_i_iowr_bl_return_foo_unnamed_foo3_foo3_backStall),
        ...
        .out_iowr_bl_return_foo_o_fifodata(i_iowr_bl_return_foo_unnamed_foo3_foo3_out_iowr_bl_return_foo_o_fifodata),
        .out_iowr_bl_return_foo_o_fifovalid(i_iowr_bl_return_foo_unnamed_foo3_foo3_out_iowr_bl_return_foo_o_fifovalid),
        .out_o_ack(),
        .out_o_stall(i_iowr_bl_return_foo_unnamed_foo3_foo3_out_o_stall),
        .out_o_valid(i_iowr_bl_return_foo_unnamed_foo3_foo3_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // SE_out_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x(STALLENABLE,46)
    ...
    assign SE_out_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x_consumed1 = (~ (i_iowr_bl_return_foo_unnamed_foo3_foo3_out_o_stall) & SE_out_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x_wireValid) | SE_out_i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x_fromReg1;
    // Consuming
    ...
    // i_iord_bl_call_foo_unnamed_foo2_foo1_aunroll_x(BLACKBOX,29)@1
    // in in_i_stall@20000000
    ...
    // SE_out_foo_B1_start_merge_reg(STALLENABLE,40)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // SE_out_i_sfc_s_c0_in_wt_entry_foos_c0_enter1_foo0_aunroll_x(STALLENABLE,48)
    // Valid signal propagation
    ...
    // i_sfc_s_c0_in_wt_entry_foos_c0_enter1_foo0_aunroll_x(BLACKBOX,30)@1
    // in in_i_stall@20000000
    ...
    assign out_iowr_bl_return_foo_o_fifodata = i_iowr_bl_return_foo_unnamed_foo3_foo3_out_iowr_bl_return_foo_o_fifodata;
    assign out_iowr_bl_return_foo_o_fifovalid = i_iowr_bl_return_foo_unnamed_foo3_foo3_out_iowr_bl_return_foo_o_fifovalid;
